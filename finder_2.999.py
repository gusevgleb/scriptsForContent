...
mazok = [1131922, 1913360, 2928285, 1131921, 2761762, 940412, 1131923, 1131924, 1131925, 1131926, 1132171, 2007865, 2007866, 2008175, 2008179, 2008180, 2008181, 2008182, 2007835]
vp4 = [1131878]
dermatolog = [546738, 2008766, 1132398, 1132397, 934542, 934544, 1132473, 1132472, 1132471, 934552, 1132474, 1132434, 1132435, 1132436, 2008769, 1792752, 1132426, 1132424, 2008521, 191194, 934554, 934550, 1132425, 1132446, 1132448, 2008770, 1132465, 1132464, 1132463, 1132462, 2008771, 1132449, 1132447]
...
def without_lab_func():
	...
	main_func(["массаж"], ["общий", "общего"], "Общий классический массаж", ["дет", "бан", "до 5", "до 11", "до 1 го", "цел", "реб", "втор", "спины", "допол", "позвон", "описани", "лимфодренаж", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["эрозии", "диатермокоа", "электр"], ["шейки матки"], "Прижигание эрозии шейки матки", ["дет", "реб", "папил", "консерват", "кондил", "образован", "опухол", "солковаг", "лазер", "влаг", "вульв", "крио", "кони", "азот", "радио", "сурги", "медикамент", "после", "набот", "желез", "кист", "желуд", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["сеанс", "мин", "комплексая мануальная терапия", "комплексная мануальная терапия", "мануальная терапия при "], ["мануальн"], "Сеанс мануальной терапии", ["дет", "реб", "сустав", "втор", "релизин", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["терап"])
...
def lab_finder():
	...
	new_lab_finder(["пап", "николау", "рар"], ["тест"], "ПАП-тест", ["лмк", "книж", "рино", "адено", "акци", "биопт", "желуд", "папул", "после", "фгдс", "гастро", "эндо", "слиз", "киш", "профосмо", "парво", "бока", "инфекций", "профпат", "вакцин", "комплекс", "профил", "холес", "витамин", "соэ", "вестер"])
