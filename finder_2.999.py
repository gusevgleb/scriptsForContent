...
vp4 = [1131878]
dermatolog = [546738, 2008769, 1792752, 1132426, 1132424, 2008521, 191194, 934554, 934550, 1132425, 1132446, 1132448, 2008770, 1132465, 1132464, 1132463, 1132462, 2008771, 1132449, 1132447]
...
def without_lab_func():
	...
	main_func(["плазмотерапия", "плазматерапия", "prp", "аутоплазменная терапия", "введение"], ["плазмы", "плазмотерапия", "плазматерапия", "терапи", "аутоплазменная терапия", "prp"], "Плазмотерапия", ["дет", "контроль", "век", "мезо", "кист", "после", "костной", "предоплат", "реб", "после", "втор", "описани", "дополни", "расшифров", "офр", "озон", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["хирургич", "механич"], ["моллюск", "молюск"], "Хирургическое удаление контагиозного моллюска", ["дет", "5-20", "от 20", "от 40", "боле", "более", "до 5 элементов", "след", "свыше", "11-", "6-",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "до 5 элементов", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "в рамках", "под", "для", "во время", "курс"])
...
def lab_finder():
	...
	new_lab_finder(["трийодтиронин", "т3", "t3", "т-3", "t-3"], ["трийодтиронин", "т3", "t3", "т-3", "t-3"], "Анализ крови на гормоны Т3 / трийодтиронин", ["бад", "капсул"])
