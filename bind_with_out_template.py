...
mazok = [1131922, 1913360, 2928285, 1131921, 2928284, 2928269, 1131923, 1131924, 1131925, 1131926, 1132171, 2007865, 2007866, 2008175, 2008179, 2008180, 2008181, 2008182, 2007835]
vp4 = [1131878]
dermatolog = [546738, 2008766, 1132398, 1132397, 934542, 934544, 1132473, 1132472, 1132471, 934552, 1132474, 1132434, 1132431, 1132435, 1132436, 2008769, 1792752, 1132426, 1132424, 2008521, 191194, 934554, 934550, 1132425, 1132446, 1132448, 2008770, 1132465, 1132464, 1132463, 1132462, 2008771, 1132449, 1132447]
hirurg = [1132390, 1132391, 2008765, 1132392, 1132394, 1132396, 1132422, 1132421, 1134603, 934546, 1919338, 934548, 934556, 1132395, 1132489, 1132389, 1132393, 1132423, 1978667, 1978671, 1132407, 1132409]
oftalmolog = [546742]
...
def add_sostavnie():
	...
	for i in range(1, rows +1):
		...
		if cell != None and cell in blood:
			...
			cell2 = sheet.cell(row = i, column = 10)
			cell2.value = 2309416
		elif cell != None and cell in dermatolog:
			cell2 = sheet.cell(row = i, column = 10)
			cell2.value = 1134070
		elif cell != None and cell in hirurg:
			cell2 = sheet.cell(row = i, column = 10)
			cell2.value = 1134094

		elif cell != None and cell in oftalmolog:
			cell2 = sheet.cell(row = i, column = 10)
			cell2.value = 1134063
...
def without_lab_func():
													...
													for k in range(1, rows):
														...
														if cell_id == cell_value_name_from_template:
															if cell_value_from_price != "": 
																...
																link_for_sheet_0 = "#" + wb.sheetnames[1] + "!" + str(sheet_1.cell(row = k, column = 4).coordinate)
																sheet_0.cell(row = i, column = 5).value = cell_value_name_from_template
																sheet_1.cell(row = k, column = 7).value = cell_value_name_from_price

																print(cell_value_name_from_template, cell_value_from_price, cell_value_name_from_price)

																sheet_0.cell(row = i, column = 4).value = sheet_1.cell(row = k, column = 11).value
																sheet_0.cell(row = i, column = 3).value = sheet_1.cell(row = k, column = 2).value
																break
	...
	id_uzi_malogo_taza, uzi_malogo_taza_2, stop_for_uzi_malogo_taza = "УЗИ малого таза", ["таза", "гинекологическое"], ["ребен", "фолликул", "при наличии", "дево", "брюш", "щитовид", "плод", "триместр", "терапия", "воздей", "треместр", "беремен", "втор", "муж", "трузи", "недел", "после", "аборт", "контрол", "дет", "абдомин", "живот", "ваги", "влага", "ta", "воздей", "кавита", "беремен", "tv", "вен", "кг", "кардиограф", "фолликулометр", "под", "расшир"]
	...
	id_uzi_matki, uzi_matki_2, stop_for_uzi_matki = "УЗИ матки", ["матк"], ["ребен", "дет", "трим", "шей", "орошен", "контрол", "под", "рубц", "воздейс", "терапия", "после", "только", "воздей", "кавита"]
	id_uzi_molo4nih_jelez, uzi_molo4nih_jelez_2, stop_for_uzi_molo4nih_jelez, uzi_molo4nih_jelez_3 = "УЗИ молочных желез", ["молочн", "груд"], ["ребен", "дет", "лимф", "втор", "пунктат", "взятие", "комплекс", "почк", "мочев", "муж", "пункц", "под ", "девоч", "терапия", "воздей", "возде", "кавита", "допол", "до 1", "до 2", "до 3", "прием"], ["желез", "желёз"]
	...
	id_uzi_zabrushinnogo, uzi_zabrushinnogo, stop_for_uzi_zabrushinnogo = "УЗИ забрюшинного пространства", ["забрюшинн"], ["ребен", "дет", "терапия", "мрт", "тела", "воздей", "под ", "контрол", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
	...
	id_uzi_brushnoy_rebenku, uzi_brushnoy_rebenku_1, uzi_brushnoy_rebenku_2, stop_for_uzi_brushnoy_rebenku = "УЗИ брюшной полости ребенку", ["брюшной"], ["ребен", "детям", "детей", "детское"], ["диспан", "комплекс", "нейро", "терапия", "воздей", "под", "контрол"]
	...
	id_uzi_taza_rebenku, uzi_taza_rebenku_1, uzi_taza_rebenku_2, stop_for_uzi_taza_rebenku = "УЗИ малого таза ребенку", ["таза", "тазов", "гинекологическое"], ["ребен", "дет", "девоч"], ["фолликул", "втор", "преры", "терапия", "воздей", "бере", "контрол", "под", "под", "контрол"]
	...
	uzi_moshonki_rebenku, id_uzi_moshonki_rebenku, stop_for_uzi_moshonki_rebenku, uzi_moshonki_rebenku_2 = ["мошонк"], "УЗИ мошонки ребенку", ["диспан", "под", "контрол"], ["ребен", "дет", "мальч"]
	...
	uzi_po9snic, id_uzi_po9snic, stop_for_uzi_po9snic, uzi_po9snic_2 = ["позвоноч"], "УЗИ поясничного отдела позвоночника", ["ребен", "дет", "новорожд", "терапия", "воздей", "втор", "навигац", "экстру", "протру", "блок", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"], ["поясни", "одного отдела", "1 отдел", "один отдел"]
	uzi_sheynogo_pozvon, id_uzi_sheynogo_pozvon, stop_for_uzi_psheynogo_pozvon, uzi_sheynogo_pozvon_2 = ["позвоноч"], "УЗИ шейного отдела позвоночника", ["ребен", "новорожд", "дет", "втор", "терапия", "воздей", "навигац", "экстру", "протру", "блок"], ["шейн", "1 отдел", "одного отдела", "один отдел"]
	...
	uzi_sustavov, id_uzi_sustavov, stop_for_uzi_sustavov = ["сустав", "суствов"], "УЗИ суставов", ["ребен", "дет", "височ", "челюст", "нерв", "колен", "локт", "голеност", "терапия", "воздей", "лучеза", "плече", "тазо", "стоп", "пункц", "наведен", "навигац", "контрол", "под", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
	...
	tkdg, id_tkdg, stop_for_tkdg, tkdg_2 = ["транскрани", "ткдг", "транскарни", "ткдс", "транс крани"], "ТКДГ сосудов головного мозга", ["ребен", "дет", "под", "контрол", "стимуляц"], ["мозг", "допплеро", "артерий", "вен", "ткдс", "дуплекс"]
	...
	kolposkopia_video, kolposkopia_video_2, id_kolposkopia_video, stop_for_kolposkopia_video, kolposkopia_video_3 = ["кольпо"], ["скоп"], "Видеокольпоскопия", ["реб", "контрол", "видеокольпоскопа", "кисты", "дет", "в рамках", "в ходе кон", "прием", "без вид", "без кольп"], ["видео"]
	...
	laringoskop, laringoskop_2, id_laringoskop, stop_for_laringoskop = ["ларингоскопия", "эндоскоп"], ["ларингоскопия", "гортан", "лор-органов", "лор органов"], "Ларингоскопия", ["микро", "инород", "биопси", "мини", "реб", "дет", "регистр", "запись", "данн", "прием", "консул"]
	...
	otoskopia, otoskopia_2, id_otoskopia, stop_for_otoskopia = ["отоскопи", "эндоскопи"], ["отоскопи", "уха", "ушных", "ушей", "слухо", "лор-органов", "лор органов"], "Отоскопия", ["микро", "операци", "регистр", "запись", "данн", "оториноларинголог", "лор"]
	...
	bujir_uretri, bujir_uretri_2, id_bujir_uretri, stop_for_bujir_uretri = ["бужирован"], ["уретр"], "Бужирование уретры", ["дет", "реб", "втор", "муж", "жен"]
	...
	piling_glikol, piling_glikol_2, id_piling_glikol, stop_for_piling_glikol = ["пилинг", "%"], ["гликоли", "гликоле"], "Гликолевый химический пилинг", ["дет", "акци", "реб", "втор", "допол"]
	...
	amniocentez, amniocentez_2, id_amniocentez, stop_for_amniocentez = ["амниоценте"], ["амниоценте"], "Амниоцентез", ["дет", "реб", "втор", "без стоимости амнио"]
	...
	# aspirac_biop_endometr, aspirac_biop_endometr_2, id_aspirac_biop_endometr, stop_for_aspirac_biop_endometr = ["биопсия", "биопсии"], ["аспирац"], "Аспирационная биопсия эндометрия", ["дет", "молоч", "яич", "желез", "груд", "реб", "узи при", "втор"]
	paipel, paipel_2, id_paipel, stop_for_paipel, paipel_3 = ["биопсия", "биопсии", "диагности", "аспирата из полости матки"], ["пайпел", "pipel", "аспирац"], "Пайпель биопсия эндометрия", ["дет", "реб", "втор", "молоч", "яич", "желез", "груд", "реб", "узи при"], ["пайпел", "pipel", "аспирац"]
	...
	fgds_3, fgds_2_3, id_fgds_3, stop_for_fgds_3 = ["гастроскопия", "гастродуоденоскопия"], ["гастроскопия", "гастродуоденоскопия"], "ФГДС / Гастроскопия желудка", ["дет", "реб", "эгдс", "эндоназальн", "наркоз", "хромоскоп" ,"при", "кислот", "полип", "в ходе", "удал", "образ", "акци", "эзофагогастродуоденоскоп", "анестез", "седац", "хелико", "helico"]
	...
	ezofagogastroduodenoskop, ezofagogastroduodenoskop_2, id_ezofagogastroduodenoskop, stop_for_ezofagogastroduodenoskop = ["эзофагогастродуоденоскоп", "эгдс", "гастродуоденоскопия"], ["эзофагогастродуоденоскопия", "эгдс", "гастродуоденоскопия"], "ЭГДС", ["дет", "полип", "фибро", "прерва", "досроч", "в ходе", "удал", "для", "образ", "акци", "при", "кислот", "реб", "втор", "удал", "хелико", "helico"]
	...
	uz_terapi, uz_terapi_2, id_uz_terapi, stop_uz_terapi = ["узи", "ультразвуко", "уз-", "уз - "], ["терапия", "ультразвуковой терапии", "сеанс"], "Ультразвуковая терапия", ["дет", "боту", "бото", "реб", "ингалляц", "инфу", "втор", "вторич", "протруз", "абонемент", "занятий", "посещени"]
	ufo_terapi, ufo_terapi_2, id_ufo_terapi, stop_ufo_terapi = ["уфо", "ультрафиолет"], ["терапи", "лечен", "воздейств", "уфо", "облучени"], "УФО-терапия", ["дет", "куфо", "цитофе", "цитафа", "форм", " куф", "куф", "окуф", "кров", "вен", "коротк", "сосуд", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
	...
	fotoforez, fotoforez_2, id_fotoforez, stop_fotoforez = ["фотофорез", "фотоферез"], ["фотофорез", "фотоферез"], "Фотоферез", ["дет", "цитафе", "цитофо", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
	...
	udal_vros_vms, udal_vros_vms_2, id_udal_vros_vms, stop_udal_vros_vms, udal_vros_vms_3 = ["удалени", "извлечен"], ["спирали", "вмс", "вмк"], "Удаление вросшей спирали", ["дет", "реб", "втор", "первой катего", "не осложне", "первая катег", "вторич", "абонемент", "неосложненн", "несложн", "занятий", "посещени"], ["сложн", "вросш", "гистероскопа"]
	...
	vnutriven_inekc, vnutriven_inekc_2, id_vnutriven_inekc, stop_vnutriven_inekc = ["внутривенн", "в/в"], ["инъекци", "введение лекарственных", "вливание"], "Внутривенная инъекция", ["дет", "дом", "капель", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "курс"]
	vnutrimish_inekc, vnutrimish_inekc_2, id_vnutrimish_inekc, stop_vnutrimish_inekc = ["внутримышеч", "в/м"], ["инъекц", "введение лекарственных "], "Внутримышечная инъекция", ["дет", "диспорт", "гипер", "пото", "dispo", "ксео", "наличии", "направлен", "xeo", "botox", "ботокс", "сустанон", "реб", "хгч", "гонадо",  "втор", "вторич", "абонемент", "занятий", "посещени", "курс"]
	...
	kt_gortani_2, id_kt_gortani, stop_kt_gortani = ["гортани", "гортань"], "КТ гортани", ["дет", "реб", "втор", "вторич", "абонемент", "описание ", "занятий", "дефект", "подго", "приго", "перед", "посещени", "топометр", "контрастом", "контрастированием", "введением контраст", "введение контраст", "прием контраста"]
	...
	kt_kisti_ruki_2, id_kt_kisti_ruki, stop_kt_kisti_ruki = ["кисти", "кисть",], "КТ кисти руки", ["дет", "реб", "пальцев", "втор", "вторич", "описание ", "абонемент", "дефект", "подго", "приго", "перед", "занятий", "посещени", "топометр", "скт", "мультиспиральн", "спирал"]
	...
	kt_licevogo_skelet_2, id_kt_licevogo_skelet, stop_kt_licevogo_skelet, kt_llicevogo_skelet_3 = ["лицев", "лица"], "КТ лицевого скелета", ["дет", "описание ", "реб", "подго", "приго", "перед", "втор", "дефект", "вторич", "абонемент", "занятий", "посещени", "топометр"], ["кост", "скелет"]
	...
	kt_viso4nih_2, id_kt_viso4nih, stop_kt_viso4nih, kt_viso4nih_3 = ["височн"], "КТ височных костей", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "подго", "приго", "описание ", "перед", "посещени", "дефект", "топометр", "контрастом", "контрастированием", "введением контраст", "введение контраст", "прием контраста"], ["костей", "кости"]
	...
	kt_golenostop_2, id_kt_golenostop, stop_kt_golenostop = ["голеностопн"], "КТ голеностопного сустава", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "подго", "приго", "перед", "дефект", "описание ", "посещени", "топометр"]
	kt_kolena_2, id_kt_kolena, stop_kt_kolena = ["колен"], "КТ коленного сустава", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "топометр", "подго", "приго", "перед", "дефект", "описание "]
	kt_lokt9_2, id_kt_lokt9, stop_kt_lokt9 = ["локтевого", "локтевых"], "КТ локтевого сустава", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "подго", "приго", "перед", "дефект", "описание ", "топометр"]
	kt_ple4_2, id_kt_ple4, stop_kt_ple4 = ["плечев"], "КТ плечевого сустава", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "топометр", "подго", "приго", "перед", "описание ", "дефект", "предплеч"]
	kt_tazobedr_2, id_kt_tazobedr, stop_kt_tazobedr = ["тазобедр"], "КТ тазобедренного сустава", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "подго", "приго", "перед", "топометр", "описание ", "дефект"]
	...
	obzor_mammograf, obzor_mammograf_2, id_kt_obzor_mammograf, stop_obzor_mammograf = ["маммографи"], ["маммографи"], "Обзорная маммография", ["дет", "реб", "после", "подго", "приго", "перед", "втор", "описани", "описание ", "расшифров", "занятий", "посещени", "топометр", "контрастом", "контрастированием", "введением контраст", "введение контраст", "скт", "спирал", "прием контраста", "мультиспиральн", "дукто", "галакто", "прицель"]
	...
	kt_lu4ezap_2, id_kt_lu4ezap, stop_kt_lu4ezap = ["лучезапястн"], "КТ лучезапястного сустава", ["дет", "реб", "втор", "вторич", "абонемент", "описани", "подго", "приго", "перед", "расшифров", "топометр", "описание "]
	...
	kt_for_kontrast = ["контрастом", "контрастным", "контрастированием", "введением контраст", "использованием контраст", "внутривенным введением"]
	...
	ren_legkih, id_ren_legkih, stop_ren_legkih, ren_legkih_2 = ["легких", "грудной"], "Рентген легких / грудной клетки", ["дет", "реб", "втор", "доп", "описани", "расшифров", "занятий", "посещени", "топометр"], ["легких", "клетки", "полости"]
	...
	rebenok = ["ребенку", "ребенок", "ребенка", "дети", "детям", "детей"]
	...
	mrt_kist, id_mrt_kist, stop_mrt_kist = ["кисти", "кисть"], "МРТ кисти", ["дет", "реб", "пальц", "втор", "описание ", "расшифров", "не включая кист", "занятий", "подго", "приго", "перед", "посещени", "топометр", "контрастом", "контрастированием", "введением контраст", "введение контраст", "использованием контраст", "прием контраст", "введением контраст"] 
	...
	mrt_golova, id_mrt_golova, stop_mrt_golova = ["головы"], "МРТ головы", ["дет", "реб", "втор", "описание ", "расшифров", "занятий", "посещени", "подго", "приго", "перед", "топометр", "контрастом", "контрастированием", "введением контраст", "введение контраст", "использованием контраст", "прием контраст", "сосуд", "введением контраст"] 
	...
	mskt = ["скт", "мультиспиральная томография", "мультисрезовая томография", "спиральная компьютерная томографи", "спиральной компьютерной томограф", "мультисрезовая компьютерная томографи", "мультиспиральная кт", "мультисрезовая кт", "мультидетекторная кт", "мультидетекторная томограф", "мультидетекторная компьютерная томо", "спирал"]
	...
	mrurograf, mrurograf_2, id_mrurograf, stop_mrurograf =  ["мрт", "мр", "мскт"], ["урография"], "МРТ-урография", ["дет", "допол", "реб", "втор", "описани", "предыду", "наличии", "расшифров", "занятий", "посещени"]
	...
	main_func(["энмг", "электронейромиографи", "декремент", "электромиография"], ["энмг", "электромиография", "электронейромиографи", "тест"], "ЭНМГ / Электронейромиография", ["дет", "боту", "бото", "при проведе", "при электро", "лиц", "верх", "осмотр", "объема", "консульт", "прием", "ниж", "рук", "ног", "реб", "втор", "описани", "расшифров", "занятий", "посещени"])
	...
	main_func(["фарингоскопия", "эндоскопия"], ["фарингоскопия", "глотк", "глодк"], "Фарингоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"])
	...
	main_func(["rf", "термолифтинг", "рф", "радиоволновой лифтинг", "радиочастотный лифтинг", "радиочастотная термоабляция"], ["шеи", "шейн", "шея"], "RF лифтинг шеи", ["дет", "томограф", "реб", "втор", "описани", "расшифров", "инфек", "антител", "занятий", "посещени", "под", "для", "rfe", "во время"])
	...
	main_func(["антицеллюлитн", "антициллюлитный", "цилюлит", "целюлит"], ["массаж"], "Антицеллюлитный массаж ягодиц", ["дет", "реб", "общий", "втор", "курс", "допол", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"], ["ягоди", "таз", "мышц таза"])
	...
	main_func(["пластик", "сечение", "удал", "хирургич", "опера"], ["прямых", "диастаз", "передней брюшной стенки"], "Герниопластика при диастазе прямых мышц живота", ["дет", "дополнение", "реб", "снятие", "после", "втор", "снятие", "после", "описани", "расшифров", "без опе", "занятий", "посещени", "для", "во время"])
	...
	main_func(["интимн", "цервикал", "влагалищ", "вульв", "гинекологи", "матки"], ["плазмолифтинг"], "Интимный плазмолифтинг", ["дет", "контроль", "реб", "втор", "дополни", "десен", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["увеличени", "аугментац", "увелече"], ["графенберг", "грефенберг", "g", " джи"], "Увеличение точки G", ["дет", "реб", "втор", "описани", "графи", "рентген", "молоч", "груд", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["капельн", "непрерывное внутривенное введение"], ["капельн", "непрерывное внутривенное введение"], "Капельницы", ["дет", "иппп" "реб", "допол", "алкоголь", "выезд", "дом", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["капельн"], ["дом", "выезд"], "Капельница на дому", ["дет", "реб", "втор", "следу", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["фолея", "катетера фоли", "фолей", "фоллея"], ["фолея", "катетера фоли", "фолей", "фоллея"], "Постановка постоянного катетера Фолея", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["контурная пластика", "контурной пластики", "belotero"], ["гиалурон", "belotero"], "Контурная пластика гиалуроновой кислотой", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция верхней губы", ["дет", "реб", "втор", "муж", "описани", "расшифров", "процедур ", "занятий", "посещени", "во время", "курс"], ["губ", "усы", "усов"])
	...
	main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция живота", ["дет", "реб", "втор", "муж", "описани", "расшифров", "процедур ", "занятий", "посещени", "под", "во время", "курс"], ["живот"])
	...
	main_func(["вскрыти", "дренаж", "дренир"], ["паратонзиллярно", "околоминдалинн", "паратонзилярн", "пара(пери)тонзиллярного"], "Вскрытие паратонзиллярного абсцесса", ["дет", "разведение ", "после", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["абсцесс"])
	...
	main_func(["липосакция"], ["липосакция"], "Липосакция", ["дет", "спин", "шеи", "следу", "боле", "шейн", "радио", "лазер", "сурги", "мини", "ягоди", "щек", "щеч", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["липосакци", "удаление подкожно-жировой"], ["бедер", "бедра"], "Липосакция бедер", ["дет", "реб", "втор", "описани", "безопер", "без опера", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["липосакци", "удаление подкожно-жировой"], ["бок", "тали", "фланк"], "Липосакция бока", ["дет", "реб", "втор", "безопер", "без опера", "описани", "без тали", "без бок", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["галиф"], "Липосакция галифе", ["дет", "реб", "втор", "описани", "безопер", "без опера", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["голен"], "Липосакция голеней", ["дет", "реб", "лазер", "втор", "безопер", "без опера", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["живот"], "Липосакция живота", ["дет", "реб", "втор", "описани", "безопер", "без опера", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["лиц"], "Липосакция лица", ["дет", "реб", "втор", "описани", "безопер", "без опера", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], [" ног", "нижних кон", "нижней кон"], "Липосакция ног", ["дет", "безопер", "без опера", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["подбород"], "Липосакция подбородка", ["дет", "реб", "втор", "безопер", "без опера", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["рук", "верних кон", "верхней кон"], "Липосакция рук", ["дет", "безопер", "без опера", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["спин"], "Липосакция спины", ["дет", "реб", "втор", "описани", "безопер", "без опера", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["шеи", "шейн", "шея"], "Липосакция шеи", ["дет", "реб", "втор", "безопер", "без опера", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["щек"], "Липосакция щек", ["дет", "реб", "мини", "втор", "описани", "безопер", "без опера", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци", "удаление подкожно-жировой"], ["ягоди"], "Липосакция ягодиц", ["дет", "реб", "втор", "описани", "расшифров", "безопер", "без опера", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["липосакци"], ["радиочастот"], "Радиочастотная Липосакция Body Tite", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["массаж"], ["позвоночник"], "Классический массаж позвоночника", ["дет", "реб", "отдела", "допол", "сегмен", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "вибро"], ["класс", "общ", "медицин", "лечеб", "всей области"])
	...
	main_func(["массаж"], ["ягодиц", "ягодичной"], "Массаж ягодиц", ["дет", "реб", "общий", "целлю", "до", "втор", "описани", "расшифров", "занятий", "допол", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["массаж"], ["общий", "общего"], "Общий классический массаж", ["дет", "бан", "до 5", "до 11", "до 1 го", "1 ед", "10 мин", "цел", "реб", "втор", "спины", "допол", "позвон", "описани", "лимфодренаж", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["мастэктомия"], ["мастэктомия"], "Мастэктомия", ["дет", "подкож", "радика", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["мезотерапия", "мезококтейль"], ["мезотерапия", "мезококтейль"], "Мезотерапия", ["дет", "крио", "голов", "рубц", "рубец", "hair", "dermahe", "гомео", "безыголь", "лазер", "безигол", "кислород", "волос", "meso", "век", "глаз", "орбит", "кокте", "липоли", "лиц", "тел", "шеи", "дермахи", "мезолай", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["мезотерапи", "мезококтейль", "mesoline"], ["волос", "голов", "hair"], "Мезотерапия волос", ["дет", "реб", "втор", "безинъекцион", "описани", "расшифров", "занятий", "посещени", "под", "во время", "курс"])
	...
	main_func(["мезотерапи", "липолитик", "интралинотерапи", "интралипотерапи", "nctf-135", "акваликс", "aqualyx", "алидия", "alidya"], ["коктейл", "интралинотерапи", "липолитик", "жиросжиг", "интралипотерапи", "nctf-135", "акваликс", "aqualyx", "алидия", "alidya"], "Мезотерапия коктейлями", ["дет", "следую", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["мезотерапи"], ["лиц"], "Мезотерапия лица", ["дет", "реб", "безыголь", "безинъекцион", "угревой", "безиголь", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
	...
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация акушера-гинеколога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["акушера-гинеколога"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация аллерголога", ["дет", "иммуно", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "иммунолог"], ["аллерголог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация гастроэнтеролога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гастроэнтеролог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация гематолога", ["дет", "онко", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гематолог", "гемотолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация гепатолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гепатолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация гинеколога", ["дет", "реб", "онко", "уролог", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "акушер", "хирург", "эндокринолог"], ["гинеколог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация дерматолога", ["дет", "онколог", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онколог"], ["дерматолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация диетолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["диетолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация инфекциониста", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["инфекционист"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация кардиолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "интервен", "хирург"], ["кардиолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация ЛОР-врача", ["дет", "реб", "хиру", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онколог"], ["лор", "оторинолари"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация маммолога-онколога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["маммолог-онколог", "маммолога-онколога"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация нейрохирурга", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["нейрохирург"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация нефролога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["нефролог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация онколога", ["дет", "реб", "эндо", "маммолог", "прокто", "втор", "описани", "дермато", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "гинеколог", "лор", "хирург", "оторино", "гемато", "уролог", "кардиоло"] , ["онколог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация офтальмолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "хирург", "нейро"], ["офтальмолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация педиатра", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["педиатр"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация проктолога", ["дет","хирург", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онколог"], ["проктолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация психиатра", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["психиатр"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация психотерапевта", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["психотерапевт"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация пульмонолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["пульмонолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация ревматолога", ["дет", "реб", "кардио", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["ревматолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация семейного врача", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["семейного врача"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация терапевта", ["дет", "рефлекс", "гирудо", "физио", "радио", "химио", "реб", "психо", "натур", "лазер", "гирудо", "баро", "втор", "мануал", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["терапевт"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация уролога", ["дет", "реб", "гинеколог", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онко", "хирург"], ["уролог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация флеболога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "хирург"], ["флеболог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация флеболога-хирурга", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["флеболога-хирурга", "хирурга-флеболога"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация хирурга", ["дет", "реб", "пласти", "офталь", "втор", "гной", "бариатри", "абдомин", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онко", "уро", "вертебро", "имплан", "онко", "орто", "прокто", "травма", "челю", "эндо", "лор", "рино", "сосуд", "кардио", "торакал", "стомато", "флебо", "гине", "нейро"], ["хирург"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация эндокринолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "хирург", "онколог", "гинеколог"], ["эндокринолог"])
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "удаленн"], ["консультац", "прием"], "Онлайн консультация невролога", ["дет", "верте", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["невролог"])
	...
	main_func(["резекц"], ["мочевого пузыря"], "Резекция мочевого пузыря", ["дет", "реб", "опухоли", "шей", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["эпицистостомия", "эпицистотомия", "эпицистомия"], ["эпицистостомия", "эпицистотомия", "эпицистомия"], "Эпицистостомия", ["дет", "троакар", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["ультразвук", "ультрозвук"], ["чистк", "пилинг"], "Ультразвуковая чистка лица", ["дет", "реб", "чистка шеи", "втор", "челюст", "зуб", "стомато", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "лоп"])
	...
	main_func(["солев", "солян"], ["ингал", "пещер"], "Солевая ингаляция", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "под", "для", "во время", "курс"])
	...
	main_func(["мастоидотоми", "мастоидэктоми"], ["мастоидотом", "мастоидэктоми"], "Мастоидотомия", ["дет", "после", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["удал", "вскрытие"], ["фурункул"], "Удаление фурункула", ["дет", "лазер", "хирург", "реб", "втор", "описани", "расшифров", "занятий", "после", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["удал", "леч", "терап"], ["лазер"], "Лазерное удаление пигментных пятен", ["дет", "реб", "1 вспышк", "более", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["пигмент"])
	...
	main_func(["удал", "извлеч", "уретеролитотомия"], ["камн", "конкремент", "уретеролитотомия"], "Удаление камней из мочеточника", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["мочеточник", "уретеролитотомия"])
	...
	main_func(["удал", "коагул", "лечение"], ["бородав"], "Удаление бородавок", ["дет", "реб", "подошв", "механич", "след", "более", "от ", "5-20", "11-20", "6-10", "от 11", "от 10", "6-10", "2-5", "стоп", "в рамках", "лазер", "свыше", "радио", "сурги", "электр", "хирурги", "крио", "азот", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["хирургич", "механич", "физическ"], ["бородав"], "Хирургическое удаление бородавок", ["дет", "реб", "подошв", "след", "более", "в рамках", "5-20", "11-20", "6-10", "от 11", "от 10", "6-10", "2-5", "стоп", "лазер", "свыше", "радио", "сурги", "электр", "крио", "азот", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["крио", "азот"], ["бородав"], "Криодеструкция бородавок жидким азотом", ["дет", "подошв", "след", "более", "в рамках", "реб", "5-20", "11-20", "6-10", "от 11", "от 10", "6-10", "2-5", "втор", "описани", "свыше", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["радио", "сурги"], ["бородав"], "Радиоволновое удаление бородавок", ["дет", "подошв", "реб", "втор", "более", "в рамках", "след", "5-20", "11-20", "6-10", "от 11", "от 10", "6-10", "2-5", "описани", "расшифров", "свыше", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["лазер"], ["бородав"], "Удаление бородавок лазером", ["дет", "реб", "втор", "подошв", "описани", "в рамках", "более", "расшифров", "5-20", "11-20", "6-10", "от 11", "от 10", "6-10", "2-5", "след", "занятий", "посещени", "свыше", "под", "для", "во время", "курс"])
	main_func(["электр"], ["бородав"], "Электрокоагуляция вульгарной бородавки", ["дет", "подошв", "реб", "втор", "в рамках", "более", "описани", "5-20", "от 21", "11-20", "6-10", "от 11", "от 10", "6-10", "2-5", "расшифров", "след", "занятий", "свыше", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["пунк", "пунктирование"], ["плевр"], "Плевральная пункция", ["дет", "реб", "биопси", "втор", "описани", "расшифров", "контрол", "при", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["асцитическ"], "Пункция асцитической жидкости", ["дет", "реб", "втор", "описани", "контрол", "при", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["голеностоп"], "Пункция голеностопного сустава", ["дет", "реб", "втор", "описани", "контрол", "при", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["желудочков"], "Пункция желудочков головного мозга", ["дет", "реб", "втор", "описани", "контрол", "при ", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["мозг"])
	main_func(["пунк", "пунктирование"], ["заднего свода", "задний свод"], "Пункция заднего свода влагалища", ["дет", "реб", "втор", "контрол", "при", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["кист"], "Пункция кисты головного мозга", ["дет", "реб", "костн", "втор", "описани", "контрол", "при ", "расшифров", "занятий", "посещени", "для", "во время", "курс", "спинн"], ["мозг"])
	main_func(["пунк", "пунктирование"], ["кист"], "Пункция кисты яичника", ["дет", "реб", "втор", "описани", "расшифров", "контроль", "контроля", "при", "занятий", "посещени", "для", "во время", "курс"], ["яичник"])
	main_func(["пунк", "пунктирование"], ["коленн"], "Пункция коленного сустава", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при ", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["костн"], "Пункция костного мозга", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при ", "занятий", "посещени", "для", "во время", "курс"], ["мозг"])
	main_func(["пунк", "пунктирование"], ["лимф"], "Пункция лимфоузла", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "контроль", "при ", "посещени", "для", "во время", "курс"], ["узл", "узе"])
	main_func(["пунк", "пунктирование"], ["лобных пазух", "лобной пазухи", "верхнечелюст"], "Пункция лобных пазух", ["дет", "реб", "втор", "контрол", "при ", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["локт"], "Пункция локтевого сустава", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при ", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["лучезап"], "Пункция лучезапястного сустава", ["дет", "реб", "втор", "описани", "контрол", "при ", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["молочн"], "Пункция молочной железы", ["дет", "реб", "навигация", "наведение", "биопсия", "контрол", "при ", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["мошонк"], "Пункция мошонки", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при" , "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование", "перикардиоцентез"], ["перикард", "перикардиоцентез"], "Пункция перикарда", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при ", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["плеч"], "Пункция плечевого сустава", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при ", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["подвз", "повзд"], "Пункция подвздошной кости", ["дет", "реб", "втор", "описани", "контрол", "при ", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["предстат", "простат"], "Пункция предстательной железы", ["дет", "реб", "втор", "контрол", "при ", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["спинн"], "Пункция спинного мозга", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при ", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["тазобедр"], "Пункция тазобедренного сустава", ["дет", "реб", "втор", "описани", "контрол", "при ", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["пунк", "пунктирование"], ["яичник"], "Пункция фолликулов яичников", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при ", "занятий", "посещени", "для", "во время", "курс"], ["фолликул"])
	main_func(["пунк", "пунктирование"], ["стерналь"], "Стернальная пункция", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "контрол", "при ", "посещени", "для", "во время", "курс"])
	...
	main_func(["подбор", "коррекции зрен"], ["очков"], "Подбор очков для зрения", ["дет", "реб", "футляра", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
	...
	main_func(["эрозии", "диатермокоа", "электр"], ["шейки матки"], "Прижигание эрозии шейки матки", ["дет", "реб", "оптич", "папил", "консерват", "кондил", "образован", "опухол", "солковаг", "лазер", "влаг", "вульв", "крио", "кони", "азот", "радио", "сурги", "медикамент", "после", "набот", "желез", "кист", "желуд", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий", "эндометрийо", "эндометриой"], ["азот", "крио"], "Прижигание эрозии шейки матки жидким азотом", ["дет", "папил", "опухол", "кони", "кондил", "влаг", "вульв", "образован", "после", "деструкцией шейки", "деструкцией матки", "деструкция шейки", "деструкция матки", "деструкции шейки", "деструкции матки", "ампутац", "биопси", "кист", "набот", "желез", "удал", "резекц", "реб", "желуд", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий", "эндометрийо", "эндометриой"], ["лазер"], "Прижигание эрозии шейки матки лазером", ["дет", "этап", "реб", "после", "терап", "папил", "шлиф", "кониз", "кондил", "влаг", "вульв", "опухол", "образован", "втор", "кист", "биопси", "набот", "желез", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий", "эндометрийо", "эндометриой"], ["солковаг", "медикамент", "медимикамент", "лекарств", "консервативное лечение", "химическ"], "Прижигание эрозии шейки матки Солковагином", ["дет", "кони", "после", "влаг", "вульв", "папил", "опухол", "кондил", "образован", "реб", "кист", "набот", "желез", "втор", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий", "эндометрийо", "эндометриой"], ["радио", "сурги"], "Радиоволновое прижигание эрозии шейки матки", ["дет", "сине", "сеч", "биопси", "реб", "опухол", "кони", "папил", "кондил", "влаг", "вульв", "кист", "после", "набот", "желез", "образован", "втор", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["прививк", "вакцин", "рекомбина", "дрожжев"], ["гепатита б", "гепатита b", "гепатита в", "гепатит в"], "Прививка от гепатита В", ["втор", "книж", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"])
	...
	main_func(["плазмотерапия", "плазматерапия", "prp", "аутоплазменная терапия", "введение"], ["плазмы", "плазмотерапия", "плазматерапия", "терапи", "аутоплазменная терапия", "prp"], "Плазмотерапия", ["дет", "оксиген", "кислород", "контроль", "век", "мезо", "кист", "после", "костной", "предоплат", "реб", "после", "втор", "описани", "дополни", "расшифров", "офр", "озон", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["пластик", "увели", "круропластик"], ["голене", "голени", "круропластик"], "Пластика голеней", ["дет", "реб", "лож", "сустав", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["транусретра", "тур", "трансуретра"], ["аденомы простаты", "аденомы предста", "аденоме простаты", "аденоме предста"], "Трансуретральная резекция (ТУР) аденомы простаты", ["дет", "реб", "вапоризац", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["вскры", "дренаж", "дренир"], ["фурунку"], "Вскрытие фурункула носа", ["дет", "реб", "перевязка после вскрытия фу", "втор", "описани", "расшифров", "занятий", "после", "посещени", "под", "для", "во время", "курс", "промеж"], ["нос", "лор-органа", "лор-органов", "лор органа", "лор органов"])
	...
	main_func(["меатотомия", "меатомия", "сечен"], ["меатотомия", "меатомия", "наружного отверстия уретры"], "Меатотомия", ["дет", "реб", "полип", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["уздеч"], ["пластик", "операция"], "Пластика уздечки полового члена", ["дет", "реб", "втор", "язык", "губ", "тяжа", "слизист", " рот", " рта", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["член", "крайн"])
	...
	main_func(["массаж"], ["реб", "дет", "до 1 го", "до 5", "до 11"], "Детский массаж", ["втор", "описани", "расшифров", "абонемент", "занятий", "посещени", "под", "во время", "допол", "курс"], ["общ", "класс"])
	...
	main_func(["мрт", "мр-", "мр -", "мр ", "магнито-резонанс", "магниторезонанс", "магнитно-резонанс", "магнитнорезонанс", "магнито резонанс", "магнитно резонанс"], ["ангиограф", "артериограф"], "МР-ангиография сосудов головного мозга", ["дет", "реб", "наличии", "нашем", "проведенного", "втор", "описани", "спирал", "мскт", "расшифров", "занятий", "посещени", "спин", "под", "для", "кост", "во время", "курс"], ["сосудов мозга", "сосудов головного мозга", "вен и артерий мозга", "вен и артерий головного мозга", "артерий и вен головного мозга", "артерий и вен мозга", "головного мозга", "мозга", "артерий головного", "сосуды головы"])
	main_func(["мрт", "мр-", "мр -", "мр ", "магнито-резонанс", "магниторезонанс", "магнитно-резонанс", "магнитнорезонанс", "магнито резонанс", "магнитно резонанс"], ["вен ", "вены", "венограф"], "МР-венография головного мозга", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "спирал", "мскт", "посещени", "под", "для", "спин", "во время", "курс"], ["мозг"])
	...
	main_func(["экг", "электрокардиографи", "электрокардиограм"], ["экг", "электрокардиографи", "электрокардиограмм"], "ЭКГ", ["дет", "ктг", "плод", "акц", "перед", "дом", "запо", "выезд", "после", "проф", "дополн", "неб", "сут", "монитор", "без экг", "ад", "давлен", "холтер", "нагруз", "стресс", "пищевод", "реб", "втор", "занятий", "расшифровка", "с расшифровкой", "описание", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["сут", "мониторировани"], ["экг", "холтер", "электрокардиографи", "сердечного ритм", "ритма сердц"], "Суточное мониторирование ЭКГ + АД", ["дет", "реб", "или", "втор", "установка", "описани", "расшифровка", "заде", "занятий", "посещени", "под", "для", "во время", "курс"], ["ад", "давлени"])
	...
	main_func(["имплант", "установк"], ["иол", "интраокулярных линз", "интраокулярной линзы"], "Имплантация ИОЛ при афакии", ["дет", "карди", "арит", "реб", "доп", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["втор", "реимплант"], ["имплант"], "Повторная имплантация ИОЛ", ["дет", "биологи", "реб", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["иол", "интраокуля"])
	...
	main_func(["сеанс", "мин", "комплексая мануальная терапия", "комплексная мануальная терапия", "мануальная терапия при "], ["мануальн"], "Сеанс мануальной терапии", ["дет", "реб", "сустав", "втор", "релизин", "описани", "расшифров", "скид", "занятий", "посещени", "для", "во время", "курс"], ["терап"])
	...
	main_func(["уздеч"], ["губ"], "Пластика уздечки губы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "при пластике", "посещени", "для", "во время", "курс"])
	main_func(["уздеч"], ["язык"], "Пластика уздечки языка", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["удал", "деструк", "прижига", "коагуляц"], ["кондилом", "кандилом"], "Удаление кондилом вульвы", ["дет", "реб", "втор", "описани", "след", "свыше", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["вульв", "наружных полов"])
	main_func(["удал", "деструк", "прижига", "коагуляц"], ["папиллом", "папилом"], "Удаление папиллом вульвы", ["дет", "реб", "втор", "описани", "след", "свыше", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["вульв", "наружных полов"])
	...
	main_func(["моллюск", "молюск"], ["моллюск", "молюск"], "Удаление контагиозного моллюска", ["дет", "крио", "5-20", "от 20", "от 40", "боле", "свыше", "след", "до 5 элементов", "11-20", "6-10", "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "механич", "в рамках", "азот", "лаз", "радио", "сурги", "хирурги", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["крио", "азот"], ["моллюск", "молюск"], "Криодеструкция контагиозного моллюска жидким азотом", ["дет", "5-20", "от 20", "от 40", "боле", "свыше", "след", "до 5 элементов", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "реб", "в рамках", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["лаз"], ["моллюск", "молюск"], "Лазерное удаление контагиозного моллюска", ["дет", "реб", "втор", "5-20", "от 20", "от 40", "боле", "до 5 элементов", "след", "свыше", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "описани", "расшифров", "в рамках", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["радио", "сурги"], ["моллюск", "молюск"], "Радиоволновое удаление контагиозного моллюска", ["дет", "5-20", "от 20", "от 40", "боле", "до 5 элементов", "реб", "след", "свыше", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "втор", "описани", "расшифров", "в рамках", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["хирургич", "механич", "пинцет"], ["моллюск", "молюск"], "Хирургическое удаление контагиозного моллюска", ["дет", "5-20", "от 20", "от 40", "боле", "более", "до 5 элементов", "след", "свыше", "11-", "6-",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "до 5 элементов", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "в рамках", "под", "для", "во время", "курс"])
	...
	main_func(["удал", "механич", "сечен"], ["родин", "невус"], "Удаление родинки / невуса", ["дет", "6", "7", "8", "3-5", "9", "от 3", "от 4", "от 5", "лазер", "механич", "электр", "радио", "сурги", "крио", "азот", "хирургич", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["лазер"], ["родин", "невус"], "Лазерное удаление родинки / невуса", ["дет", "реб", "7-15", "втор", "3-5", "6", "7", "8", "от 3", "от 4", "от 5", "9", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["радио", "сурги"], ["родин", "невус"], "Радиоволновое удаление родинки / невуса", ["дет", "7-15", "3-5", "реб", "6", "7", "от 3", "от 4", "от 5", "8", "9", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["крио", "азот"], ["родин", "невус"], "Удаление родинки / невуса жидким азотом", ["дет", "реб", "7-15", "3-5", "6", "7", "8", "от 3", "от 4", "от 5", "9", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["хирургич", "механич"], ["невус", "родин"], "Хирургичекое удаление родинки / невуса", ["дет", "реб", "7-15", "6", "3-5", "7", "от 3", "от 4", "от 5", "8", "9", "втор", "описани", "электр", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["электр"], ["родин", "невус"], "Электрокоагуляция невуса", ["дет", "реб", "втор", "описани", "расшифров", "и более", "3-5", "от 1", "7-15", "6", "от 3", "от 4", "от 5", "7", "8", "9", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["диаскинтест", "диаскин-тест", "диаскин тест"], ["диаскинтест", "диаскин тест", "диаскин-тест"], "Диаскинтест", ["дет", "реб", "контрол", "после", "втор", "описани", "расшифров", "после", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["хеликобактер", "helicobacter"], ["фгдс", "гастроскопи", "желудка", "фгс"], "Анализ на хеликобактер при ФГДС", ["дет", "реб", "втор", "описани", "без", "расшифров", "после", "занятий", "посещени", "для", "курс"])
	...
	main_func(["рхпг", "ретроградная холангиопанкреатография"], ["эрхпг", "рхпг", "ретроградная холангиопанкреатография"], "ЭРХПГ", ["дет", "допол", "реб", "втор", "описани", "расшифров", "занятий", "посещени"])
	...
	main_func(["lpg"], ["костюм"], "Костюм для LPG-массажа", ["дет", "реб", "втор", "включая", "описани", "расшифров", "занятий", "посещени", "без костю", "с костюм", "включая костюм", "не вклю", "без стоимости кост"])
	...
	main_func(["манту"], ["манту"], "Реакция Манту", ["дет", "реб", "контрол", "после", "втор", "описани", "без", "расшифров", "после", "занятий", "консульт", "прием", "прив", "справ", "посещени", "для", "курс"])
	...
	perfect_match(["взятие крови из вены", "взятие крови", "забор крови", "забор  крови", "забор крови периферической вены", "забор крови  из вены", "венопункция (взрослые, дети)", "взятие крови для анализа из вены", "забор крови из вены", "забор крови из периферической вены", "взятие крови из периферической вены", "забор венозной крови", "взятие венозной крови", "забор крови(вена)", "взятие крови (вена)", "взятие крови (из вены)", "забор крови для анализов", "забор крови из вены (пальца)", "взятие крови из периферической вены", "забор крови из периферической вены ( пациенты от 5 лет)"], "Забор крови")
	...
	main_func(["удал", "лечение одной"], ["папил"], "Удаление папиллом", ["дет", "лазер", "крио", "5-20", "азот", "от 20", "радио", "сурги", "электро", "дэк", "диатермо", "вульв", "вагин", "влагал", "ротов", "глот", "лор", "анус", "анал", "зад", "более", "свыше", "след", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["лазер"], ["папил"], "Лазерное удаление папиллом", ["дет", "более", "от 20", "свыше", "следу", "5-20", "11-20", "6-", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["радио", "сурги"], ["папил"], "Радиоволновое удаление папиллом", ["дет", "от 20", "более", "свыше", "5-20", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["крио", "азот"], ["папил"], "Удаление папиллом жидким азотом", ["дет", "более", "от 20", "свыше", "5-20", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["хирурги", "механич"], ["папил"], "Хирургическое удаление папиллом", ["дет", "ради", "лазер", "магнит", "5-20", "от 20", "сурги", "коагул", "электр", "более", "свыше", "следу", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["электро", "диатермо", "дэк"], ["папил"], "Электрокоагуляция папиллом", ["дет", "более", "от 20", "свыше", "5-20", "следу", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["крио", "азот"], ["кондил", "кандил"], "Криодеструкция кондилом жидким азотом", ["дет", "от 20", "более", "свыше", "следу", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["радио", "сурги"], ["кондил", "кандил"], "Радиоволновое удаление кондилом", ["дет", "более", "от 20", "3-10", "свыше", "следу", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["солкодер", "лекарств", "медикамент"], ["кондил", "кандил"], "Удаление кондилом солкодермом", ["дет", "от 20", "более", "свыше", "следу", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["электро", "дэк", "диатермо"], ["кондилом", "кандил"], "Электрокоагуляция кондилом", ["дет", "более", "от 20", "свыше", "следу", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["лфк", "лечебная физическая культура"], ["беременн"], "ЛФК для беременных", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "при", "во время", "курс"], ["беременн"])
	main_func(["интерпретация результатов", "второе мнение", "консилиум", "совместный осмотр двух врачей", "консулиум"], ["друго", "второе мнение", "консилиум", "профессор", "к. м. н.", "к.м.н.", "совместный осмотр двух врачей", "консулиум"], "Второе мнение врача", ["дет", "привлече", "для участия в консилиуме", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
	main_func(["тест", "проб", "спирометри", "фвд", "внешнего дыхания", "спирограф"], ["бронхолити"], "Тест с бронхолитиком", ["дет", "реб", "втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
	...
	main_func(["медикамент", "лекарств", "мифепрестон", "мифепристон", "мефепрестон" "фармаборт", "мизопристол", "отечественный препарат", "импортный препарат"], ["аборт", "прерывание беременности"], "Медикаментозный аборт", ["дет", "втор", "после", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
	...
	main_func(["чистка", "комплекс", "гигиен", "отложен", "сняти", "гигиен"], ["air", "эйрфлоу", "эйр флоу", "аэрфло"], "Чистка зубов AirFlow", ["дет", "1 челю", "одна че", "реб", "професси", "комплекс", "втор", "курс", "1 зуб", "скидк", "без", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["flow"])
	...
	main_func(["имплант"], ["alpha bio", "альфа био", "alfa", "альфа-био", "alpha - bio", "alpha-bio", "alphabio"], "Импланты Alpha Bio", ["дет", "формировате", "аналог", "времен", "фдм", "предложе", "коронк", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
	...
	main_func(["сня", "удал"], ["зуб"], "Снятие зубных отложений", ["дет", "реб", "втор", "акци", "air", "имплант", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["отлож"] )
	...
	main_func(["штифт", "свш"], ["штифт", "свш"], "Установка зубного штифта", ["дет", "реб", "подготовка", "вкладку", "втор", "удал", "извеч", "описани", "пломбир", "канала", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
	main_func(["icon"], ["кариес", "лечение", "апрокси", "вестибул"], "Лечение кариеса ICON", ["дет", "реб", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
	...
	main_func(["акри", "acryfree", "acry-free", "acry free", "akri-free", "akri free"], ["фри", "acryfree", "acry-free", "acry free", "akri-free", "akri free"], "Протезы Акри-Фри", ["дет", "реб", "втор", "курс", "микро", "снятие", "удале", "извле", "ремонт", "почин", "мини", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"])
	...
	main_func(["дуплекс", "уздс", "узи сосудов"], ["голов"], "Дуплексное сканирование сосудов головы и шеи / УЗДС", ["дет", "реб", "втор", "позвон", "курс", "микро", "снятие", "удале", "извле", "ремонт", "почин", "мини", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"], ["шеи", "шея", "шейн"])
...
def lab_finder():
	...
	new_lab_finder(["25-oh", "25 oh", "25 он", "25-он", "витамин д", "25-hydroxyvitamin", "кальциферол", "витамин d", "25он", "25oh"], ["25-oh", "25 oh", "25 он", "25-он", "витамин д", "25-hydroxyvitamin", "кальциферол", "витамин d", "25он", "25oh"], "Анализ на витамин Д", ["комплекс", "ультра"])
	new_lab_finder(["т-спот", "т спот", "t spot", "t-spot"], ["т-спот", "т спот", "t spot", "t-spot"], "Тест (анализ) Т-Спот", ["заглушка"])
	new_lab_finder(["манту"], ["манту"], "Реакция Манту", ["прием", "контрол", "после", "приём", "консультац"])
	...
	new_lab_finder(["аллерг", "панель"], ["живот", "кошк", "собак", "шерст", "лошад", "коров"], "Анализ на аллергию к животным", ["шерстис", "бухар", "бытов", "дет", "моло"])
	...
	new_lab_finder(["трийодтиронин", "т3", "t3", "т-3", "t-3"], ["трийодтиронин", "т3", "t3", "т-3", "t-3"], "Анализ крови на гормоны Т3 / трийодтиронин", ["бад", "капсул", "immun", "бере"])
	new_lab_finder(["тироксин", "т4", "t4", "t-4", "т-4"], ["тироксин", "т4", "t4", "t-4", "т-4"], "Анализ крови на гормоны Т4 / тироксин", ["туширова", "immuno"])
	...
	new_lab_finder(["хромогранин", "chromogranin", "хромгранин", "cga", "хга", "нейроэндокринных опухолей"], ["хромогранин", "chromogranin", "хромгранин", "cga", "хга", "нейроэндокринных опухолей"], "Анализ на онкомаркер Хромогранин А", ["ихга", "ротавиру"])
	new_lab_finder(["72 4", "72-4", "72.4", "72 - 4"], ["72 4", "72-4", "72.4", "72 - 4"], "Анализ Cа 72-4", ["туширова"])
	new_lab_finder(["енолаз", "nse", "enolase", "нсэ", "нейронспецифическ", "нейро-специфическ"], ["енолаз", "nse", "enolase", "нсэ", "нейронспецифическ", "нейро-специфическ"], "Анализ на нейронспецифическую енолазу", ["туширова", "pratense", "halepense", "перо", "clean", "пенк", "пост"])
	...
	new_lab_finder(["отцовс", "родства"], ["отцовс", "родства"], "ДНК тест на отцовство", ["прижиг", "удал", "книж", "выдача"])
	...
	new_lab_finder(["гемоглобин"], ["гемоглобин"], "Анализ на гемоглобин", ["глик", "кал", "карбокси", "электро", "метгемо", "гапто", "fob", "стул", "фекал"])
	...
	perfect_match_lab(["взятие крови из вены", "взятие крови", "забор крови", "забор крови периферической вены", "забор крови из вены", "забор крови  из вены", "забор крови из периферической вены", "венопункция (взрослые, дети)", "забор  крови", "взятие крови из периферической вены", "забор венозной крови", "взятие венозной крови", "забор крови(вена)", "взятие крови для анализа из вены", "взятие крови (вена)", "взятие крови (из вены)", "забор крови для анализов", "забор крови из вены (пальца)", "взятие крови из периферической вены", "забор крови из периферической вены ( пациенты от 5 лет)"], "Забор крови")
	...
	new_lab_finder(["кров", "днк", "антиген"], ["хелико", "хилико", "helico", "pylori", "pilori", "pylory"], "Анализ крови на хеликобактер Пилори", ["лмк", "книж", "рино", "кале", "адено", "биопт", "желуд", "фгдс", "гастро", "эндо", "слиз", "киш", "профосмо", "парво", "бока", "инфекций", "профпат", "вакцин", "комплекс", "профил", "холес", "витамин", "соэ", "вестер"])
	new_lab_finder(["пап", "николау", "рар", "жидкостная цитология"], ["тест", "жидкостная цитология"], "ПАП-тест", ["лмк", "книж", "папилл", "рино", "адено", "акци", "биопт", "желуд", "папул", "после", "фгдс", "гастро", "эндо", "слиз", "киш", "профосмо", "парво", "бока", "инфекций", "профпат", "вакцин", "комплекс", "профил", "холес", "витамин", "соэ", "вестер"])
	new_lab_finder(["фемофлор"], ["фемофлор"], "Фемофлор", ["лмк", "книж", "рино", "адено", "акци", "биопт", "желуд", "фгдс", "гастро", "эндо", "слиз", "киш", "профосмо", "парво", "бока", "инфекций", "профпат", "вакцин", "комплекс", "профил", "холес", "витамин", "соэ", "вестер"])
...
header_list = ['Родительские категории', 'service_id', 'Комментарии для контента', 'Название выборки', 'price', 'is_min_price', 'comment', 'clinic_id', 'filial_id', 'excluded_service_ids', 'Просмотры выборки за посл. 30 дней']
wbcsv = wbcsv.reindex(columns = header_list)
filename_xlsx = glob('*райс*.xlsx')
filename_strip = str(filename_xlsx).rstrip('\']')
filename_strip = filename_strip.lstrip('[\'')
