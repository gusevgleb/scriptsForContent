...
все таки разобраться с полупробелом! Усаши такое было
'''
...
def without_lab_func():
    ...
    def new_doubler_main(name_1, name_2, stopword, what_double, what_double_section, what_double_service, what_double_title):
    ...
    uzi_golenostop, id_uzi_golenostop, stop_for_uzi_golenostop = ["голеностоп", "парных суставов"], "УЗИ голеностопного сустава", ["ребен", "нерв", "дет", "терапия", "воздей", "втор", "под", "контрол", "пункц", "пунктирование", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_kolen, id_uzi_kolen, stop_for_uzi_kolen = ["колен", "парных суставов"], "УЗИ коленного сустава", ["ребен", "дет", "втор", "под", "терапия", "воздей", "нерв", "контрол", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_loktevogo, id_uzi_loktevogo, stop_for_uzi_loktevogo = ["локт", "локот", "парных суставов"], "УЗИ локтевого сустава", ["ребен", "терапия", "воздей", "дет", "нерв", "втор", "под", "контрол", "пункц", "пунктирование", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_lu4ezap, id_uzi_lu4ezap, stop_for_uzi_lu4ezap = ["лучезап", "запяст", "парных суставов"], "УЗИ лучезапястного сустава", ["ребен", "терапия", "воздей", "дет", "нерв", "втор", "под", "контрол", "пункц", "пунктирование", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_ple4, id_uzi_ple4, stop_for_uzi_ple4 = ["плечевого", "сустава плеча", "плечевых", "парных суставов", "плечевой"], "УЗИ плечевого сустава", ["ребен", "терапия", "воздей", "нерв", "дет", "втор", "вен", "до плеча", "дуплекс", "под", "пункц", "контрол", "сплетен", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_tazobedr, id_uzi_tazobedr, stop_for_uzi_tazobedr = ["тазобедр", "парных суставов"], "УЗИ тазобедренного сустава", ["ребен", "терапия", "воздей", "дет", "втор", "нерв", "рожд", "млад", "пункц", "под", "контрол", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    ...
    laringoskop, laringoskop_2, id_laringoskop, stop_for_laringoskop = ["ларингоскопия", "эндоскоп"], ["ларингоскопия", "гортан", "глотк", "глодк", "лор-органов", "лор органов"], "Ларингоскопия", ["микро", "биопси", "мини", "реб", "дет", "регистр", "запись", "данн", "прием", "консул"]
    ...
    kukushka, kukushka_2, id_kukushka, stop_for_kukushka = ["процедур", "промыва", "санац", "чистк", "кукушк", "проетц", "проэтц"], ["кукушк", "проетц", "проэтц", "перемещения"], "Процедура Кукушка", ["дет", "реб", "втор"]
    ...
    block_krest_povz, block_krest_povz_2, id_block_krest_povz, stop_for_block_krest_povz, block_krest_povz_3 = ["блокад"], ["крест"], "Блокада крестцово-подвздошного сочленения", ["дет", "реб", "втор"], ["подвздош", "повздош", "позвз"]
    ...
    fks_and_fgds, fks_and_fgds_2, id_fks_and_fgds, stop_for_fks_and_fgds = ["колоноскоп", "фкс", "вкс"], ["фгдс", "гастроскоп", "эндоскопия желудка", "вгдс", "эгдс"], "Колоноскопия и ФГДС под наркозом одновременно", ["дет", "готов", "полип", "образо", "в ходе", "акци", "реб", "втор", "при", "для"]
    ...
    aspirac_biop_endometr, aspirac_biop_endometr_2, id_aspirac_biop_endometr, stop_for_aspirac_biop_endometr = ["биопсия", "биопсии"], ["аспирац"], "Аспирационная биопсия эндометрия", ["дет", "молоч", "желез", "груд", "реб", "втор"]
    ...
    lazeroterapi, lazeroterapi_2, id_lazeroterapi, stop_for_lazeroterapi = ["лазеротерапи", "лазерная терапия", "лазерное облучение кожи", "воздействие"], ["лазеротерапи", "лазер", "лазерная терапия", "лазерное облучение кожи"], "Лазеротерапия", ["дет", "реб", "влок", "доп", "крови", "папил", "образ", "кондил", "образо", "добро", "фибр", "кровь", "втор", "вторич", "абонемент", "занятий", "посещени", "магнит", "десен", "стоматол"]
    ...
    udal_vros_vms, udal_vros_vms_2, id_udal_vros_vms, stop_udal_vros_vms, udal_vros_vms_3 = ["удалени", "извлечен"], ["спирали", "вмс", "вмк"], "Удаление вросшей спирали", ["дет", "реб", "втор", "первой катего", "первая катег", "вторич", "абонемент", "неосложненн", "несложн", "занятий", "посещени"], ["сложн", "вросш"]
    ...
    ren_pozvono4_grud, id_ren_pozvono4_grud, stop_ren_pozvono4_grud, ren_pozvono4_grud_2 = ["грудн"], "Рентген грудного отдела позвоночника", ["дет", "реб", "втор", "описани", "расшифров", "доп", "занятий", "посещени", "топометр"], ["позвоночн", "поз-ка"]
    ...
    ren_pozvono4_po9s, id_ren_pozvono4_po9s, stop_ren_pozvono4_po9s = ["поясни"], "Рентген поясничного отдела позвоночника", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "доп", "крест"]
    ren_pozvono4_shei, id_ren_pozvono4_shei, stop_ren_pozvono4_shei = ["шейн", "шеи"], "Рентген шейного отдела позвоночника", ["дет", "реб", "втор", "описани", "позвонка", "расшифров", "занятий", "доп", "посещени"]
    ...
    veroelrgo, veloergo_2, id_veloergo, stop_veloergo =  ["велоэргометри", "велоэгрометри"], ["велоэргометри", "велоэгрометри"], "Велоэргометрия", ["дет", "реб", "диспансер", "втор", "описани", "расшифров", "занятий", "посещени"]
    steptest, steprtest_2, id_steprtest, stop_steptetst =  ["стептест", "степ тест", "степ-тест"], ["стептест", "степ тест", "степ-тест"], "Степ-тест", ["дет", "реб", "втор", "описани", "расшифровка", "занятий", "посещени"]
    ...
    bronhobio, bronhobio_2, id_bronhobio, stop_bronhobio =  ["бронхоскопи"], ["биопси"], "Бронхоскопия с биопсией", ["дет", "реб", "удалени", "инород", "втор", "описани", "расшифров", "занятий", "посещени"]
    ...
    main_func(["ial-system", "ial system", "иал систем", "иал-систем", "ial – system", "yal- system", "иал - систем", "lаl system"], ["ial-system", "ial system", "иал систем", "иал-систем", "ial – system", "yal- system", "иал - систем", "lаl system"], "Биоревитализация IAL System", ["дет", "реб", "facial", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["биоревитализац"], ["возраст", "age"], "Биоревитализация возрастной кожи", ["дет", "лазер", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["биоревитализац"], ["инъекционн", "препарат"], "Инъекционная биоревитализация", ["дет", "реб", "втор", "безинъекцио", "безын", "описани", "лазер", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["внутри", "полостн", "внутрен"], ["гирудотерапи"], "Внутриполостная гирудотерапия", ["дет", "реб", "втор", "описани", "внеполост", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["дарсонвал", "дарсанвал", "д-арсонвал", "д-арсонваль", "дарсонал", "дарсенвал"], ["волос"], "Дарсонвализация волосистой части головы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["дарсонвал", "д-арсонвал", "дарсанвал", "д-арсонваль", "дарсонал", "дарсенвал"], ["лиц"], "Дарсонвализация лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["дарсонвал", "д-арсонвал", "д-арсонваль", "дарсанвал", "дарсонал", "дарсенвал"], ["полост"], "Дарсонвализация полостная", ["дет", "реб", "втор", "вне", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["дарсонвал", "д-арсонвал", "д-арсонваль", "дарсанвал", "дарсонал", "дарсенвал"], ["спины"], "Дарсонвализация спины", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["иглоукалывани", "рефлексотерапи", "иглотерапия", "акупунктура корпоральная"], ["иглотерапия", "иглоукалывани", "рефлексотерапи", "акупунктура корпоральная"], "Иглоукалывание / Рефлексотерапия", ["дет", "допол", "реб", "други", "гиру", "электр", "аури", "ушн", "микросистем", "ушей", "уха", "пиявк", "втор", "описани", "лазер", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    new_doubler_main(["иглоукалывани", "рефлексотерапи", "аурикулотерапия", "акупунктур"], ["аурик", "ушей", "ушн", "микросистем"], ["дет", "реб", "други", "гиру", "электр", "пиявк", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], "Иглоукалывание / Рефлексотерапия", 28856, 961113, "Иглоукалывание / Рефлексотерапия")
    ...
    main_func(["увеличени", "аугментац", "увелече"], ["графенберг", "грефенберг", "g"], "Увеличение точки G", ["дет", "реб", "втор", "описани", "графи", "рентген", "молоч", "груд", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["уменьше", "редукц", "резекция"], ["малых половых", "малой половой", "половых губ"], "Уменьшение малых половых губ", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["контурная пластика", "контурной пластики", "коррекция контура"], ["губ", "smile", "lips", "smail", "kiss"], "Контурная пластика губ", ["дет", "нос", "реб", "вестибуло", "полов", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    new_doubler_main(["лазерная эпиляция живот", "лазерная эпиляция зоны живот", "лазерная эпиляция (живот)", "удаление волос в области живота лазе", "удаление волос в зоне живота лазер", "эпиляция живота лазер", "лазерная эпиляция живота"], ["полност"], ["втор", "дет", "реб", "посеще", "во время", "курс"], "Лазерная эпиляция живота", 47604, 1978638, "Лазерная эпиляция")
    ...
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция носа", ["дет", "реб", "втор", "полнос", "описани", "расшифров", "занятий", "посещени", "во время", "курс"], ["нос"])
    ...
    main_func(["мини", "мало"], ["флебэктом"], "Минифлебэктомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func([" дом", "по москве"], ["консульт", "прием", "вызов", "выезд"], "Вызов врача на дом", ["дет", "реб", "втор", "2-го", "описани", "ортопедом", "мануал", "пси", "рефлекс", "расшифров", "дмс", "занятий", "посещени", "под", "для", "во время", "курс"], ["терапевт"])
    ...
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов детского врача / педиатра на дом", ["втор", "2-го", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "дмс", "от ", "крови", "курс"], ["педиатр", "детского врача"])
    ...
    main_func(["медикамент", "лечени", "терап"], ["акне"], "Медикаментозное лечение акне", ["дет", "аппарат", "тек", "дот", "фракц", "ток", "фото", "радио", "сурги", "азот", "крио", "реб", "лазер", "без", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["озон"], ["тела", "тело", "грудь", "груди", "декольте", "артикуляр"], "Озонотерапия тела", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "шеи", "шей", "шея", "во время", "курс"])
    ...
    main_func(["лазер", "радио"], ["редукц", "коагуля", "томия"], "Лазерная редукция нижних носовых раковин", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["носовых раковин", "носовой раковины"])
    ...
    main_func(["удал", "марсупи", "вапоризац", "вскрыти", "вылущивание"], ["кист"], "Удаление кисты бартолиновой железы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["бартолин", "бактолин", "бортолин"])
    ...
    main_func(["синех", "сенехи"], ["половых губ", "наружных половых органов"], "Рассечение синехий половых губ", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени",  "для", "во время", "курс"])
    main_func(["синех", "сенехи"], ["носа", "носу", "носов", "полости", " нос"], "Удаление синехий полости носа", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    new_doubler_main(["очков"], ["сложн", "цилиндри", "бифокал", "призм"], ["втор", "дет", "реб", "посеще", "не ц", "не б", "не с", "во время", "курс"], "Подбор очков для зрения", 29039, 1132371, "Проверка зрения")
    ...
    main_func(["осмотр", "консультаци", "прием"], ["перед", "для", "предвак", "предприв"], "Осмотр перед вакцинацией", ["втор", "книж", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"], ["вакцин"])
    ...
    main_func(["прессотерап"], ["верхни", "рук"], "Прессотерапия верхних конечностей", ["дет", "реб", "втор", "сеансов", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["прессотерап"], ["всего тела", "тела полностью", "тело полностью", "все тело"], "Прессотерапия всего тела", ["дет", "реб", "костю", "шта", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["плазм"], ["век"], "Плазмолифтинг век", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "дополни", "готов", "акци", "под", "скид", "для", "во время", "курс"], ["лифт", "терапи"])
    ...
    main_func(["плазмотерапия", "плазматерапия", "prp", "аутоплазменная терапия", "введение"], ["аутоплазмы", "плазмотерапия", "плазматерапия", "терапи", "аутоплазменная терапия", "prp"], "Плазмотерапия", ["дет", "мезо", "после", "костной", "предоплат", "реб", "после", "втор", "описани", "дополни", "расшифров", "офр", "озон", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["отопластика", "пластика ушной раковины"], ["отопластика", "пластика ушной раковины"], "Отопластика", ["дет", "лазер", "меато", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал", "резекц"], ["ногт"], "Удаление вросшего ногтя", ["дет", "лазер", "бартлет", "радио", "сурги", "хирурги", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["экг", "электрокардиографи", "электрокардиограм"], ["экг", "электрокардиографи", "электрокардиограмм"], "ЭКГ", ["дет", "акц", "перед", "дом", "выезд", "дополнит", "неб", "сут", "монитор", "бех экг", "ад", "давлен", "холтер", "нагруз", "стресс", "пищевод", "реб", "втор", "занятий", "расшифровка", "описание", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["экг", "электрокардиографи", "электрокардиограмм"], ["нагруз", "физическими упражнениями"], "ЭКГ с нагрузкой", ["дет", "медикаментозной нагрузкой", "реб", "втор", "без нагрузки", "без нагрузок", "описани", "расшифровка", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["b-s", "b/s", "b s", "bs-"], ["b-s", "b/s", "b s", "пластин"], "Исправление вросшего ногтя B/S-пластиной", ["дет", "кобалт", "микро", "лемен", "реб", "микро", "мыш", "токси", "исс", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["ногт"])
    ...
    main_func(["моллюск", "молюск"], ["моллюск", "молюск"], "Удаление контагиозного моллюска", ["дет", "крио", "боле", "свыше", "след", "до 5 элементов", "11-20", "6-10", "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "механич", "в рамках", "азот", "лазер", "радио", "сурги", "хирурги", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["крио", "азот"], ["моллюск", "молюск"], "Криодеструкция контагиозного моллюска жидким азотом", ["дет", "боле", "свыше", "след", "до 5 элементов", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "реб", "в рамках", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["лазер"], ["моллюск", "молюск"], "Лазерное удаление контагиозного моллюска", ["дет", "реб", "втор", "боле", "до 5 элементов", "след", "свыше", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "описани", "расшифров", "в рамках", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["радио", "сурги"], ["моллюск", "молюск"], "Радиоволновое удаление контагиозного моллюска", ["дет", "боле", "до 5 элементов", "реб", "след", "свыше", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "втор", "описани", "расшифров", "в рамках", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["хирургич", "механич"], ["моллюск", "молюск"], "Хирургическое удаление контагиозного моллюска", ["дет", "боле", "более", "до 5 элементов", "след", "свыше", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "до 5 элементов", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "в рамках", "под", "для", "во время", "курс"])
    ...
    main_func(["хирургич", "механич"], ["невус", "родин"], "Хирургичекое удаление родинки / невуса", ["дет", "реб", "7-15", "6", "7", "8", "9", "втор", "описани", "электр", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["скрининг"], ["беремен", "пренатальный", "плода"], "Скрининговое УЗИ 1 триместр", ["дет", "реб", "втор", "описани", "хим", "вне", "не скрин", "расшифров", "занятий", "посещени", "для", "курс", "шейк", "трисоми", "хромос", "аномал", "биохим"], ["1 триместр", "до 13", "до 14", "i триместр", "11-14", "1-го три", "11-13 нед"])
    main_func(["скрининг"], ["беремен", "пренатальный", "плода"], "Скрининговое УЗИ 2 триместр", ["дет", "узи 2-го триместра беременности", "реб", "втор", "описани", "хим", "вне", "расшифров", "не скрин", "занятий", "посещени", "для", "курс", "шейк", "трисоми", "хромос", "аномал", "биохим"], ["2 триместр", "до 27", "до 28", "ii триместр", "20-22", "2-го три", "18-21 нед", "ii-iii триместр"])
    main_func(["скрининг"], ["беремен", "пренатальный", "плода"], "Скрининговое УЗИ 3 триместр", ["дет", "реб", "втор", "описани", "хим", "узи 3-го триместра беременности", "вне", "расшифров", "не скрин", "занятий", "посещени", "для", "курс", "шейк", "трисоми", "хромос", "аномал", "биохим"], ["3 триместр", "с 28", "iii триместр", "32-34", "3-го три", "30-34 нед", "ii-iii триместр"])
    ...
    new_doubler_main(["узи", "ультразвук"], ["печени и желчного", "печени с желчным", "желчного и печени", "желчного с печень", "печень и желчный", "желчный и печень", "печень + желчный"], ["дет", "реб", "други", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс", "навед", "пункц", "контрол"], "УЗИ печени", 47426, 541726, "УЗИ брюшной полости")
    main_func(uzi, uzi_po4ek, id_uzi_po4ek, stop_for_uzi_po4ek)
    new_doubler_main(["узи", "ультразвук"], ["почек и надпочечни", "почек с надпочечникам", "надпочечники и почки", "надпочечников и почек", "почки и надпочечников", "почки + надпочечники", "почек, надпочечников"], ["дет", "реб", "други", "втор", "описани", "расшифров", "пузыр", "занятий", "посещени", "для", "во время", "курс", "навед", "пункц", "контрол"], "УЗИ почек", 47426, 540984, "УЗИ брюшной полости")
    ...
    new_doubler_main(["дуплекс", "уздс", "дс "], ["артерий и вен верхних конечностей", "сосудов (артерий и вен) верхних конечностей", "артерий и вен рук", "артерий и вен верхней конечности", "артерий и вен на верхн", "вен и артерий рук", "вен и артерий верхн", "сосудов верхн", "сосудов рук"], ["ребен", "перед", "дет", "одного", "бры", "чрев"], "Дуплексное сканирование вен верхних конечностей", 1415, 546691, "Дуплексное сканирование")
    new_doubler_main(["дуплекс", "уздс", "дс "], ["артерий и вен нижн", "артерий и вен ног", "вен и артерий ног", "вен и артерий ниж", "сосудов нижн", "сосудов ног", "(артерий и вен) нижних"], ["ребен", "перед", "дет", "одного", "ного", "бры", "чрев"], "Дуплексное сканирование вен нижних конечностей", 1415, 2109275, "Дуплексное сканирование")
    new_doubler_main(["дуплекс", "уздс", "дс "], ["артерий и вен верхних конечностей", "артерий и вен рук", "артерий и вен верхней конечности", "артерий и вен на верхн", "сосудов (артерий и вен) верхних конечностей", "вен и артерий рук", "вен и артерий верхн", "сосудов верхн", "сосудов рук"], ["ребен", "перед", "дет", "одного", "бры", "чрев"], "Дуплексное сканирование артерий верхних конечностей", 1415, 866862, "Дуплексное сканирование")
    new_doubler_main(["дуплекс", "уздс", "дс "], ["артерий и вен нижн", "артерий и вен ног", "вен и артерий ног", "вен и артерий ниж", "сосудов нижн", "сосудов ног", "(артерий и вен) нижних конечностей"], ["ребен", "перед", "дет", "ного", "одного", "бры", "чрев"], "Дуплексное сканирование артерий нижних конечностей", 1415, 2109271, "Дуплексное сканирование")
    ...
    new_doubler_main(["вправлени", "устранение"], ["вывиха крупн", "вывихов крупн", "крупных сустав", "крупный сустав", "крупного суста", "крупном суста", "сустав (круп", "большой сустав", "большом суставе", "большого сустава", "больших суст"], ["дет", "кроме", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время"], "Вправление вывиха", 49585, 1132290, "Вправление вывиха")
    ...
    new_doubler_main(["экг", "электрокардиографи", "электрокардиограм"], ["с расшифровкой", "включая расшифровку", "и расшифровка"], ["дет", "акц", "дом", "выезд", "неб", "сут", "монитор", "ад", "давлен", "холтер", "нагрузка", "нагрузкой", "стресс", "пищевод", "реб", "втор", "занятий", "расшифровка", "описание", "посещени", "под", "для", "во время", "курс"], "ЭКГ", 1060, 405, "ЭКГ и АД")
    ...
    perfect_match(["взятие крови из вены", "взятие крови", "забор крови", "забор  крови", "венопункция (взрослые, дети)", "взятие крови для анализа из вены", "забор крови из вены", "забор крови из периферической вены", "взятие крови из периферической вены", "забор венозной крови", "взятие венозной крови", "забор крови(вена)", "взятие крови (вена)", "взятие крови (из вены)", "забор крови для анализов", "забор крови из вены (пальца)", "взятие крови из периферической вены", "забор крови из периферической вены ( пациенты от 5 лет)"], "Забор крови")
    perfect_match(["взятие мазка", "взятие мазка из носа", "забор мазка из влагалища", "получение цервикального мазка", "забор мазка из носа и зева", "взятие мазка из зева", "забор мазка", "взятие мазков из уретры", "взятие материала ( соскоб)", "взятие (забор) гинекологического мазка", "взятие гинекологического мазка", "получение влагалищного мазка", "забор материала на анализ (мазок) на приеме", "забор мазков для исследования из носа, уха или горла (без стоимости исследования) (1 забор)", "получение урогенитального мазка", "получение влагалищного мазка на флору, онкоцитологию, ПЦР исследование, бакпосев", "взятие мазка из уретры"], "Взятие мазка")
    ...
    main_func(["лазер"], ["папил"], "Лазерное удаление папиллом", ["дет", "более", "свыше", "след", "11-20", "6-", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["лазер"], ["кондил", "кандил"], "Лазерное удаление кондилом", ["дет", "более", "свыше", "след", "11-", "6-", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["интерпретация результатов", "второе мнение", "консилиум" , "совместный осмотр двух врачей"], ["друго", "второе мнение", "консилиум", "совместный осмотр двух врачей"], "Второе мнение врача", ["дет", "привлече", "для участия в консилиуме", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    ...
    main_func(["каппа", "каппы", "капа", "капы"], ["спорт", "бруксиз", "разгрузоч", "ретенци", "лечение", "ортодонти", "релаксац"], "Капы для зубов", ["дет", "реб", "втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    ...
    main_func(["чистка", "комплекс", "гигиен", "отложен", "сняти"], ["air", "эйрфлоу", "эйр флоу", "аэрфло"], "Чистка зубов AirFlow", ["дет", "реб", "професси", "комплекс", "втор", "курс", "1 зуб", "скидк", "без", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["flow"])
    ...
    main_func(["ортопантомограмма", "оптг", "ортопантомография", "панорамн"], ["ортопантомограмма", "оптг", "ортопантомография", "рентген"], "Ортопантомограмма", ["дет", "реб", "по результатам","медицинское заключен", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["ортопантомограмма", "оптг", "ортопантомография", "зуб"])
    ...
    main_func(["времен"], ["коронк"], "Временные коронки", ["дет", "фиксаци", "реб", "втор", "акци", "восстановление куль", "отбели", "цементировка", "временный цемент", "имплант", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
    ...
    main_func(["имплант"], ["alpha bio", "альфа био", "alfa", "альфа-био", "alpha - bio"], "Импланты Alpha Bio", ["дет", "формировате", "аналог", "времен", "фдм", "коронк", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["анкилос", "ankilos", "ankylos"], "Импланты ANKYLOS", ["дет", "формировате", "фдм", "реб", "коронк", "аналог", "точка опоры", "времен", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    ...
    main_func(["имплант"], ["mis"], "Импланты MIS", ["дет", "реб", "втор", "акци", "отбели", "описани", "формировате", "фдм", "расшифров", "коронк", "точка опоры", "занятий", "аналог", "времен", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["nobel", "нобел"], "Импланты Nobel Biocare", ["дет", "реб", "втор", "акци", "формировате", "фдм", "отбели", "коронк", "описани", "точка опоры", "расшифров", "аналог", "времен", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["осстем", "остем", "osstem", "ostem"], "Импланты Osstem", ["дет", "реб", "формировате", "фдм", "втор", "на 4", "на 6", "акци", "коронк", "точка опоры", "отбели", "описани", "аналог", "времен", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["xive"], "Импланты XIVE", ["дет", "реб", "втор", "акци", "отбели", "описани", "формировате", "фдм", "расшифров", "коронк", "занятий", "посещени", "точка опоры", "аналог", "времен", "во время", "для", "курс"] )
    main_func(["имплант"], ["zimmer", "циммер", "зиммер"], "Импланты Zimmer", ["дет", "реб", "втор", "формировате", "фдм", "акци", "отбели", "коронк", "описани", "расшифров", "точка опоры", "аналог", "времен", "занятий", "посещени", "во время", "для", "курс"] )
    ...
    main_func(["установка", "прямой", "индивидуаль", "alpha", "шаровид", "углово", "adin", "alfa", "двойной", "стандартный"], ["абатмент", "абантмент", "аббатмент"], "Установка абатмента", ["дет", "реб", "времен", "втор", "акци", "отбели", "описани", "расшифров", "без установки абат", "без стоимости абат", "не включая аба", "отдельно", "занятий", "посещени", "во время", "для", "курс"] )
    ...
    main_func(["культев", "культивая", "культевой"], ["вкладк"], "Культевая вкладка", ["дет", "реб", "втор", "акци", "отбели", "времен", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс", "не включа", "привар", "удал", "почин", "допол", "снятие"])
    ...
    main_func(["lm", "l-m"], ["активат"], "LM-активатор", ["дет", "реб", "осмотр", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "контрол"])
    ...
    main_func(["альвеол"], ["эктом", "удал"], "Альвеолэктомия", ["дет", "реб", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    main_func(["удал", "ампутац"], ["корня"], "Удаление корня зуба", ["дет", "реб", "втор", "описани", "кисты", "через лун", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    ...
    main_func(["композит"], ["винир"], "Композитные виниры", ["дет", "реб", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    ...
    main_func(["удлинени", "увелич"], ["коронк"], "Удлинение коронковой части зуба", ["дет", "реб", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    ...
    main_func(["дома"], ["opales", "опелс", "опалес"], "Домашнее отбеливание Opalescence", ["дет", "реб", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    ...
    main_func(["циркони"], ["коронк"], "Циркониевые коронки", ["дет", "реб", "втор", "имплант", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    ...
    main_func(["ортопед"], ["стелек", "стельки", "формто", "formt"], "Изготовление ортопедических стелек", ["дет", "реб", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    ...
    main_func(["ретейнер"], ["ретейнер"], "Ретейнеры", ["дет", "реб", "втор", "сня", "удал", "чис", "чин", "ремон", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    ...
    main_func(["метал","лит"], ["коронк"], "Цельнометаллические коронки", ["дет", "реб", "керам", "емакс", "e-max", "сня", "втор", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс", "импла", "удал", "извле"])
    main_func(["метал"], ["керам"], "Металлокерамические коронки", ["дет", "реб", "сня", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс", "импла", "удал", "извле"], ["корон"])
    main_func(["керам", "емакс", "e-max", "emax", "e max"], ["коронк"], "Керамические коронки", ["дет", "реб", "втор", "сня", "метал", "лит", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс", "импла", "удал", "извле"])
    ...
    main_func(["бабочк", "иммедиа", "имедиа"], ["бабочк", "протез"], "Иммедиат-протез Бабочка", ["дет", "реб", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    main_func(["штифт"], ["штифт"], "Установка зубного штифта", ["дет", "реб", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
    ...
    main_func(["тест", "возбудител", "рнк", "забор на коронавирус"], ["коронавирус", "covid", "забор на коронавирус"], "Тест на коронавирус", ["лмк", "книж", "рино", "адено", "профосмо", "парво", "бока", "инфекций", "антител", "профпат", "вакцин"])
...
def lab_finder():
    ...
    ########################################################################################################
    def new_doubler_lab(name_1, name_2, stopword, what_double, what_double_section, what_double_service, what_double_title):
        wb.active = 1                                            
        sheet_1 = wb.active                                                         
        rows, columns = sheet_1.max_row, sheet_1.max_column
        for i in range(1, rows+1):
    ...
    new_doubler_lab(["впч", "папиллом", "папилом", "hpv"], ["высок", "онкоген", "канцеро", "16, 18, 31, 33", "16/18/31/33", "16, 18, 30, 31, 33"], ["прижиг", "удал", "книж", "низ"], "Анализ ВПЧ", 28804, 1131878, "Анализ ВПЧ")
    ...
    new_lab_finder(["аллерг", "панель"], ["живот", "кошк", "собак", "шерст", "лошад", "коров"], "Анализ на аллергию к животным", ["шерстис", "бухар"])
    ...
    new_lab_finder(["аллерг", "панель"], ["насеком", "таракан"], "Анализ на аллергию к насекомым", ["туширова"])
    ...
    new_doubler_lab(["hla"], ["drb1, dqa1, dqb1", "dqa1, drb1, dqb1", "dqb1, dqa1, drb1", "dqa1, dqb1, drb1", "drb1, dqb1, dqa1", "drb1, dqa1, dqb1", "hla-dqa1, hla-dqb1, hla-drb", "гистосовместимост", "комплекс", "по трем генам"], ["уроген", "андрофлор", "патоген", "chla", "локус dqa1", "локус dqb1", "локус drb1", "b27", "1 локус", "один локус", "одному локусу", "абакавир", "5701", "чувств"], "HLA-типирование", 49243, 1875930, "HLA-типирование")
    ...
    perfect_match_lab(["взятие крови из вены", "взятие крови", "забор крови", "забор крови из вены", "забор крови из периферической вены", "венопункция (взрослые, дети)", "забор  крови", "взятие крови из периферической вены", "забор венозной крови", "взятие венозной крови", "забор крови(вена)", "взятие крови для анализа из вены", "взятие крови (вена)", "взятие крови (из вены)", "забор крови для анализов", "забор крови из вены (пальца)", "взятие крови из периферической вены", "забор крови из периферической вены ( пациенты от 5 лет)"], "Забор крови")
    perfect_match_lab(["взятие мазка", "забор мазка", "взятие мазка из носа", "забор мазка из влагалища", "получение цервикального мазка", "забор мазка из носа и зева", "взятие мазка из зева", "взятие мазков из уретры", "взятие (забор) гинекологического мазка", "взятие материала ( соскоб)", "забор материала на анализ (мазок) на приеме", "взятие гинекологического мазка", "забор мазков для исследования из носа, уха или горла (без стоимости исследования) (1 забор)", "получение влагалищного мазка", "получение урогенитального мазка", "получение влагалищного мазка на флору, онкоцитологию, ПЦР исследование, бакпосев", "взятие мазка из уретры"], "Взятие мазка")
