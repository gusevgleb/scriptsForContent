#! /usr/bin/env python
# -*- coding: utf-8 -*-
# ВАЖНО - ЕСТЬ РАЗДЕЛЕНИЕ ПОИСКА ЛАБОРАТОРКИ И ОБЫЧНЫХ УСЛУГ, РАБОТАЕТ ТОЛЬКО С ПРОПИСНЫМ БУКВАМИ,"
...
def without_lab_func():
	...
	id_uzi_molo4nih_jelez, uzi_molo4nih_jelez_2, stop_for_uzi_molo4nih_jelez, uzi_molo4nih_jelez_3 = "УЗИ молочных желез", ["молочн", "груд"], ["ребен", "дет", "лимф", "втор", "муж", "пункц", "под ", "девоч", "терапия", "воздей", "возде", "кавита", "допол", "до 1", "до 2", "до 3", "прием"], ["желез", "желёз"]
	...
	main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий", "эндометрийо"], ["азот", "крио"], "Прижигание эрозии шейки матки жидким азотом", ["дет", "папил", "опухол", "кони", "кондил", "влаг", "вульв", "образован", "деструкцией шейки", "деструкцией матки", "деструкция шейки", "деструкция матки", "деструкции шейки", "деструкции матки", "ампутац", "биопси", "кист", "набот", "желез", "удал", "резекц", "реб", "желуд", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий", "эндометрийо"], ["лазер"], "Прижигание эрозии шейки матки лазером", ["дет", "этап", "реб", "терап", "папил", "шлиф", "кониз", "кондил", "влаг", "вульв", "опухол", "образован", "втор", "кист", "биопси", "набот", "желез", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий", "эндометрийо"], ["солковаг", "медикамент", "медимикамент", "лекарств", "консервативное лечение", "химическ"], "Прижигание эрозии шейки матки Солковагином", ["дет", "кони", "влаг", "вульв", "папил", "опухол", "кондил", "образован", "реб", "кист", "набот", "желез", "втор", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий", "эндометрийо"], ["радио", "сурги"], "Радиоволновое прижигание эрозии шейки матки", ["дет", "сине", "сеч", "биопси", "реб", "опухол", "кони", "папил", "кондил", "влаг", "вульв", "кист", "набот", "желез", "образован", "втор", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["экг", "электрокардиографи", "электрокардиограм"], ["экг", "электрокардиографи", "электрокардиограмм"], "ЭКГ", ["дет", "акц", "перед", "дом", "запо", "выезд", "после", "проф", "дополн", "неб", "сут", "монитор", "без экг", "ад", "давлен", "холтер", "нагруз", "стресс", "пищевод", "реб", "втор", "занятий", "расшифровка", "описание", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["удал", "деструк", "прижига"], ["кондилом", "кандилом"], "Удаление кондилом вульвы", ["дет", "реб", "втор", "описани", "след", "свыше", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["вульв"])
	main_func(["удал", "деструк", "прижига"], ["папиллом", "папилом"], "Удаление папиллом вульвы", ["дет", "реб", "втор", "описани", "след", "свыше", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["вульв"])
	...
	main_func(["хирурги", "механич"], ["папил"], "Хирургическое удаление папиллом", ["дет", "ради", "магнит", "от 20", "сурги", "коагул", "электр", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
...
def lab_finder():
	...
	new_lab_finder(["уреазн", "дыхательный тест", "дыхательного теста"], ["уреазн", "дыхательный тест", "дыхательного теста", "helicobacter", "хеликобактер", "хиликобактер"], "Дыхательный тест на хеликобактер", ["плода", "крови матери", "гена", "кровь"])
	...
	new_lab_finder(["аллерг", "панель"], ["живот", "кошк", "собак", "шерст", "лошад", "коров"], "Анализ на аллергию к животным", ["шерстис", "бухар", "бытов"])
