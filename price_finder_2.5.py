...
''''
Для нового шаблонаd
сделать чтобы не брать 0 в цену
цистосцопию дублировать мужскую и женскую
аборты добавить
дублировать заднюю тампонаду носа
Биометрия глаза вгнести
Криосауна внести Альвеолэктомия
Удаление корня зуба (ампутация корня)
Керамические виниры
Композитные виниры
Операции при опущении половых органов
остеосинтез добавить?
'''
start_time = datetime.now()
print("скачать шаблон мск - 1")
print("скачать шаблон спб - 2")
print("не скачивать шаблон - 0")
change_city_id = int(input())
# change_city_id = 0
...
if change_city_id != 0:
    ...
    chrome_options.add_argument(path + "/chromedriver_win32")
    ...
    driver = webdriver.Chrome(path + "/chromedriver_win32/chromedriver.exe", chrome_options=chrome_options)
    driver.get("https://napopravku.ru:BWZyq1QvhZ@analytics.napopravku.ru/bitrix/admin/gen_price_template.php")



    s_username = driver.find_elements_by_class_name("login-input")[0]
    s_password = driver.find_elements_by_class_name('login-input')[1]
    s_continue = driver.find_element_by_class_name('login-btn-green')
    s_username.send_keys("g.gusev@napopravku.ru")
    s_password.send_keys("BWZyq1QvhZ")
    s_continue.click()
    time.sleep(2)
    driver.refresh()
    time.sleep(1)
    select = Select(driver.find_element_by_name('city_id'))

    if change_city_id == 1:
        select.select_by_value("263")
    if change_city_id == 2:
        select.select_by_value("2") 

    select = Select(driver.find_element_by_name('template_type'))
    select.select_by_value("1")
    driver.find_elements_by_class_name("adm-btn-save")[1].click()
    print("Cкачиваю шаблон")
    time.sleep(3)                                                                           
######################################################################################################################################
...
vakcine = [865244, 1836640, 1836626, 2492189, 1913367, 940421, 1836613, 2492186, 1836634, 1124103, 1836620, 2216902, 865253, 1134599, 2375472, 1134600, 1836631, 2245240, 1836651, 1836652, 865248, 1836615, 1836650, 1836654, 1836621, 1836628, 865250, 1836641, 1836642, 1836616, 1836622, 1132361, 1836653, 1836638, 1836618, 1836632, 1836629, 1836655, 1132362, 865257, 865254, 1134294, 1134293, 865260, 865255, 865245, 865246, 1134570, 865276, 1132363, 865256, 1828795, 865275, 2114790, 865252, 865274, 1132364, 865258, 2114794, 865249, 1134314, 1134316, 865259, 1134319, 865251, 1132365, 1836623, 1836607, 2007408, 2007409, 2007410, 1836619, 1836630, 1836645, 1836633, 1836646, 1836647, 1836635, 1836648, 1836614, 1836625, 1836624, 1836617, 1836627, 1836649, 2007407]
...
def add_sostavnie():
    ...
    for i in range(1, rows +1):
        ...
        if cell != None and cell in blood:
            ...
            sheet.cell(row = i, column = 10).fill = PatternFill("solid", fgColor="FFFFFF")
            sheet.cell(row = i, column = 9).fill = PatternFill("solid", fgColor="FFFFFF")
            sheet.cell(row = i, column = 7).fill = PatternFill("solid", fgColor="FFFFFF")
            sheet.cell(row = i, column = 7).fill = PatternFill("solid", fgColor="FFFFFF")
        
    for i in range(1, rows+1):
        if str(sheet.cell(row = i, column = 4).value) in lab_list_1:
            sheet.cell(row = i, column = 4).fill = PatternFill("solid", fgColor="FFFF00")
        if str(sheet.cell(row = i, column = 4).value) in lab_list_2:
            sheet.cell(row = i, column = 4).fill = PatternFill("solid", fgColor="FFFF00")
...
def without_lab_func():
    ...
    for i in range(1, rows+1):
        ...
        if comma[0] in cell_value_with_comma:
            ...
            stop_int = re.search('|'.join(ints), cell_value_with_comma) != None
            if stop_int == False:
                print(sheet_0.cell(row = i, column = 3).value, sheet_0.cell(row = i, column = 2).value, sheet_0.cell(row = i, column = 1).value)
                sheet_0.cell(row = i, column = 3).value = int(float(sheet_0.cell(row = i, column = 3).value))


    for i in range(1, rows + 1):
        cell_with_yo = str(sheet_0.cell(row = i, column = 2).value)
        if yo in cell_with_yo:      
            sheet_0.cell(row = i, column = 2).value = cell_with_yo.replace('ё','е')
    ...
    def new_doubler_main(name_1, name_2, stopword, what_double, what_double_section, what_double_service, what_double_title, service_or_method):
        print("запущен нью даублер мейн для " + what_double)
        wb.active = 1                                            
        sheet_1 = wb.active                                                         
        ...
        for i in range(1, rows + 1):
            if sheet_1.cell(row = i, column = 4).value == what_double:                  
                ...
                sheet_1.cell(row = i, column = 1).value = what_double_section
                sheet_1.cell(row = i, column = 2).value = what_double_service
                sheet_1.cell(row = i, column = 3).value = what_double_title
                sheet_1.cell(row = i, column = 4).value = what_double
                sheet_1.cell(row = i, column = 11).value = service_or_method
                break   
                                                ...
                                                if cell_value_from_price != sheet_1.cell(row = k, column = 5).value and cell_value_from_price != "":
                                                    if sheet_0.cell(row = i, column = 3).value != None:                             
                                                        if sheet_1.cell(row = k, column = 5).value == None:             
                                                            ...
                                                            sheet_1.cell(row = k, column = 6).value = 0 
                                                            ...
                                                            link_for_sheet_1 = "#" + wb.sheetnames[0] + "!" + str(sheet_0.cell(row = i, column = 3).coordinate)
            ...
            for m in range(1, 3600):
                ...
                if cell_id == str(cell_sheet_1):
                    ...
                    if len(set(a)) > 1:
                        ...
                        sheet_1.cell(row = m, column = 6).value = 0
    ...
    def main_func(name_1, name_2, cell_id, stopword, name_3=100):
        ...
        for i in range(1, main_loop + 1):
            cell_value_name_from_price = str(sheet_0.cell(row = i, column = 2).value) # перебираем названия услуг в прайсе клиники
            for j in range(0, len(name_1)): # перебираем список слов из _ключевых_слов_1 на наличие в названии услуги
                
                if name_1[j] in cell_value_name_from_price: #если что-то из _ключевых_слов_1 нашлось в названии услуги, то:
                    #print(name_1[j])
                    #print(name_2)
                    for m in range(0, len(name_2)): # перебираем список слов из _ключевых_слов_2 на наличие в названии услуги
                        #print(name_2[m])
                        if name_2[m] in cell_value_name_from_price: #если что-то из _ключевых_слов_2 нашлось в названии услуги, то:
                                ...
                                for g in range(0, len(name_3)):
                                    if name_3[g] in cell_value_name_from_price:
                                        ...
                                        if stop_word == False:
                                            if sheet_0.cell(row = i, column = 3).value != '' and sheet_0.cell(row = i, column = 3).value != None:
                                                if str(sheet_0.cell(row = i, column = 3).value).isdigit():
                                                    cell_value_from_price = round(int(sheet_0.cell(row = i, column = 3).value)) # это цена для услуги                                   
                                                    wb.active = 1
                                                    sheet_1 = wb.active
                                                    rows, columns = sheet_1.max_row, sheet_1.max_column
                            ...
                            if name_3 == 100:
                                ...
                                #print(stop_word)
                                if stop_word == False:
                                    #print(sheet_0.cell(row = i, column = 3).value)
                                    if sheet_0.cell(row = i, column = 3).value != '' and sheet_0.cell(row = i, column = 3).value != None:
                                        if str(sheet_0.cell(row = i, column = 3).value).isdigit():
                                            cell_value_from_price = round(int(sheet_0.cell(row = i, column = 3).value)) # это цена для услуги
                                            #print(cell_value_from_price)
                                            wb.active = 1
                                            sheet_1 = wb.active
                                            rows, columns = sheet_1.max_row, sheet_1.max_column
                                            ...
                                            for k in range(1, rows):
                                                cell_value_name_from_template = str(sheet_1.cell(row = k, column = 4).value)
                                                #print(cell_value_name_from_template)
                                                if cell_id == cell_value_name_from_template:
                                                    #print(cell_value_name_from_template)
                                                    print(cell_value_from_price, cell_value_name_from_template)
                                                    if cell_value_from_price != sheet_1.cell(row = k, column = 5).value and cell_value_from_price != "":
                                                        if sheet_0.cell(row = i, column = 3).value != None:
                                                            if sheet_1.cell(row = k, column = 5).value == None:             
                                                                sheet_1.cell(row = k, column = 5).value = cell_value_from_price
    ...
    id_uzi_kishe4nika, uzi_kishe4nika_2, stop_for_uzi_kishe4nika = "УЗИ кишечника", ["кишечник", "прямой кишки"], ["ребен", "дет", "терапия", "воздей", "под", "контрол", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    id_uzi_limfouzlov, uzi_limfouzlov_2, stop_for_uzi_limfouzlov = "УЗИ лимфоузлов", ["лимф"], ["ребен", "дет", "молочн", "пункц", "терапия", "воздей", "под", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    id_uzi_malogo_taza, uzi_malogo_taza_2, stop_for_uzi_malogo_taza = "УЗИ малого таза", ["таза", "гинекологическое"], ["ребен", "брюш", "щитовид", "плод", "триместр", "терапия", "воздей", "треместр", "беремен", "втор", "недел", "после", "аборт", "контрол", "дет", "абдомин", "живот", "ваги", "влага", "ta", "воздей", "кавита", "беремен", "tv", "вен", "кг", "кардиограф", "фолликулометр", "под", "расшир"]
    ...
    id_uzi_malogo_taza_tv, uzi_malogo_taza__tv_2, uzi_malogo_taza__tv_3, stop_for_uzi_malogo_taza_tv = "УЗИ малого таза трансвагинально", ["таза", "гинекологи", "трансвагинально", "твузи", "женских половых органов"], ["ваги", "твузи", "влага", "tv", "тv"], ["ребен", "после", "терапия", "воздей", "аборт", "контрол", "втор", "дет", "под", "воздей", "кавита", "контрол", "беремен"]
    ...
    id_uzi_molo4nih_jelez, uzi_molo4nih_jelez_2, stop_for_uzi_molo4nih_jelez, uzi_molo4nih_jelez_3 = "УЗИ молочных желез", ["молочн", "груд"], ["ребен", "дет", "лимф", "муж", "пункц", "под", "девоч", "терапия", "воздей", "возде", "кавита", "допол", "до 1", "до 2", "до 3", "прием"], ["желез", "желёз"]
    ...
    id_uzi_4lena, uzi_4lena_2, stop_for_uzi_4lena = "УЗИ полового члена", ["член"], ["ребен", "дет", "лонн", "сочлен", "сосуд", "артери", " вен", "под", "терапия", "воздей", "контрол", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    ...
    id_uzi_brushnoy, uzi_brushnoy_1, uzi_brushnoy_2, stop_for_uzi_brushnoy = "УЗИ брюшной полости", ["брюшн"], ["полост"], ["ребен", "дет", "органа", "1 орган", "один орган", "2 органа", "двух органов", "2-х органов", "плев", "жидко", "наличи", "свобод", "школ", "акц", "терапия", "воздей", "сердц", "щитовид", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    id_uzi_jeludka, uzi_jeludka, stop_for_uzi_jeludka = "УЗИ желудка", ["желудк"], ["ребен", "дет", "под", "терапия", "воздей", "контрол", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    ...
    id_uzi_po4ek, uzi_po4ek, stop_for_uzi_po4ek = "УЗИ почек", ["почек"], ["ребен", "дет", "под", "контрол", "щитовид", "пузыр", "мочев", "надпочеч", "терапия", "воздей", "комплексное узи органов", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    ...
    id_uzi_funkcii_jel4nogo, uzi_funkcii_jel4nogo_1, uzi_funkcii_jel4nogo_2, stop_for_uzi_funkcii_jel4nogo = "УЗИ функции желчного пузыря", ["функци", "сократи"], ["желч"], ["ребен", "дет", "под", "контрол", "терапия", "воздей", "без исследования функции", "без функци"]
    id_uzi_brushnoy_rebenku, uzi_brushnoy_rebenku_1, uzi_brushnoy_rebenku_2, stop_for_uzi_brushnoy_rebenku = "УЗИ брюшной полости ребенку", ["брюшной"], ["ребен", "детям", "детей"], ["диспан", "терапия", "воздей", "под", "контрол"]
    ...
    id_uzi_jeludka_rebenku, uzi_jeludka_rebenku_1, uzi_jeludka_rebenku_2, stop_for_uzi_jeludka_rebenku = "УЗИ желудка ребенку", ["желудк"], ["ребен", "дет"], ["диспан", "терапия", "воздей", "под", "контрол"]
    ...
    uzi_mo4evogo_rebenku, id_uzi_mo4evogo_rebenku, stop_for_uzi_mo4evogo_rebenku, uzi_mo4evogo_rebenku_2 = ["мочево"], "УЗИ мочевого пузыря ребенку", ["диспан", "под", "терапия", "воздей", "контрол"], ["ребен", "дет"]
    ...
    uzi_po4ek_rebenku, id_uzi_po4ek_rebenku, stop_for_uzi_po4ek_rebenku, uzi_po4ek_rebenku_2 = ["почек", "почк"], "УЗИ почек ребенку", ["диспан", "под", "терапия", "воздей", "контрол"], ["ребен", "дет"]
    ...
    uzi_serdca_rebenku, uzi_serdca_rebenku_2, id_uzi_serdca_rebenku, stop_for_uzi_serdca_rebenku, uzi_serdca_rebenku_3 = ["эхо", "узи", "ультразвук"], ["кг", "кардиограф", "серд"], "УЗИ сердца (ЭхоКГ) ребенку", ["диспан", "под", "контрол"], ["ребен", "дет"]
    ...
    uzi_shitovid_rebenku, id_uzi_shitovid_rebenku, stop_for_uzi_shitovid_rebenku, uzi_shitovid_rebenku_2 = ["щитовидн"], "УЗИ щитовидной железы ребенку", ["диспан", "под", "терапия", "воздей", "контрол"], ["ребен", "дет"]
    ...
    uzi_m9gkih_legkih, id_uzi_legkih, stop_for_uzi_legkih = ["легких", "бронхов"], "УЗИ легких и бронхов", ["ребен", "дет", "терапия", "воздей", "диффуз", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_m9gkih_plevri, id_uzi_plevri, stop_for_uzi_plevri = ["плевр"], "УЗИ плевральной полости", ["ребен", "терапия", "воздей", "дет", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_pozvono4, id_uzi_pozvono4, stop_for_uzi_pozvono4 = ["позвоночн"], "УЗИ позвоночника", ["ребен", "дет", "шей", "протру", "груд", "терапия", "воздей", "поясн", "отдела", "втор", "артерий", "сосудов", "вен", "втор", "навигац", "блок", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"] 
    ...
    uzi_serdca, uzi_serdca_2, id_uzi_serdca, stop_for_uzi_serdca = ["эхо", "узи", "ультразвук"], ["кг", "кардиограф", "серд"], "УЗИ сердца / ЭхоКГ", ["ребен", "кроме", "по результату", "дом", "перед", "терапия", "воздей", "для", "дет", "нагруз", "школ", "стресс", "пище", "плод", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    ...
    uzi_golenostop, id_uzi_golenostop, stop_for_uzi_golenostop = ["голеностоп"], "УЗИ голеностопного сустава", ["ребен", "нерв", "дет", "терапия", "воздей", "втор", "под", "контрол", "пункц", "пунктирование", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_kolen, id_uzi_kolen, stop_for_uzi_kolen = ["колен"], "УЗИ коленного сустава", ["ребен", "дет", "втор", "под", "терапия", "воздей", "нерв", "контрол", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_loktevogo, id_uzi_loktevogo, stop_for_uzi_loktevogo = ["локт", "локот"], "УЗИ локтевого сустава", ["ребен", "терапия", "воздей", "дет", "нерв", "втор", "под", "контрол", "пункц", "пунктирование", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_lu4ezap, id_uzi_lu4ezap, stop_for_uzi_lu4ezap = ["лучезап", "запяст"], "УЗИ лучезапястного сустава", ["ребен", "терапия", "воздей", "дет", "нерв", "втор", "под", "контрол", "пункц", "пунктирование", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    uzi_ple4, id_uzi_ple4, stop_for_uzi_ple4 = ["плечевого", "сустава плеча", "плечевых"], "УЗИ плечевого сустава", ["ребен", "терапия", "воздей", "нерв", "дет", "втор", "вен", "до плеча", "дуплекс", "под", "пункц", "контрол", "сплетен", "до 1", "до 2", "до 3", "до 18", "до 12", "до 10", "до 4", "до 5", "до 6"]
    ...
    dupleks, tripleks, uzdg = ["дуплекс", "уздс", "дс "], ["триплекс"], ["допплерограф", "доплерограф", "уздг", "доплер", "допплер"]
    dupleks_aorti, id_dupleks_aorti, stop_for_dupleks_aorti = ["аорт"], "Дуплексное сканирование аорты", ["ребен", "дет", "под", "терапия", "воздей", "брюш", "контрол"]
    ...
    dupleks_brahiocefal, id_dupleks_brahiocefal, stop_for_brahiocefal = ["брахиоцефал"], "Дуплексное сканирование брахиоцефальных артерий", ["ребен", "терапия", "воздей", "дет", "под", "контрол"]
    ...
    tkdg, id_tkdg, stop_for_tkdg, tkdg_2 = ["транскрани", "ткдг", "транскарни", "ткдс"], "ТКДГ сосудов головного мозга", ["ребен", "дет", "под", "контрол", "стимуляц"], ["мозг", "допплеро", "артерий", "вен", "ткдс"]
    ...
    elastograf_pe4en, elastograf_pe4en_2, id_elastograf_pe4en, stop_for_elastograf_pe4en = ["эластограф", "сэг", "эластометрия"], ["печен"], "Эластография печени", ["ребе", "дет"]
    ...
    neirosonografia, neirosonografia_2, id_neirosonografia, stop_for_neirosonograf = ["нейро", "узи", "ультразвук"], ["соно", "мозга"], "Нейросонография / УЗИ головного мозга ребенку", ["перфуз", "щитовид", "эластограф", "допол", "черн", "субстанц", "паркинс", "транскрани", "магнит", "терапия", "воздей", "мрт", "терапи", "сонопульс", "аппарат", "зона", "мр", "эндосонограф", "эндоузи"]
    ...
    kolposkopia_video, kolposkopia_video_2, id_kolposkopia_video, stop_for_kolposkopia_video, kolposkopia_video_3 = ["кольпо"], ["скоп"], "Видеокольпоскопия", ["реб", "дет", "прием", "консул"], ["видео"]
    ...
    laringoskop, laringoskop_2, id_laringoskop, stop_for_laringoskop = ["ларингоскопия", "эндоскоп"], ["ларингоскопия", "гортан", "глотк"], "Ларингоскопия", ["микро", "биопси", "мини", "реб", "дет", "регистр", "запись", "данн", "прием", "консул"]
    ...
    audiogramma, audiogramma_2, id_audiogramma, stop_for_audiogramma = ["аудио"], ["грамм", "метр"], "Аудиометрия / Аудиограмма", ["реб", "дет", "вебер", "порог", "прием", "консул"]
    ...
    tamponada_nosa, tamponada_nosa_2, id_tamponada_nosa, stop_for_tamponada_nosa = ["тампон"], ["нос"], "Тампонада носа", ["реб", "удал", "ринит", "хронич", "уретр", "перетамп", "извлеч", "лун", "зуб", "стома", "дес", "влага", "гине", "вуль", "мат", "дет", "удал", "извлеч"]
    ...
    otoskopia, otoskopia_2, id_otoskopia, stop_for_otoskopia = ["отоскопи", "эндоскопия"], ["отоскопи", "уха", "ушных", "ушей", "слухо"], "Отоскопия", ["микро", "регистр", "запись", "данн", "оториноларинголог", "лор"]
    ...
    otoakustik, otoakustik_2, id_otoakustik, stop_for_otoakustik = ["акусти"], ["эмисс"], "Отоакустическая эмиссия", ["реб", "дет"]
    ...
    refraktometr, refraktometr_2, id_refraktometr, stop_for_refraktometr = ["рефрактометрия", "авторефрактометрия"], ["рефрактометрия", "авторефрактометрия"], "Рефрактометрия", ["дет", "реб", "повтор", "направле", "после", "преодплат"] 
    ...
    instil_mo4e, instil_mo4e_2, id_instil_mo4e, stop_for_instil_mo4e = ["инстил"], ["мочевого", "мочевой"], "Инстилляция мочевого пузыря", ["заглушка"]
    ...
    inorod_glotki, inorod_glotki_2, id_inorod_glotki, stop_for_inorod_glotki = ["инород", "посторонн"], ["глотки"], "Удаление инородного тела из глотки", ["дет", "реб", "втор"]
    ...
    inorod_uha, inorod_uha_2, id_inorod_uha, stop_for_inorod_uha = ["инород", "посторонн"], ["уха", "ушной", "ушей", "ушных", "ухо"], "Удаление инородного тела из уха", ["дет", "реб", "втор"]
    ...
    kukushka, kukushka_2, id_kukushka, stop_for_kukushka = ["процедур", "промыва", "санац", "чистк", "кукушк", "проетц", "проэтц"], ["кукушк", "проетц", "проэтц"], "Процедура Кукушка", ["дет", "реб", "втор"]
    ...
    bujir_anal, bujir_anal_2, id_bujir_anal, stop_for_bujir_anal = ["бужирован"], ["анальн"], "Бужирование анального отверстия", ["дет", "реб", "втор"]
    ...
    block_krest_povz, block_krest_povz_2, id_block_krest_povz, stop_for_block_krest_povz, block_krest_povz_3 = ["блокад"], ["крест"], "Блокада крестцово-подвздошного сочленения", ["дет", "реб", "втор"], ["подвздош", "повздош"]
    ...
    block_sustav, block_sustav_2, id_block_sustav, stop_for_block_sustav = ["блокад", "периартикулярное введение алфлутоп"], ["сустав", "периартикулярн", "параартикулярн", "интраартикулярн", "периартикулярное введение алфлутоп"], "Блокада сустава", ["дет", "реб", "устране", "позвон", "лечен", "исправлен"]
    block_to4ek, block_to4ek_2, id_block_to4ek, stop_for_block_to4ek = ["блокад"], ["триггер", "миофасциальн"], "Блокада триггерных точек", ["дет", "реб", "втор"]
    block_nosa, block_nosa_2, id_block_nosa, stop_for_block_nosa = ["блокад"], ["носа", "носов", "эндоназальн"], "Внутриносовая блокада", ["дет", "реб", "втор"]
    ...
    block_epidural, block_epidural_2, id_block_epidural, stop_for_block_epidural = ["блокад"], ["эпидурал"], "Эпидуральная блокада", ["дет", "реб", "втор"]
    ...
    piling_almaz, piling_almaz_2, id_piling_almaz, stop_for_piling_almaz = ["пилинг"], ["алмазн"], "Алмазный пилинг", ["дет", "реб", "втор", "акци", "допол"]
    ...
    piling_jeltiy, piling_jeltiy_2, id_piling_jeltiy, stop_for_piling_jeltiy = ["пилинг"], ["желт", "ретино", "yellow"], "Желтый химический пилинг", ["дет", "реб", "втор", "акци", "допол"]
    ...
    piling_jessner, piling_jessner_2, id_piling_jessner, stop_for_piling_jessner = ["пилинг"], ["джесснер", "джеснер"], "Пилинг Джесснера", ["дет", "реб", "втор", "допол"]
    piling_tsa, piling_tsa_2, id_piling_tsa, stop_for_piling_tsa = ["пилинг", "tca 15%"], ["тса", "трихлор", "tca", "tca 15%"], "Пилинг ТСА", ["дет", "реб", "втор", "допол"]
    ...
    piling_salicil, piling_salicil_2, id_piling_salicil, stop_for_piling_salicil = ["пилинг"], ["салицил"], "Салициловый химический пилинг", ["дет", "реб", "акци", "втор", "допол"]
    ...
    kolonoskop, kolonoskop_2, id_kolonoskop, stop_for_kolonoskop = ["колоноскоп", "фкс"], ["колоноскоп", "фкс"], "Колоноскопия кишечника / ФКС", ["дет", "реб", "полип", "в ходе", "образова", "готов", "втор", "без", "акци", "анестез", "седац", "томограф", "кт ", "кт-", "кт - ", "кт- ", "наркоз"]
    fks_and_fgds, fks_and_fgds_2, id_fks_and_fgds, stop_for_fks_and_fgds = ["колоноскоп", "фкс", "вкс"], ["фгдс", "гастроскоп", "эндоскопия желудка", "вгдс"], "Колоноскопия и ФГДС под наркозом одновременно", ["дет", "готов", "полип", "образо", "в ходе", "акци", "реб", "втор", "при", "для"]
    fks_narkoz, fks_narkoz_2, id_fks_narkoz, stop_for_fks_narkoz = ["колоноскоп", "фкс"], ["под наркозом", "с наркозом", "седаци"], "Колоноскопия под наркозом", ["дет", "реб", "без седации", "без наркоза", "втор", "полип", "образ", "акци", "в ходе", "фгдс", "готов", "эгдс", "эзофаго", "гастроскоп"]
    ...
    beskon_tonometr, beskon_tonometr_2, id_beskon_tonometr, stop_for_beskon_tonometr = ["бесконтакт", "пневмо"], ["тонометр"], "Бесконтактная тонометрия", ["дет", "реб", "втор"]
    ...
    fluor_proba, fluor_proba_2, id_fluor_proba, stop_for_fluor_proba = ["флюоресце", "тест флюоресциииновый", "тест флюоресциин", "флуоресце", "флюоресцииин", "флюоресцин", "флюоресциииновый тест", "флюоресцииновый тест", "флюоресцеиновая проба", "флюоресцеиновая инстилляционная проба", "зайдел"], ["зайдел", "инстилл", "тест флюоресциииновый", "флюоресцеиновая проба", "тест флюоресциин", "флюоресциииновый тест", "флюоресцииновый тест", "люоресцеиновая инстилляционная проба"], "Флюоресцеиновая инстилляционная проба", ["дет", "реб", "втор"]
    ...
    biopsia_sheiki_matki, biopsia_sheiki_matki_2, id_biopsia_sheiki_matki, stop_for_biopsia_sheiki_matki = ["биопсия", "биопсии"], ["шейки матки"], "Биопсия шейки матки", ["дет", "реб", "втор", "прицель", "ножева"]
    ...
    aspirac_biop_endometr, aspirac_biop_endometr_2, id_aspirac_biop_endometr, stop_for_aspirac_biop_endometr = ["биопсия", "биопсии"], ["аспирац"], "Аспирационная биопсия эндометрия", ["дет", "реб", "втор"]
    ...
    fgds_narko, fgds_narko_2, id_fgds_narko_2, stop_for_fgds_narko_2 = ["фгдс", "гастроскоп", "эгдс"], ["наркоз", "седац"], "ФГДС под наркозом", ["дет", "реб", "втор", "колонос", "хромоскоп", "полип", "в ходе", "удал", "образ", "акци", "без"]
    ezofagogastroduodenoskop, ezofagogastroduodenoskop_2, id_ezofagogastroduodenoskop, stop_for_ezofagogastroduodenoskop = ["эзофагогастродуоденоскоп", "эгдс"], ["эзофагогастродуоденоскопия", "эгдс", "анестез"], "ЭГДС", ["дет", "полип", "прерва", "досроч", "в ходе", "удал", "образ", "акци", "при", "кислот", "реб", "втор", "удал", "хелико", "helico"]
    ...
    gisteroskop, gisteroskop_2, id_gisteroskop, stop_for_gisteroskop = ["гистероскопия", "гистероскопии"], ["гистероскопия", "гистероскопии"], "Гистероскопия", ["дет", "реб", "втор", "рдв", "выскаблива", "диагности", "гистероскопическ"]
    ...
    bos_terapi, bos_terapi_2, id_bos_terapi, stop_for_bos_terapi = ["бос-терапи", "биологическ", "бос "], ["обратн", "бос-терапи", "терапи"], "Бос-терапия", ["дет", "пия", "гируд", "перед", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "прогрев"]
    ...
    vlok, vlok_2, id_vlok, stop_for_vlok, vlok_3 = ["влок", "внутривенн", "облуч"], ["влок", "лазер"], "ВЛОК / Внутривенное лазерное облучение крови", ["дет", "реб", "над", "наруж", "втор", "вторич", "абонемент", "занятий", "посещени", "внеполостн", "при проведении"], ["влок", "кров"]
    ...
    lazeroterapi, lazeroterapi_2, id_lazeroterapi, stop_for_lazeroterapi = ["лазеротерапи", "лазерная терапия", "лазерное облучение кожи"], ["лазеротерапи", "лазерная терапия", "лазерное облучение кожи"], "Лазеротерапия", ["дет", "реб", "влок", "доп", "крови", "папил", "образ", "кондил", "образо", "добро", "фибр", "кровь", "втор", "вторич", "абонемент", "занятий", "посещени", "магнит", "десен", "стоматол"]
    ...
    magnitoterap, magnitoterap_2, id_magnitoterap, stop_for_magnitoterap = ["магнитотерап"], ["магнитотерап"], "Магнитотерапия", ["дет", "реб", "от 3", "более", "втор", "вторич", "абонемент", "занятий", "посещени", "внеполостн"]
    ...
    okuf, okuf_2, id_okuf, stop_for_okuf = ["куф", "ультрафиолет"], ["куф", "терапи", "лечен", "воздейств", "облучени"], "ОКУФ-терапия", ["дет", "длинн", "реб", "втор", "кров", "вторич", "абонемент", "занятий", "посещени", "внеполостн"]
    smt_terapi, smt_terapi_2, id_smt_terapi, stop_for_smt_terapi = ["смт", "амплипульс", "синусоидальн", "импульсн"], ["смт", "амплипульс", "терапи", "лечен", "воздейств", "ток"], "СМТ-терапия", ["дет", "доп", "реб", "втор", "внеполос", "наружн", "вторич", "абонемент", "занятий", "посещени"]
    ...
    uv4_terapi, uv4_terapi_2, id_uv4_terapi, stop_uv4_terapi = ["увч", "ультравысокочасто", "ультразвуковое лечение кожи"], ["терапи", "ультразвуковое лечение кожи"], "УВЧ-терапия", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
    uz_terapi, uz_terapi_2, id_uz_terapi, stop_uz_terapi = ["узи", "ультразвуко", "уз-", "уз - "], ["терапия", "ультразвуковой терапии", "сеанс"], "Ультразвуковая терапия", ["дет", "реб", "втор", "вторич", "протруз", "абонемент", "занятий", "посещени"]
    ufo_terapi, ufo_terapi_2, id_ufo_terapi, stop_ufo_terapi = ["уфо", "ультрафиолет"], ["терапи", "лечен", "воздейств", "уфо"], "УФО-терапия", ["дет", "куфо", " куф", "куф", "окуф", "кров", "вен", "коротк", "сосуд", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
    ...
    chens, chens_2, id_chens, stop_chens = ["чэнс", "чрескожная", "чрезскожная", "tens-терапия", "чрезкожная электронейростимуляция", "черескожная электонейростимуляция", "черескожная электронейростимуляция"], ["tens-терапия", "чэнс", "нейростимуляция", "электростимуляция", "электронейростимуляция", "чрезкожная электронейростимуляция", "черескожная электонейростимуляция", "черескожная электронейростимуляция"], "Чрескожная электронейростимуляция", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
    ...
    cistoskopia, cistoskopia_2, id_cistoskopia, stop_cistoskopia = ["цистоскопия", "цистоскопии"], ["цистоскопия", "цистоскопии"], "Цистоскопия", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "хромо"]
    cirkumsicizo, cirkumsicizo_2, id_cirkumsicizo, stop_cirkumsicizo = ["циркумцизи", "обрезание"], ["циркумцизи", "крайней плоти"], "Обрезание / Циркумцизия", ["дет", "радио", "сурги", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
    ...
    gsg, gsg_2, id_gsg, stop_gsg = ["гсг", "гистеросальпингография", "гистеросальпинография"], ["гсг", "гистеросальпингография", "гистеросальпинография"], "ГСГ / Гистеросальпингография", ["дет", "операц", "реб", "втор", "эхо", "уз", "ультразвук", "подгото", "узд", "соно", "вторич", "абонемент", "занятий", "посещени"]
    punkc_shitovid, punkc_shitovid_2, id_punkc_shitovid, stop_punkc_shitovid = ["пункция щитовидной"], ["пункция щитовидной"], "Пункция щитовидной железы", ["дет", "реб", "при", "втор", "вторич", "абонемент", "занятий", "посещени"]
    ...
    rinoskopia, rinoskopia_2, id_rinoskopia, stop_rinoskopia = ["рино", "носа", "носо"], ["скопия", "скопии", "эндоскопи"], "Риноскопия", ["дет", "реб", "блок", "втор", "вторич", "абонемент", "биопси", "занятий", "посещени"]
    ...
    udalenie_probok, udalenie_probok_2, id_udalenie_probok, stop_udalenie_probok = ["удаление", "промывание серных пробок", "промывание серной пробки"], ["пробок", "пробки", "ушной серы", "серы из ушей", "серы из слуховых", "серы из слухового", "промывание серных пробок", "промывание серной пробки"], "Удаление серных пробок", ["дет", "реб", "миндал", "втор", "вторич", "абонемент", "занятий", "посещени"]
    promiv_mndalin, promiv_mndalin_2, id_promiv_mndalin, stop_promiv_mndalin = ["промывани", "очищени", "санация"], ["миндалин"], "Промывание лакун небных миндалин", ["дет", "реб", "консул", "прием", "в рамках", "втор", "вторич", "абонемент", "занятий", "посещени"]
    ...
    vnutriven_ozon, vnutriven_ozon_2, id_vnutriven_ozon, stop_vnutriven_ozon = ["внутривенн", "в/в"], ["озон", "введение офр"], "Внутривенная озонотерапия", ["дет", "ауто", "гемо", "агт", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
    ...
    ustanovka_vms, ustanovka_vms_2, id_ustanovka_vms, stop_ustanovka_vms = ["становк", "введени"], ["спирали", "вмс", "мирена", "вмк"], "Установка внутриматочной спирали / ВМС", ["дет", "реб", "втор", "после", "нит", "лифти", "косич", "фил", "напол", "мезо", "вторич", "абонемент", "занятий", "посещени"]
    udalenie_vms, udalenie_vms_2, id_udalenie_vms, stop_udalenie_vms = ["удалени", "извлечени"], ["спирали", "вмс", "вмк"], "Удаление внутриматочной спирали / ВМС", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "врос", "сложное", "сложного"]
    udal_vros_vms, udal_vros_vms_2, id_udal_vros_vms, stop_udal_vros_vms, udal_vros_vms_3 = ["удалени", "извлечен"], ["спирали", "вмс", "вмк"], "Удаление вросшей спирали", ["дет", "реб", "втор", "вторич", "абонемент", "неосложненн", "несложн", "занятий", "посещени"], ["сложн", "вросш"]
    ...
    vnutriven_inekc, vnutriven_inekc_2, id_vnutriven_inekc, stop_vnutriven_inekc = ["внутривенн"], ["инъекци", "введение лекарственных "], "Внутривенная инъекция", ["дет", "дом", "капель", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "курс"]
    vnutrimish_inekc, vnutrimish_inekc_2, id_vnutrimish_inekc, stop_vnutrimish_inekc = ["внутримышеч"], ["инъекц", "введение лекарственных "], "Внутримышечная инъекция", ["дет", "диспорт", "dispo", "ксео", "наличии", "направлен", "xeo", "botox", "ботокс", "сустанон", "реб", "хгч", "гонадо",  "втор", "вторич", "абонемент", "занятий", "посещени", "курс"]
    ...
    kt_kolonoskop_2, id_kt_kolonoskop, stop_kt_kolonoskop = ["колоноскопи"], "КТ-виртуальная колоноскопия кишечника", ["дет", "реб", "втор", "вторич", "абонемент", "описание ", "занятий", "подго", "приго", "перед", "дефект", "посещени", "топометр", "контрастом", "контрастированием", "введением контраст", "введение контраст", "скт", "мультиспиральн", "спирал", "прием контраста"]
    ...
    kt_jeludok_2, id_kt_jeludok, stop_kt_jeludok = ["желудк"], "КТ желудка", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени", "топометр", "описание ", "контрастом", "подго", "приго", "перед", "дефект", "скт", "мультиспиральн", "спирал"]
    kt_jel4_puz_2, id_kt_kt_jel4_puz, stop_kt_jel4_puz, kt_jel4_puz_3 = ["желчн"], "КТ желчного пузыря", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "описание ", "посещени", "подго", "приго", "перед", "дефект", "топометр", "скт", "мультиспиральн", "спирал"], ["пузыр"]
    ...
    kt_4elust_2, id_kt_4elust, stop_kt_4elust = ["челюст", "дентальная", "дентальной"], "КТ челюсти", ["дет", "реб", "втор", "1-3", "1 з", "несколько зу", "до 3", "2-3", "одного зуба", "один зуб", "для", "консуль", "план", "лечен", "терапи", "ортопед", "прием", "анализ", "вторич", "абонемент", "занятий", "посещени", "подго", "приго", "перед", "сустав", "височ", "описание ", "топометр", "дефект", "спинн", "скт", "мультиспиральн", "сустав", "внчс", "спирал"]
    ...
    kt_bronhoskop_2, id_kt_bronhoskop_2, stop_kt_bronhoskop = ["бронхоскоп"], "КТ-виртуальная бронхоскопия", ["дет", "реб", "втор", "вторич", "абонемент", "подго", "приго", "перед", "занятий", "описание ", "посещени", "дефект", "топометр", "спинн", "контрастом", "контрастированием", "введением контраст", "введение контраст", "скт", "мультиспиральн", "спирал", "прием контраста"]
    ...
    kt_prostati_2, id_kt_prostati_2, stop_kt_prostati = ["простат", "предстательн"], "КТ предстательной железы", ["дет", "реб", "втор", "вторич", "абонемент", "подго", "приго", "перед", "занятий", "описание ", "посещени", "дефект", "топометр", "скт", "мультиспиральн", "спирал"]
    ...
    kt_kontrast_stop = ["дет", "реб", "втор", "вторич", "абонемент", "описани", "расшифров", "топометр", "спинн", "артери", "венами", "вены", "вену", "дефект", "сосуд", "спирал", "скт", "подго", "приго", "описание ", "перед"]
    ...
    ren_bedra, id_ren_bedra, stop_ren_bedra = ["бедра", "бедрен"], "Рентген бедра", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр", "тазобедр"]
    ...
    ren_legkih, id_ren_legkih, stop_ren_legkih, ren_legkih_2 = ["легких", "грудной"], "Рентген легких / грудной клетки", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр"], ["легких", "клетки"]
    ...
    ren_nosoglotki, id_ren_nosoglotki, stop_ren_nosoglotki = ["носоглотк"], "Рентген носоглотки", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр"]
    ...
    ren_stopi_nagruz, id_ren_stopi_nagruz, stop_ren_stopi_nagruz, ren_stopi_nagruz_2 = ["стопы"], "Рентген стопы с нагрузкой", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр"], ["нагруз"]
    ...
    ren_4erep, id_ren_4erep, stop_ren_4erep = ["череп"], "Рентген черепа", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр"]
    ...
    ren_pozvono4_grud, id_ren_pozvono4_grud, stop_ren_pozvono4_grud, ren_pozvono4_grud_2 = ["грудн"], "Рентген грудного отдела позвоночника", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр"], ["позвоночн", "поз-ка"]
    ren_pozvono4_po9s_krest, id_ren_pozvono4_po9s_krest, stop_ren_pozvono4_po9s_krest, ren_pozvono4_po9s_krest_2 = ["поясни"], "Рентген пояснично-крестцового отдела позвоночника", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр"], ["крест"]
    ren_pozvono4_po9s, id_ren_pozvono4_po9s, stop_ren_pozvono4_po9s = ["поясни"], "Рентген поясничного отдела позвоночника", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "крест"]
    ren_pozvono4_shei, id_ren_pozvono4_shei, stop_ren_pozvono4_shei = ["шейн", "шеи"], "Рентген шейного отдела позвоночника", ["дет", "реб", "втор", "описани", "позвонка", "расшифров", "занятий", "посещени"]
    ren_kop4ik, id_ren_kop4ik, stop_ren_kop4ik = ["копчика"], "Рентген копчика", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    ...
    ren_krest_podvzdo, id_ren_krest_podvzdo, stop_ren_krest_podvzdo, ren_krest_podvzdo_2 = ["крестцов"], "Рентген крестцово-подвздошных суставов", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр"], ["повздошн", "подвздошн"]
    ...
    ren_ple4a, id_ren_ple4a, stop_ren_ple4a = ["плечевого"], "Рентген плечевого сустава", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "топометр"]
    ...
    mrt_uha, id_mrt_uha, stop_mrt_uha = [" уха"], "МРТ структуры внутреннего уха", ["дет", "реб", "втор", "описание ", "расшифров", "занятий", "посещени", "топометр", "контрастом", "подго", "приго", "перед", "контрастированием", "введением контраст", "введение контраст", "использованием контраст", "прием контраст", "введением контраст"] 
    ...
    mrt_holangio, id_mrt_holangio, stop_mrt_holangio = ["холангио"], "МР-холангиография", ["дет", "реб", "втор", "описание ", "расшифров", "занятий", "подго", "приго", "онко", "всего тела", "все тело", "перед", "посещени", "топометр", "контрастом", "контрастированием", "введением контраст", "введение контраст", "использованием контраст", "прием контраст", "введением контраст"] 
    ...
    mrt_sheinogo, id_mrt_sheinogo, stop_mrt_sheinogo, mrt_sheinogo_2 = ["шейн"], "МРТ шейного отдела позвоночника", ["дет", "реб", "втор", "описание ", "расшифров", "занятий", "посещени", "топометр", "контрастом", "подго", "приго", "перед", "контрастированием", "введением контраст", "введение контраст", "использованием контраст", "прием контраст", "введением контраст"], ["позвон", "отдел"]
    ...
    mr_kishe4, id_mr_kishe4_reb, stop_mr_kishe4_reb = ["кишки", "кишечник"], "МРТ кишечника", ["реб", "дет", "втор", "мыш", "таз", "плани", "предоперац", "перед операци", "описание ", "расшифров", "занятий", "посещени", "топометр", "контрастом", "подго", "приго", "перед", "контрастированием", "введением контраст", "введение контраст", "использованием контраст", "прием контраст", "введением контраст"]
    mrt_for_kontrast = ["контрастом", "контрастным", "контрастированием", "введением контраст", "введение контраст", "использованием контраст", "прием контраст", "введением контраст"]
    ...
    mr_glazk, id_glazk, stop_mr_glazk = ["глаз"], "МРТ глаза с контрастом", ["дет", "реб", "подго", "приго", "перед", "втор", "описание ", "расшифров", "занятий", "посещени", "топометр", "без учета контраст", "без констраст"]
    ...
    mr_grudpozvon, id_mrt_grudpozvonk, stop_mrt_grudpozvonk = ["грудного отдела позвоночни", "позвоночника в грудной отдел", "грудной отдел позвоно"], "МРТ грудного отдела позвоночника с контрастом", ["дет", "реб", "подго", "приго", "перед", "втор", "описание ", "расшифров", "занятий", "посещени", "топометр", "без учета контраст", "без констраст"]
    ...
    mr_kishe4nikk, id_kishe4nikk, stop_mr_kishe4nikk = ["кишечник", "кишки"], "МРТ кишечника с контрастом", ["дет", "реб", "подго", "приго", "перед", "втор", "описание ", "расшифров", "занятий", "посещени", "топометр", "без учета контраст", "без констраст"]
    ...
    mr_po9skk, id_po9skk, stop_mr_po9skk = ["поясничн"], "МРТ поясничного отдела позвоночника с контрастом", ["дет", "реб", "подго", "приго", "перед", "втор", "описание ", "расшифров", "занятий", "посещени", "топометр", "без учета контраст", "без констраст"]
    ...
    mr_sheynogok, id_sheynogok, stop_mr_sheynogok = ["шейного отдела позвоночника"], "МРТ шейного отдела позвоночника с контрастом", ["дет", "ангиография сосудов шеи", "реб", "подго", "приго", "перед", "втор", "описание ", "расшифров", "занятий", "посещени", "топометр", "без учета контраст", "без констраст"]
    ...
    keratometr, keratometr_2, id_keratometr, stop_keratometr = ["кератометри", "кривизны роговицы", "кривизны роговой оболочки", "офтальмометрия"], ["офтальмометрия", "кривизны роговицы", "кератометри", "кривизны роговой оболочки"], "Кератометрия", ["втор", "описани", "расшифров", "занятий", "посещени", "комп"]
    ...
    ktg, ktg_2, id_ktg, stop_ktg =  ["кардиотокограф", "ктг"], ["плод", "беременн", "кардиотокограф"], "КТГ при беременности", ["втор", "вторич", "актг"]
    ...
    msktpo4ek_2, id_msktpo4ek, stop_msktpo4ek =  ["почек", "почк"], "МСКТ почек", ["дет", "реб", "вторич", "сосуд", "артери", "вен", "подго", "введение контраст", "приго", "перед", "для", "втор", "абонеме", "занят", "посещен"]
    ...
    biomikro, biomikro_2, id_biomikro, stop_biomikro =  ["биомикроскопия"], ["биомикроскопия"], "Биомикроскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    ...
    tride, tride_2, id_tride, stop_tride =  ["3д", "3 д", "3-д", "3-d", "3 d", "3d"], ["узи", "ультразвук", "плода", "беременн"], "3Д УЗИ", ["дет", "3 до", "4 до", "област", "1 орган", "одного органа", "1 органа", "органа", "кт", "томограф", "втор", "описани", "расшифров", "занятий", "посещени"]
    ...
    dinscin_2, id_discin, stop_discin =  ["пищевода и желудка", "желудка и пищевода"], "Динамическая сцинтиграфия пищевода и желудка", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    scilim_2, id_scilim, stop_scilim =  ["лимфатическ", "лимф"], "Лимфосцинтиграфия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    uzperner, uzner_2, id_uzner, stop_uzner =  ["узи", "ультразвук"], ["нерв"], "УЗИ периферических нервов", ["дет", "реб", "локт", "втор", "описани", "расшифров", "занятий", "посещени"]
    voseretro, vosuretro_2, id_vosuretro, stop_vosuretro =  ["восходящ"], ["уретрограф"], "Восходящая уретрография", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    ...
    obzouro, obzouro_2, id_obzouro, stop_obzouro =  ["обзорн"], ["урография"], "Обзорная урография", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    ...
    fluoro, fluoro_2, id_fluoro, stop_fluoro =  ["флюорография", "флюрография"], ["флюорография", "флюрография"], "Флюорография", ["дет", "книжк", "доп", "реб", "втор", "для", "на ул" "описани", "расшифров", "занятий", "посещени"]
    ...
    sfinmetr, sfinmetr_2, id_sfinmetr, stop_sfinmetr =  ["сфинктерометрия", "сфинктерометрии", "тонуса"], ["сфинктерометрия", "сфинктерометрии", "сфинктера"], "Сфинктерометрия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    uroflowmetr, uroflowmetr_2, id_uroflowmetr, stop_uroflowmetr =  ["урофлоуметрия", "урофлоуметрии", "урофлоурометрия", "урофлуометрия"], ["урофлуометрия", "урофлоуметрия", "урофлоуметрии", "урофлоурометрия"], "Урофлоуметрия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    cistometr, cistrometr_2, id_cistometr, stop_cistometr =  ["цистостометри", "цистоманометри"], ["цистометри", "цистоманометри"], "Цистометрия / Цистоманометрия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    cherpishekardi, cherpishekardi_2, id_cherpishekardi, stop_cherpishekardi =  ["чреспищевод", "чрезпищевод", "черезпищевод", "череспищевод"], ["кардиостимуляци"], "Чреспищеводная электрокардиостимуляция", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    elektrogastro, elektrogastro_2, id_elektrogastro, stop_elektrogastro =  ["эгг", "электрогастрографи"], ["эгг", "электрогастрографи"], "Электрогастрография / ЭГГ", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    elektronis, elektronis_2, id_elektronis, stop_elektronis =  ["электронистагмографи"], ["электронистагмографи"], "Электронистагмография", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    ehosinus, ehosinus_2, id_ehosinus, stop_ehosinus =  ["эхосинусоскопи", "эхо- синусоскопи", "эхо-синусоскопи", "эхо синусоскопи"], ["эхосинусоскопи", "эхо- синусоскопи", "эхо-синусоскопи", "эхо синусоскопи"], "Эхосинусоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    fvd, fvd_2, id_fvd, stop_fvd =  ["фвд", "функции внешнего дыхания", "функция внешнего дыхания", "исследование дыхательных объемов"], ["исследование дыхательных объемов", "фвд", "функции внешнего дыхания", "функция внешнего дыхания"], "Функция внешнего дыхания / ФВД", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    bodiplet, bodiplet_2, id_bodiplet, stop_bodiplet =  ["бодиплетизмографи"], ["бодиплетизмографи"], "Бодиплетизмография", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    pnevmotah, pnevmotah_2, id_pnevmotah, stop_pnevmotah =  ["пневмотахометри", "пневмотахиметри"], ["пневмотахиметр", "пневмотахометри"], "Пневмотахометрия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    diffleg, diffleg_2, id_diffleg, stop_diffleg =  ["диффузионн"], ["способности легких"], "Проверка диффузионной способности лёгких", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    spiromet, _spiromet2, id_spiromet, stop_spiromet =  ["спирометрия", "спирография", "спирометрии", "спирографии"], ["спирометрия", "спирография", "спирометрии", "спирографии"], "Спирометрия / Спирография", ["дет", "эрго", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    ergospiro, ergospiro_2, id_ergospiro, stop_ergospiro =  ["эргоспирометри", "эргоспирографи"], ["эргоспирометри", "эргоспирографи"], "Эргоспирометрия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    veroelrgo, veloergo_2, id_veloergo, stop_veloergo =  ["велоэргометри", "велоэгрометри"], ["велоэргометри", "велоэгрометри"], "Велоэргометрия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    steptest, steprtest_2, id_steprtest, stop_steptetst =  ["стептест", "степ тест", "степ-тест"], ["стептест", "степ тест", "степ-тест"], "Степ-тест", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    tredtest, tredtest_2, id_tredtest, stop_tredtest =  ["тредмил-тест", "тредмилтест", "тредмил тест", "тредмил"], ["тредмил-тест", "тредмилтест", "тредмил тест", "тредмил"], "Тредмил-тест", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    elektroneyro, elektroneyro_2, id_eelktorneyro, stop_elektorneyro =  ["электронейрография"], ["электронейрография"], "Электронейрография", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    enmg, enmg_2, id_enmg, stop_enmg =  ["энмг", "электронейромиографи", "декремент", "электромиография"], ["энмг", "электромиография", "электронейромиографи", "тест"], "ЭНМГ / Электронейромиография", ["дет", "при проведе", "при электро", "лиц", "верх", "осмотр", "объема", "консульт", "прием", "ниж", "рук", "ног", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    enmgverh, enmgverh_2, id_enmgverh, stop_enmgverh =  ["энмг", "электронейромиографи", "электромиография"], ["рук", "верх"], "ЭНМГ верхних конечностей", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    enmgniz, enmgniz_2, id_enmgniz, stop_enmgniz =  ["энмг", "электронейромиографи", "электромиография"], ["нижн", "ног"], "ЭНМГ нижних конечностей", ["дет", "реб", "одного", "втор", "описани", "расшифров", "занятий", "посещени"]
    enmglic, enmglic_2, id_enmglic, stop_enmglic =  ["энмг", "электронейромиографи", "электромиография"], ["лиц"], "ЭНМГ лицевого нерва", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    enmgnreb, enmgreb_2, id_enmgreb, stop_enmgnireb =  ["энмг", "электронейромиографи", "электромиография"], ["реб", "дет"], "ЭНМГ ребенку", ["втор", "описани", "расшифров", "занятий", "посещени"]
    bronhobio, bronhobio_2, id_bronhobio, stop_bronhobio =  ["бронхоскопи"], ["биопси"], "Бронхоскопия с биопсией", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    bronhomok, bronhomok_2, id_bronhomok, stop_bronhomok =  ["бронхоскопи"], ["забор мокроты", "забором мокроты"], "Бронхоскопия с забором мокроты", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    duozon, duozon_2, id_duozon, stop_duozon =  ["дуоденальн"], ["зондир"], "Дуоденальное зондирование", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    kapsulendo, kapsulendo_2, id_kapsulendo, stop_kapsulendo =  ["капсуль"], ["эндоскоп"], "Капсульная эндоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    mikrolaringo, mikrolaringo_2, id_mikrolaringo, stop_mikrolaringo =  ["микроларингоскопи", "миниларингоскопи"], ["микроларингоскопи", "миниларингоскопи"], "Микроларингоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    mikrooto, mikro_2, id_mikro, stop_mikrooto =  ["микроотоскоп", "миниотоскоп", "отомикроскопи", "отоэндоскопия", "уха", "отоскоп"], ["микроотоскоп", "миниотоскоп", "отомикроскопи", "отоэндоскопия", "микроскоп"], "Микроотоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    nefroskop, nefroskop_2, id_nefroskop, stop_nefroskop =  ["нефроскопия"], ["нефроскопия"], "Нефроскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    rektosigmo, rektosigmo_2, id_rektosigmo, stop_rektosigmo =  ["ректосигмоскопия"], ["ректосигмоскопия"], "Ректосигмоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    rektoskop, rektoskop_2, id_rektoskop, stop_rektoskop =  ["ректоскопия"], ["ректоскопия"], "Ректоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    sigmoskop, sigmoskop_2, id_sigmoskop, stop_sigmoskop =  ["сигмоскопия"], ["сигмоскопия"], "Сигмоскопия", ["дет", "ректо", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    torakoskop, torakoskop_2, id_torakoskop, stop_torakoskop =  ["торакоскопия"], ["торакоскопия"], "Торакоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    ureteroskop, ureteroskop_2, id_ureteroskop, stop_ureteroskop =  ["уретероскопия"], ["уретероскопия"], "Уретероскопия", ["дет", "пиело", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    faringoskop, faringoskop_2, id_faringoskop, stop_faringoskop =  ["фарингоскопия"], ["фарингоскопия"], "Фарингоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    holehodoskop, holehodoskop_2, id_holehodoskop, stop_holehodoskop =  ["холеходоскопия", "холедохоскопия"], ["холеходоскопия", "холедохоскопия"], "Холедохоскопия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени"]
    ...
    main_func(["rf", "термолифтинг", "рф", "радиоволновой лифтинг", "радиочастотный лифтинг", "радиочастотная термоабляция"], ["тела"], "RF лифтинг тела", ["дет", "живот", "реб", "антител", "втор", "описани", "расшифров", "инфек", "антител", "инфек", "фракц", "занятий", "посещени", "под", "rfe", "для", "во время"])
    ...
    main_func(["абдоминопластик"], ["без перемещени"], "Абдоминопластика без перемещения пупка", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["абдоминопластик"], ["с перемещ"], "Абдоминопластика с перемещением пупка", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["ial-system", "ial system", "иал систем", "иал-систем", "ial – system", "yal- system"], ["ial-system", "ial system", "иал систем", "иал-систем", "ial – system", "yal- system"], "Биоревитализация IAL System", ["дет", "реб", "facial", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["биоревитализац"], ["возраст"], "Биоревитализация возрастной кожи", ["дет", "лазер", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["биоревитализац"], ["декольте"], "Биоревитализация декольте", ["дет", "реб", "лазер", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["биоревитализац"], ["глаз", "орбит"], "Биоревитализация зоны глаз", ["дет", "лазер", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["биоревитализац"], ["лиц"], "Биоревитализация лица", ["дет", "реб", "втор", "лазер", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["биоревитализац"], ["шеи", "шейн"], "Биоревитализация шеи", ["дет", "реб", "втор", "описани", "расшифров", "лазер", "занятий", "посещени", "под", "для", "во время"])
    main_func(["биоревитализац"], ["инъекционн"], "Инъекционная биоревитализация", ["дет", "реб", "втор", "безинъекцио", "безын", "описани", "лазер", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["биоревитализац"], ["лазер"], "Лазерная биоревитализация", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["пиляция"], ["воск", "полимер"], "Биоэпиляция воском", ["дет", "реб", "втор", "описани", "бикини", "расшифров", "занятий", "посещени", "под", "во время"])
    main_func(["пиляция"], ["воск", "полимер"], "Биоэпиляция бикини воском", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "во время"], ["бикини"])
    main_func(["блефаропластика", "пластика век"], ["блефаропластика", "пластика век"], "Блефаропластика", ["дет", "массаж" "транскон", "безоперационная", "лазер", "азиат", "кругов", "нижних и верхних", "ниж", "верх", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["блефаропластик"], ["кругов", "верх"], "Блефаропластика круговая", ["дет", "реб", "втор", "описани", "лазер", "массаж", "расшифров", "занятий", "посещени", "под", "для", "во время"], ["ниж", "кругова"])
    main_func(["блефаропласти"], ["верх"], "Верхняя блефаропластика", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "лазер", "массаж", "посещени", "под", "для", "во время"])
    main_func(["блефаропласти"], ["ниж"], "Нижняя блефаропластика", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "лазер", "массаж", "под", "для", "во время"])
    ...
    main_func(["коньюктив", "конюктив", "конъюктив", "конъюн", "коньюн"], ["блефаропластик"], "Трансконъюнктивальная блефаропластика", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["малярн"], ["мешк"], "Удаление малярных мешков", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["эпикантопластик", "сангапури", "сингапури", "пластика"], ["эпикантопластик", "сангапури", "сингапури", "эпикантус"], "Эпикантопластика", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["брахиопластика"], ["брахиопластика"], "Брахиопластика", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["вакуумный массаж", "вакуумная терапия"], ["вакуумный массаж", "вакуумная терапия"], "Вакуумный массаж", ["дет", "допол", "ран", "реб", "лод", "живот", "лиц", "тел", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["вибр"], ["массаж"], "Вибромассаж", ["дет", "реб", "механич", "электростатич", "втор", "допол", "описани", "расшифров", "занятий", "барабан", "перепон", "уш", "б/п", "б / п", "посещени", "под", "для", "во время"])
    ...
    main_func(["вправлени", "устранение"], ["вывих"], "Вправление вывиха", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["вскрыти", "дренаж", "дренир"], ["абсцесса полости рта", "абсцесса рта", "абсцесса глотки", "абсцесса ротогло", "глоточного абсцесса", "пародонтального абсце", "пародонтального абцес"], "Вскрытие абсцесса полости рта", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время"])
    ...
    main_func(["геморроидэктомия", "геммороидэктмия", "гемороидэктомия", "иссеч", "удал", "вапоризаци", "оперативное лечение", "деструкци"], ["геморроидэктомия", "геммороидэктомия", "гемороидэктомия", "геморр"], "Геморроидэктомия", ["дет", "милиган", "неоперативн", "бахром", "миллиган", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время"])
    ...
    main_func(["пластик", "сечение", "удал", "хирургич", "опера"], ["пах"], "Герниопластика пахово-бедренной грыжи", ["дет", "реб", "втор", "описани", "расшифров", "без опе", "снятие", "после", "занятий", "посещени", "для", "во время"], ["бедр"])
    ...
    main_func(["ампутация пальц"], ["кист"], "Ампутация пальцев кисти", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["ампутация пальц"], ["стоп"], "Ампутация пальцев стопы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["ампутация плеча"], ["ампутация плеча"], "Ампутация плеча", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["ампутация предплечья"], ["ампутация предплечья"], "Ампутация предплечья", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["ампутация стопы"], ["шарп"], "Ампутация стопы по Шарпу", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["экзартикуляция пальц"], ["кист"], "Экзартикуляция пальцев кисти", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["экзартикуляц"], ["плечевого сустава", "сустава плеча"], "Экзартикуляция плечевого сустава", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["гирудотерапи", "пиявк", "пиявок"], ["гирудотерапи", "пиявк, пиявок"], "Гирудотерапия", ["дет", "реб", "консультац", "проб", "перед", "перевя", "втор", "рефлексо", "внутриполост", "описани", "расшифров", "занятий", "допол", "след", "посещени", "под", "для", "во время"])
    main_func(["внутриполостн"], ["гирудотерапи"], "Внутриполостная гирудотерапия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["гистерэктомия", "удаление матки"], ["гистерэктомия", "удаление матки"], "Гистерэктомия / Операция по удалению матки", ["дет", "пан", "лапароскоп", "реб", "втор", "влагалищ", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["влагалищ"], ["гистерэктоми", "удаление матки"], "Влагалищная гистерэктомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["ампутация матки"], ["ампутация матки"], "Надвлагалищная ампутация матки", ["дет", "реб", "с придатками", "включая придатки", "и придатков", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["дарсонвал", "д-арсонвал", "д-арсонваль", "дарсонал", "дарсанвал"], ["дарсонвал", "дарсанвал", "д-арсонвал", "д-арсонваль", "дарсонал"], "Дарсонвализация", ["дет", "лиц", "голов", "спин", "сустав", "курс", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    main_func(["дарсонвал", "дарсанвал", "д-арсонвал", "д-арсонваль", "дарсонал"], ["волос"], "Дарсонвализация волосистой части головы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["дарсонвал", "д-арсонвал", "дарсанвал", "д-арсонваль", "дарсонал"], ["лиц"], "Дарсонвализация лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["дарсонвал", "д-арсонвал", "д-арсонваль", "дарсанвал", "дарсонал"], ["полост"], "Дарсонвализация полостная", ["дет", "реб", "втор", "вне", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["дарсонвал", "д-арсонвал", "д-арсонваль", "дарсанвал", "дарсонал"], ["спины"], "Дарсонвализация спины", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["дренирован", "дренаж"], ["плеврал"], "Дренирование плевральной полости", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["зондир"], ["слез"], "Зондирование слезных каналов", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["иглоукалывани", "рефлексотерапи", "иглотерапия", "акупунктура корпоральная"], ["иглотерапия", "иглоукалывани", "рефлексотерапи", "акупунктура корпоральная"], "Иглоукалывание / Рефлексотерапия", ["дет", "допол", "реб", "други", "гиру", "электр", "аури", "ушн", "микросистем", "ушей", "уха", "пиявк", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    new_doubler_main(["иглоукалывани", "рефлексотерапи", "аурикулотерапия", "акупунктур"], ["аурик", "ушей", "ушн", "микросистем"], ["дет", "реб", "други", "гиру", "электр", "пиявк", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], "Иглоукалывание / Рефлексотерапия", 28856, 961113, "Иглоукалывание / Рефлексотерапия", "services")
    ...
    main_func(["электропунктур", "электроакупунктур"], ["электропунктур", "электроакупунктур"], "Электроакупунктура", ["дет", "матки", "кист", "набот", "образ", "эроз", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["вагинопластик", "кольпорафи"], ["вагинопластик", "кольпорафия"], "Вагинопластика / Кольпорафия", ["дет", "реб", "втор", "при", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время"])
    ...
    main_func(["интимн", "цервикал", "влагалищ", "вульв", "гинекологи"], ["плазмолифтинг"], "Интимный плазмолифтинг", ["дет", "реб", "втор", "дополни", "десен", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лабиопластик", "коррекция", "увели", "восстановл", "пластика"], ["лабиопластик", "половых губ"], "Лабиопластика / Коррекция половых губ", ["дет", "реб", "гел", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["лазер"], ["омолож", "шлифовк", "моделирование"], "Лазерное омоложение влагалища", ["дет", "реб", "втор", "описани", "рубц", "рубец", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["влаг", "вагин"])
    main_func(["лазер"], ["омоложе", "шлифовк", "моделирование"], "Лазерное омоложение вульвы", ["дет", "реб", "втор", "описани", "расшифров", "рубц", "рубец", "занятий", "посещени", "под", "для", "во время", "курс"], ["вульв"])
    main_func(["перинеопластик"], ["перинеопластик"], "Перинеопластика", ["дет", "кольпо", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "рубц", "рубец", "коррекц", "удал", "шлиф", "лазер", "со2", "углекислот", "аппарат"])
    main_func(["пластик"], ["лобк"], "Пластика лобка у женщин", ["дет", "мужч", "контур", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["увеличени", "аугментац", "увелече"], ["клитор"], "Увеличение клитора", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["увеличени", "аугментац", "увелече"], ["графенберг", "грефенберг", "g"], "Увеличение точки G", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["уменьше", "редукц", "резекция"], ["больших половых губ", "большой половой губы"], "Уменьшение больших половых губ", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["уменьше", "редукц", "резекция"], ["малых половых", "малой половой"], "Уменьшение малых половых губ", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["ботокс", "botox"], ["ботокс", "botox"], "Инъекции ботокса", ["дет", "реб", "гипергидроз", "лоб", "лиц", "трещи", "лба", "губ", "втор", "шеи", "шея", "шейн", "описани", "расшифров", "занятий", "пептид", "эффектом", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["ботокс", "botox"], ["лоб"], "Инъекции ботокса в лоб", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "гипергидроз", "посещени", "под", "для", "во время", "курс"], ["ботокс"])
    main_func(["ботокс", "botox"], ["шею", "шеи", "шейн"], "Инъекции ботокса в шею", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["ботокс"])
    main_func(["диспорт", "disport", "dysport"], ["диспорт", "disport", "dysport"], "Инъекции диспорта", ["дет", "реб", "втор", "описани", "гипергидроз", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["инъекц", "укол", "шприц"], ["гиалурон"], "Инъекции гиалуроновой кислоты", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["капельн", "непрерывное внутривенное введение"], ["капельн", "непрерывное внутривенное введение"], "Капельницы", ["дет", "реб", "алкоголь", "выезд", "дом", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["капельн"], ["дом", "выезд"], "Капельница на дому", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["цистостомическ", "удаление цистостомы", "удаление цистостомического дрен", "мена цистомы", "мена цистоми", "мена цистостом"], ["мена цистоы", "мена цистоми", "мена цистостом", "дрен", "замен", "удаление цистостомы", "удаление цистостомического дрен"], "Замена цистостомического дренажа", ["дет", "реб", "фоле", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["фолея", "катетера фоли"], ["фолея", "катетера фоли"], "Постановка постоянного катетера Фолея", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["кинезио", "медицин", "лечеб", "наложение", "тейпировани"], ["тейп"], "Кинезиотейпирование", ["дет", "реб", "втор", "кросс", "апликац", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["вазэктоми"], ["вазэктоми"], "Вазэктомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["контрацептив", "влагалищного", "вагинального"], ["кольц"], "Постановка контрацептивного кольца", ["дет", "реб", "втор", "обучение устано", "обучение поста", "обучение по", "описани", "расшифров", "занятий", "пессар", "посещени", "под", "для", "во время", "курс"], ["станов", "веде"])
    ...
    main_func(["удал", "извлеч"], ["контрацеп", "гормональной системы"], "Удаление гормонального контрацептива", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["контурная пластика", "контурной пластики"], ["гиалурон"], "Контурная пластика гиалуроновой кислотой", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["контурная пластика", "контурной пластики"], ["губ", "smile", "lips"], "Контурная пластика губ", ["дет", "нос", "реб", "вестибуло", "полов", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["контурная пластика", "контурной пластики"], ["лица"], "Контурная пластика лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["контурная пластика", "контурной пластики"], ["носогуб"], "Контурная пластика носогубных складок", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["контурная пластика", "контурной пластики"], ["скул"], "Контурная пластика скул", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["контурная пластика", "контурной пластики"], ["шеи", "шейн"], "Контурная пластика шеи", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["коррекц"], ["мимич"], "Коррекция мимических морщин", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["коррекц"], ["морщ"], "Коррекция морщин", ["дет", "реб", "мимич", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["биоматрикс"], ["биоматрикс"], "Биоматрикс", ["дет", "реб", "втор", "акци", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["маск"], ["крем"], "Кремообразная маска", ["дет", "реб", "рук", "втор", "описани", "пилинг", "расшифров", "занятий", "посещени", "акци", "под", "для", "во время", "курс"])
    ...
    main_func(["криотерап", "криомассаж", "криоорошение"], ["криотерапи", "криомассаж", "криоорошение"], "Криотерапия", ["дет", "лиц", "тел", "волос", "акне", "ороше", "груд", "спин", "алопец", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["ласик", "lasik", "lasek"], ["lasik", "ласик", "lasek"], "Коррекция зрения ЛАСИК", ["дет", "реб", "втор", "femto", "фемто", "описани", "перел", "расшифров", "занятий", "посещени", "под", "после", "предоплат", "для", "во время", "курс"])
    main_func(["коррекция", "зрения"], ["смайл", "smile"], "Коррекция зрения Смайл", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "перед", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лазер"], ["липосакция голеней", "липосакции голеней"], "Лазерная липосакция голеней", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция бикини", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "во время", "курс"], ["бикин"])
    new_doubler_main(["лазерная эпиляция бикини", "лазерная эпиляция зоны бикини", "лазерная эпиляция области бикини", "лазерная эпиляция в области бикини", "лазерная эпиляция в области глубокого би", "лазерная эпиляция (бикини)", "лазерная эпиляция глубокое бикини", "удаление волос в области бикини лазер", "удаление волос в зоне бикини лазер", "эпиляция бикини лазером", "лазерная эпиляция глубокого бикини", "эпиляция глубокого бикини лазер"], ["глубок"], ["втор", "дет", "реб", "посеще", "во время", "курс"], "Лазерная эпиляция бикини", 47604, 1839930, "Лазерная эпиляция", "services")
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция верхней губы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["губ", "усы", "усов"])
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция голеней", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "во время", "курс"], ["голен"])
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция живота", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "во время", "курс"], ["живот"])
    new_doubler_main(["лазерная эпиляция живот", "лазерная эпиляция зоны живот", "лазерная эпиляция (живот)", "удаление волос в области живота лазе", "удаление волос в зоне живота лазер", "эпиляция живота лазер", "лазерная эпиляция живота"], ["полност"], ["втор", "дет", "реб", "посеще", "во время", "курс"], "Лазерная эпиляция живота", 47604, 1978638, "Лазерная эпиляция", "services")
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция лба", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "лобка", "лобок"], ["лба", "лоб"])
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"], ["лиц"])
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция ног", ["дет", "реб", "втор", "пальц", "описани", "расшифров", "мног", "нного", "сложн", "голен", "занятий", "посещени", "под", "во время", "курс"], ["ног", "нижних конечностей", "нижняя конечность", "нижней конечности"])
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция носа", ["дет", "реб", "втор", "полнос", "описани", "расшифров", "занятий", "посещени", "под", "во время", "курс"], ["нос"])
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция подбородка", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"], ["подбород"])
    main_func(["лазер", "motus ax", "duetto"], ["пиляци", "удаление волос"], "Лазерная эпиляция подмышек", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"], ["подмыше"])
    #main_func(["лазер", "motus ax"], ["александ", "motus ax"], "Эпиляция александритовым лазером", ["дет", "реб", "втор", "моло", "описани", "расшифров", "занятий", "посещени", "лечени", "терапи", "под", "во время", "курс"])
    #main_func(["лазер"], ["диод"], "Эпиляция диодным лазером", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "лечение", "терапи", "моло", "посещени", "под", "во время", "курс"], ["пиляц"])
    #main_func(["лазер"], ["неодим"], "Эпиляция неодимовым лазером", ["дет", "реб", "втор", "описани", "лечени", "терапи", "моло", "расшифров", "занятий", "посещени", "под", "во время", "курс"], ["пиляц"])
    #main_func(["лазер"], ["рубин"], "Эпиляция рубиновым лазером", ["дет", "реб", "лечени", "терапи", "втор", "описани", "расшифров", "моло", "занятий", "посещени", "под", "во время", "курс"], ["пиляц"])
    main_func(["лазер", "smooth"], ["омолож", "смус", "smooth"], "Лазерное омоложение", ["дет", "реб", "aft", "шея", "растя", "влаг", "вульв", "пол", "инти", "шеи", "шей", "декольт", "кист", "рук", "локт", "орбит", "глаз", "лиц", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["лазер", "smooth"], ["омолож", "смус", "smooth"], "Лазерное омоложение кистей рук", ["дет", "реб", "aft", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["кист"])
    main_func(["лазер", "smooth"], ["омолож", "смус", "smooth"], "Лазерное омоложение лица", ["дет", "реб", "втор", "aft", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["лиц"])
    main_func(["лазер", "smooth"], ["омолож", "смус", "smooth"], "Лазерное омоложение локтей", ["дет", "реб", "втор", "aft", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["локт"])
    main_func(["лазер", "smooth"], ["омолож", "смус", "smooth"], "Лазерное омоложение периорбитальной зоны", ["дет", "aft", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["орбит", "глаз"])
    main_func(["лазер", "smooth"], ["омолож", "смус", "smooth"], "Лазерное омоложение шеи", ["дет", "реб", "втор", "aft", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["шейн", "шеи", "шея"])
    main_func(["омолож", "шлифовк"], ["фраксел"], "Омоложение Фраксель", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["акне"], ["лазер"], "Лечение акне лазером", ["дет", "реб", "щек", "лбу", "лоб", "подборо", "спин", "лиц", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["акне"], ["лиц"], "Лазерное лечение акне на лице", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["лазер"])
    ...
    main_func(["асит", "аллерген-специфическ"], ["терапи"], "АСИТ-терапия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["вскрыти", "дренаж", "дренир", "удален"], ["бартолин", "бактолин"], "Вскрытие абсцесса бартолиновой железы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["абсцес", "абцес"])
    ...
    main_func(["минифлебэктоми"], ["минифлебэктом"], "Минифлебэктомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["абляц"], ["вен", "сосуд"], "Радиочастотная абляция вен", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени" "во время", "курс"])
    ...
    main_func(["склеротерапия", "склерозирован", "склеротизац", "сеанс склеротерапии"], ["сеанс склеротерапии", "склеротерапия", "склерозирован", "склеротизац"], "Склеротерапия", ["дет", "молоч", "кист", "образова", "гемор", "семен", "канат", "микро", "звезд", "эхо", "ретикул", "поч", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"], ["вен", "сосуд", "варикоз"])
    ...
    main_func(["эхо"], ["склеротерап"], "Эхо-склеротерапия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лигирован", "легирован"], ["геморр", "узла", "узлов"], "Лигирование геморроя", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лазер"], ["гипергидроз"], "Лазерное лечение гипергидроза", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["гипергидроза"], ["ботокс", "botox"], "Лечение гипергидроза ботоксом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["лазер"], ["циклокоагул"], "Лазерная циклокоагуляция", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["лазер"], ["глауком", "гониопластика"], "Лазерное лечение глаукомы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func([" дом", "по москве"], ["консульт", "прием", "вызов", "выезд"], "Вызов врача на дом", ["дет", "реб", "втор", "описани", "ортопедом", "мануал", "пси", "рефлекс", "расшифров", "дмс", "занятий", "посещени", "под", "для", "во время", "курс"], ["терапевт"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов аллерголога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["аллерголог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов гастроэнтеролога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гастроэнтеролог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов гинеколога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гинеколог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов дерматолога на дом", ["дет", "реб", "втор", "обработ", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["дерматолог", "дерматовенеролог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов детского врача / педиатра на дом", ["втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "дмс", "от ", "крови", "курс"], ["педиатр", "детского врача"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов детского ЛОРа на дом", ["втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["детского лор", "детского оторинолар"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов инфекциониста на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["инфекционист"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов кардиолога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["кардиолог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов ЛОРа на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["лор", "оторино"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов мануального терапевта на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["мануальн"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов массажиста на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["массажист"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов нарколога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["нарколог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов невролога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["невролог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов онколога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["онколог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов ортопеда на дом", ["дет", "реб", "втор", "ортопедом", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["ортопед"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов остеопата на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["остеопат"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов офтальмолога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["офтальмолог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов проктолога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["проктолог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов психиатра на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["психиатр"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов психотерапевта на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["психотерапевт"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов пульмонолога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["пульмонолог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов стоматолога на дом", ["дет", "реб", "ортопедом", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["стоматолог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов травматолога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["травматолог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов уролога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["уролог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов флеболога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["флеболог"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов хирурга на дом", ["дет", "реб", "абдоминал", "втор", "ортопедом", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["хирург"])
    main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов эндокринолога на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["эндокринолог"])
    main_func([" дом", "в пределах мкад", "выезд"], ["медсестр", "сестра", "м/с", "сестры", "медицинская сестра", "медицинской сестрой", "медицинской сестры", "среднего мед"], "Медсестра на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "во время", "курс"])
    ...
    main_func(["пластик", "сечение", "удал", "хирургич", "лапароскопическ", "опера"], ["пупоч"], "Герниопластика пупочной грыжи", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["грыж"])
    ...
    main_func(["опера", "хирург", "коррекци"], ["вальгус", "hallux valgus", "halux valgus", "halluxvalgus"], "Операция при Халюс вальгус", ["дет", "без", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["резекци"], ["носовой перегородки", "перегородки носа", "перегородки в носу"], "Подслизистая резекция носовой перегородки", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["иссечен", "дренирован"], ["кисты почки", "почечной кисты"], "Иссечение кисты почки", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["операция", "хирургическ"], ["при косоглазии", "косоглазия"], "Операция при косоглазии", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "без", "под", "для", "во время", "курс"])
    ...
    main_func(["эмболиза"], ["маточных артерий", "артерий матки"], "Эмболизация маточных артерий", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["радиоволн", "радиволн", "сургитрон", "радиочастот", "радионож", "радиохирурги"], ["кровоточ", "кровотеч"], "Радиоволновая коагуляция кровоточащих сосудов", ["дет", "реб", "втор", "описани", "ног", "флебо", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лод"], ["терапи", "вакуумный массаж"], "ЛОД-терапия", ["дет", "реб", "втор", "описани", "бесплод", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["увт", "ударно"], ["шпоры", "шпоре"], "Ударно-волновое лечение пяточной шпоры", ["дет", "реб", "осмотр", "консул", "прием", "перед", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["ямик"], ["ямик"], "Санация околоносовых пазух ЯМИК-катетером", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удалени", "полипэктоми", "деструкц"], ["полип"], "Удаление полипа цервикального канала", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["церви", "церкви"])
    main_func(["удалени", "полипэктоми"], ["полип"], "Удаление полипа эндометрия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["эндометри"])
    ...
    main_func(["тест"], ["эректил"], "Тесты на эректильную дисфункцию", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["функц"])
    main_func(["фалло", "член"], ["протез"], "Фаллопротезирование", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["лимфодренаж", "лимфадренаж"], ["массаж", "аппарат"], "Лимфодренажный массаж", ["дет", "конеч", "живот", "рук", "допол", "ног", "лиц", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["липосакция"], ["липосакция"], "Липосакция", ["дет", "спин", "шеи", "шейн", "радио", "лазер", "сурги", "мини", "ягоди", "щек", "щеч", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["липосакци"], ["бедер", "бедра"], "Липосакция бедер", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци", "интралипотерапия", "липолити"], ["без операции", "интралипотерапия", "мезотерапи", "коктейл"], "Липосакция без операции", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["бок", "тали", "фланк"], "Липосакция бока", ["дет", "реб", "втор", "описани", "без тали", "без бок", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["галиф"], "Липосакция галифе", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["голен"], "Липосакция голеней", ["дет", "реб", "лазер", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["живот"], "Липосакция живота", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["лиц"], "Липосакция лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["ног", "нижних кон", "нижней кон"], "Липосакция ног", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["подбород"], "Липосакция подбородка", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["липосакци"], ["рук", "верних кон", "верхней кон"], "Липосакция рук", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["спин"], "Липосакция спины", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["шеи", "шейн", "шея"], "Липосакция шеи", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["щек"], "Липосакция щек", ["дет", "реб", "мини", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["липосакци"], ["ягоди"], "Липосакция ягодиц", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["липофилинг", "липофиллинг"], ["губ"], "Липофилинг губ", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["вскрыти", "дренир", "дренаж", "удал"], ["атером"], "Вскрытие атеромы уха", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "после", "посещени", "под", "для", "во время", "курс"], ["уха", "ушей", "ушах", "ушной", "лор орган", "лор-орган"])
    ...
    main_func(["пункц", "пунктирование"], ["гаймор"], "Пункция при гайморите", ["дет", "реб", "втор", "без пунк", "безпунк", "беспун", "безпун", "описани", "расшифров", "контрол", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["тушировани"], ["глотк"], "Радиоволновое туширование задней стенки глотки", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["радио", "сурги"])
    main_func(["увулотомия", "уволотомия", "увулутомия", "увулотамия", "увулатамия", "увулатомия"], ["увулотомия", "увулотамия", "уволотомия", "увулутомия", "увулатамия", "увулатомия"], "Увулотомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["удалени", "аденотоми", "аденоиэктомия", "аденоидэктомия", "дестру"], ["аденоидэктомия", "аденоиктомия", "аденотоми", "аденоид"], "Удаление аденоидов / Аденотомия", ["дет", "при", "пособи", "реб", "образо", "вегет", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["массаж"], ["лечеб", "медицинский"], "Лечебный массаж", ["дет", "реб", "предста", "простат", "втор", "описани", "допол", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["массаж"], ["гуаш"], "Массаж гуаша", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "допол", "для", "во время", "курс"])
    ...
    main_func(["массаж"], ["дом"], "Массаж на дому", ["дет", "реб", "втор", "кист", "сустав", "ног", "рук", "плеч", "голо", "ворот", "массажиста", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["класс", "общ"])
    main_func(["массаж"], [" ног", "нижних конечностей", "нижней конечности", "нижняя конечность", "н/конечност"], "Массаж ног", ["дет", "рук", "цел", "допол", "сегмент", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["массаж"], ["рук", "верхней конечност", "верхняя конечност", "верхних конечност", "в/конечност", "верних конечностей"], "Массаж рук", ["дет", "допол", " ног", "реб", "04", " 4", "четыр", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["массаж"], ["скульптур", "моделирующ"], "Скульптурный массаж", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["медикамент", "лечени", "терап"], ["акне"], "Медикаментозное лечение акне", ["дет", "аппарат", "тек", "фракц", "ток", "фото", "радио", "сурги", "азот", "крио", "реб", "лазер", "без", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["мезотерапи", "мезококтейль"], ["волос", "голов"], "Мезотерапия волос", ["дет", "реб", "втор", "безинъекцион", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["мезотерапи", "mesoeye", "meso eye", "мезококтейль"], ["глаз", "орбит", "mesoeye", "meso eye"], "Мезотерапия зоны вокруг глаз", ["дет", "реб", "безинъекцион", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["мезотерапи", "липолитик", "интралинотерапи", "интралипотерапи", "nctf-135"], ["коктейл", "интралинотерапи", "липолитик", "жиросжиг", "интралипотерапи", "nctf-135"], "Мезотерапия коктейлями", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["микронидлинг"], ["микронидлинг"], "Микронидлинг", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["нит"], ["подтяж", "лифтин"], "Нитевой лифтинг бровей", ["дет", "реб", "втор", "синус", "дополнит", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["бров"])
    main_func(["нит"], ["подтяж", "лифтин"], "Нитевой лифтинг живота", ["дет", "реб", "втор", "синус", "дополнит","описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["живот"])
    main_func(["нит"], ["подтяж", "лифтин"], "Нитевой лифтинг молочных желез", ["дет", "реб", "втор", "дополнит", "синус", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["молочн", "груд", "декольт"])
    main_func(["нит"], ["подтяж", "лифтин"], "Нитевой лифтинг носогубных складок", ["дет", "реб", "втор", "дополнит", "синус", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["носогуб"])
    main_func(["нит"], ["подтяж", "лифтин"], "Нитевой лифтинг уголков губ", ["дет", "реб", "втор", "нос", "дополнит", "описани", "синус", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["губ"])
    main_func(["нит"], ["подтяж", "лифтин"], "Нитевой лифтинг щек", ["дет", "реб", "втор", "описани", "дополнит", "расшифров", "занятий", "синус", "посещени", "под", "для", "во время", "курс"], ["щек", "щеч"])
    main_func(["оберт", "компрессионый бандаж", "бандаж", "пелена"], ["shock", "т-шок"], "T-Shock-обертывание", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["оберт", "компрессионый бандаж", "бандаж", "пелена"], ["гряз"], "Грязевое обёртывание", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["озон"], ["бедер", "бедрен"], "Озонотерапия бедер", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["озон"], ["боков", "боковых", "боковой"], "Озонотерапия боков", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["озон"], ["волос"], "Озонотерапия волосистой части головы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["озон"], ["живот"], "Озонотерапия живота", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["озон"], ["лиц"], "Озонотерапия лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    main_func(["озон"], ["подбород"], "Озонотерапия подбородка", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    main_func(["озон"], ["рубц", "рубец"], "Озонотерапия рубцов", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["озон"], ["спин"], "Озонотерапия спины", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["озон"], ["сустав"], "Озонотерапия сустава", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["озон"], ["тела", "тело", "грудь", "груди", "декольте"], "Озонотерапия тела", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "шеи", "шей", "шея", "во время", "курс"])
    main_func(["озон"], ["шеи", "шейного", "шея"], "Озонотерапия шеи", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["ультра", "уз", "альтер", "alter"], ["смас", "smas"], "Ультразвуковой SMAS-лифтинг", ["дет", "реб", "от ", "втор", "доп", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация акушера-гинеколога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["акушера-гинеколога"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация аллерголога", ["дет", "иммуно", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "иммунолог"], ["аллерголог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация гастроэнтеролога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гастроэнтеролог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация гематолога", ["дет", "онко", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гематолог", "гемотолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация гепатолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гепатолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация гинеколога", ["дет", "реб", "онко", "уролог", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "акушер", "хирург", "эндокринолог"], ["гинеколог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация дерматолога", ["дет", "онколог", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онколог"], ["дерматолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация диетолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["диетолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация инфекциониста", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["инфекционист"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация кардиолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "интервен", "хирург"], ["кардиолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация ЛОР-врача", ["дет", "реб", "хиру", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онколог"], ["лор", "оторинолари"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация маммолога-онколога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["маммолог-онколог", "маммолога-онколога"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация нейрохирурга", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["нейрохирург"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация нефролога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["нефролог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация онколога", ["дет", "реб", "эндо", "маммолог", "прокто", "втор", "описани", "дермато", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "гинеколог", "лор", "хирург", "оторино", "гемато", "уролог", "кардиоло"] , ["онколог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация офтальмолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "хирург", "нейро"], ["офтальмолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация педиатра", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["педиатр"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация проктолога", ["дет","хирург", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онколог"], ["проктолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация психиатра", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["психиатр"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация психотерапевта", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["психотерапевт"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация пульмонолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["пульмонолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация ревматолога", ["дет", "реб", "кардио", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["ревматолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация семейного врача", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["семейного врача"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация терапевта", ["дет", "рефлекс", "гирудо", "физио", "радио", "химио", "реб", "психо", "натур", "лазер", "гирудо", "баро", "втор", "мануал", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["терапевт"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация уролога", ["дет", "реб", "гинеколог", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онко", "хирург"], ["уролог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация флеболога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "хирург"], ["флеболог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация флеболога-хирурга", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["флеболога-хирурга"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация хирурга", ["дет", "реб", "пласти", "офталь", "втор", "гной", "бариатри", "абдомин", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "онко", "уро", "вертебро", "имплан", "онко", "орто", "прокто", "травма", "челю", "эндо", "лор", "рино", "сосуд", "кардио", "торакал", "стомато", "флебо", "гине", "нейро"], ["хирург"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация эндокринолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "хирург", "онколог", "гинеколог"], ["эндокринолог"])
    main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный"], ["консультац", "прием"], "Онлайн консультация невролога", ["дет", "верте", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["невролог"])
    ...
    main_func(["трахеостом"], ["трахеостом"], "Трахеостомия", ["дет", "реб", "мен", "втор", "описани", "расшифров", "туалет", "очи", "промыв", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лапароскоп"], ["фундопликац"], "Лапароскопическая фундопликация", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удаление полип", "полипэктоми"], ["желуд"], "Удаление полипов желудка при ЭГДС", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "вне", "под", "для", "во время", "курс"])
    ...
    main_func(["удалени", "резекц", "холецистэктоми"], ["желчного", "холецистэктоми"], "Операция по удалению желчного пузыря / Холецистэктомия", ["камн", "конкремен", "дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал", "извлеч"], ["камн"], "Эндоскопическое удаление камней желчных протоков", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["проток"])
    ...
    main_func(["вапоризац"], ["шейки матки"], "Лазерная вапоризация шейки матки", ["дет", "реб", "кист", "опухо", "образ", "папил", "кондил", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    ...
    main_func(["резекц"], ["мочевого пузыря"], "Резекция мочевого пузыря", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лечени", "терапи", "пункция варикоцеле", "пункции варикоцеле", "пункция при водянке", "пункция водянки", "пункция гидроцеле", "пункции гидроцеле", "пункция при гидроцеле", "операция при гидроцеле", "операция при водянке яич", "операция по поводу гидро", "операция по поводу водянки яи", "винкельман", "бергман"], ["водянки яичка", "пункция водянки", "пункция варикоцеле", "пункции варикоцеле", "пункция при водянке", "пункция гидроцеле", "пункции гидроцеле", "пункция при гидроцеле", "операция при гидроцеле", "операция при водянке яич", "операция по поводу гидро", "операция по поводу водянки яи", "винкельман", "бергман"], "Лечение водянки яичка", ["дет", "реб", "втор", "контрол", "при", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["микрохирургическ"], ["операци"], "Микрохирургическая операция при варикоцеле", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["варикоцел"])
    main_func(["низведен", "орхипекси"], ["яичк", "орхипекси"], "Низведение яичка / Орхипексия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["иванисевич", "иваниссевич"], ["иваниссевич", "иванисевич"], "Операция Иваниссевича при варикоцеле", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["мармар", "микрохирургическ"], ["мармар", "варикоцеле"], "Операция Мармара при варикоцеле", ["дет", "реб", "втор", "описани", "расшифров", "рецидив", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["опера"], ["варикоцел"], "Операция при варикоцеле", ["дет", "микро", "иванис", "мармар", "лапар", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал", "сперматоцелектом", "сперматоцелэктом", "иссечен", "иссечение сперматоцеле"], ["кист", "сперматоцелектом", "сперматоцелэктом", "иссечение сперматоцеле"], "Удаление кисты придатка яичка / Сперматоцелектомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под ", "для", "во время", "курс"], ["придатка"])
    ...
    main_func(["дюпюитрен"], ["дюпюитрен"], "Операция при контрактуре Дюпюитрена", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лазер"], ["редукц", "коагуля", "томия"], "Лазерная редукция нижних носовых раковин", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["носовых раковин", "носовой раковины"])
    main_func(["нижн"], ["остеоконхотоми"], "Нижняя остеоконхотомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["шугаринг", "сахар"], ["лиц"], "Шугаринг лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["шугаринг", "сахар"], ["ног", "нижних конечностей", "голен", "до колена"], "Шугаринг ног", ["дет", "реб", "пальц", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["комбинирова"], ["чистка лица", "чистки лица", "чистка кожи лица", "чистки кожи лица", "завершающей маской", "дерматологи", "чистка"], "Комбинированная чистка лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["ультразвук", "ультрозвук"], ["чистк"], "Ультразвуковая чистка лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "лоп"])
    ...
    main_func(["фото", "aft"], ["омоложени"], "Фотоомоложение", ["дет", "реб", "втор", "кист", "рук", "лиц", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["фото", "aft"], ["омоложени"], "Фотоомоложение кистей рук", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["кист", "рук"])
    main_func(["фото", "aft"], ["омоложени"], "Фотоомоложение лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["лиц"])
    main_func(["фото"], ["коагуляции сосуд", "коагуляция сосуд"], "Фотокоагуляция сосудов в области носа", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "крыл"], ["нос"])
    main_func(["фото"], ["коагуляции сосуд", "коагуляция сосуд"], "Фотокоагуляция сосудов на крыльях носа", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["крыльях носа", "крыльев носа"])
    main_func(["фото"], ["коагуляции сосуд", "коагуляция сосуд"], "Фотокоагуляция сосудов на подбородке", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["подбород"])
    main_func(["фото"], ["коагуляции сосуд", "коагуляция сосуд"], "Фотокоагуляция сосудов на щеках", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["щек", "щеч"])
    main_func(["belotero", "белотеро"], ["belotero", "белотеро"], "Инъекции Belotero", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["restyline", "restylane", "рестилайн", "restylaine"], ["restyline", "restylane", "рестилайн", "restylaine"], "Инъекции Restylane", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лфк", "лечебн"], ["физкультур", "лфк"], "Лечебная физкультура / ЛФК", ["дет", "онлайн", "лиц", "масс", "скайп", "skype", "online", "on line", "on-line", "реб", "втор", "описани", "беремен", "расшифров", "занятий", "во время", "курс"])
    ...
    main_func(["маникюр"], ["маникюр"], "Аппаратный маникюр", ["дет", "реб", "лечеб", "медицин",  "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["педикюр"], ["педикюр"], "Аппаратный педикюр", ["дет", "реб", "лечеб", "медиц", "гриб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["педикюр"], ["гриб"], "Педикюр для ногтей с грибком", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "во время", "курс"])
    ...
    main_func(["ультразвук"], ["лифтинг", "подтяжк"], "Ультразвуковой лифтинг", ["дет", "смас", "smas", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "допол", "для", "во время", "курс"])
    ...
    main_func(["удал", "иссеч", "коррекция", "шлиф"], ["рубц", "шрам"], "Удаление шрамов и рубцов", ["дет", "реб", "более", "от 5", "от 0.5", "от 0,5", "свыше", "втор", "носа", "лигатур", "с рубцов", "с послеоперационных ру", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал", "опера"], ["халязион", "холязион", "халазион"], "Удаление халязиона", ["дет", "лазер", "хирурги", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал", "коагул"], ["стержн"], "Удаление стержневой мозоли", ["дет", "механи", "хирурги", "лазер", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["мозол"])
    ...
    main_func(["хирургичес", "механич"], ["стержн"], "Хирургическое удаление стержневой мозоли", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["мозол"])
    main_func(["удал", "лечени"], ["звезд", "сетки", "сеточки", "телеангиоэктаз", "телеангиэктазий", "ангиэктазии"], "Удаление сосудистых звездочек", ["дет", "реб", "фото", "свыше", "более", "начиная", "след", "втор", "лазер", "склеро", "озон", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["сосуд", "телеангиоэктаз", "телеангиэктазий", "ангиэктазии"])
    ...
    main_func(["склер"], ["сосудистых звезд", "сосудистой сет", "телеангиоэктаз", "телеангиэктазий", "ангиэктазии"], "Микросклеротерапия сосудистых звездочек", ["дет", "начиная", "свыше", "след", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    ...
    main_func(["удал", "лечени"], ["купероз"], "Удаление купероза на лице", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал"], ["лазер"], "Лазерное удаление подошвенных бородавок", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "более", "в рамках", "посещени", "след", "для", "во время", "курс"], ["подошвенных бородавок", "подошвенной бородавки", "подошвенная борода", "подошвенных вирусных бородавок", "подошвенной вирусной бородавки", "бородавки на подошве"])
    main_func(["удал"], ["радио", "сурги"], "Радиоволновое удаление подошвенных бородавок", ["дет", "реб", "втор", "описани", "расшифров", "более", "в рамках", "занятий", "посещени", "след", "для", "во время", "курс"], ["подошвенных бородавок", "подошвенной бородавки", "подошвенная борода", "бородавки на подошве"])
    main_func(["удал"], ["азот", "крио"], "Удаление подошвенных бородавок жидким азотом", ["дет", "реб", "втор", "описани", "расшифров", "в рамках", "более", "занятий", "посещени", "для", "след", "во время", "курс"], ["подошвенных бородавок", "подошвенной бородавки", "подошвенная борода", "бородавки на подошве"])
    ...
    main_func(["хими"], ["пилинг"], "Химический пилинг пигментных пятен", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "более", "посещени", "под", "для", "во время", "курс"], ["пигмент"])
    main_func(["удал"], ["ногт"], "Удаление ногтевой пластины", ["дет", "реб", "гриб", "вросш", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал"], ["образован"], "Удаление новообразований молочной железы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["молочн", "грудной железы"])
    ...
    main_func(["удал", "аблация", "абляция"], ["фиброаденом"], "Удаление фиброаденомы молочной железы", ["дет", "следу", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["удал", "марсупи", "вапоризац", "вскрыти"], ["кист"], "Удаление кисты бартолиновой железы", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["бартолин", "бактолин"])
    ...
    main_func(["удал", "тонзиллэктоми", "тонзилэктоми", "деструкция миндалин"], ["миндалин", "тонзиллэктоми", "тонзилэктоми"], "Удаление миндалин / Тонзиллэктомия", ["лазер", "образ", "пробки", "пробок", "пробка", "абсцес", "сурги", "радио", "хирурги", "дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удален", "сечени"], ["копчик"], "Удаление копчиковой кисты", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["кист"])
    main_func(["удал"], ["кератом"], "Удаление кератомы", ["дет", "радио", "сурги", "более", "свыше", "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "след", "механич", "лазер", "азот", "крио", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["удал", "леч", "терап", "коагуля"], ["гемангиом"], "Удаление гемангиомы", ["дет", "кри", "свыше", "начиная", "в рамках", "азот", "след", "лазер", "радио", "сурги", "хирурги", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["удал", "коагул", "лечение"], ["бородав"], "Удаление бородавок", ["дет", "реб", "подошв", "механич", "след", "более", "11-20", "6-10", "от 11", "от 10", "6-10", "2-5", "стоп", "в рамках", "лазер", "свыше", "радио", "сурги", "электр", "хирурги", "крио", "азот", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["электр"], ["бородав"], "Электрокоагуляция вульгарной бородавки", ["дет", "подошв", "реб", "втор", "в рамках", "более", "описани", "11-20", "6-10", "от 11", "от 10", "6-10", "2-5", "расшифров", "след", "занятий", "свыше", "посещени", "под", "для", "во время", "курс"])
    main_func(["удал"], ["атером"], "Удаление атеромы", ["дет", "реб", "радио", "катером", "механич", "сурги", "хирурги", "электр", "лазер", "мошо", "втор", "описани", "расшифров", "в рамках", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["лазер"], ["атером"], "Лазерное удаление атеромы", ["дет", "реб", "мошон" "втор", "уш", "катером", "ух", "описани", "расшифров", "в рамках", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["радио", "сурги"], ["атером"], "Радиоволновое удаление атеромы", ["дет", "реб", "втор", "мошон", "катером", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "в рамках", "курс"])
    ...
    main_func(["электр"], ["атером", "эпидермальной кисты"], "Электрокоагуляция атеромы", ["дет", "реб", "втор", "описани", "мошон", "катером", "расшифров", "занятий", "посещени", "под", "для", "во время", "в рамках", "курс"])
    ...
    main_func(["удален"], ["панариц"], "Удаление панариция", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "в рамках", "курс"])
    ...
    main_func(["хирургич", "механич"], ["мозоли", "мозолей", "мазол"], "Хирургическое удаление мозоли", ["дет", "реб", "втор", "стерж", "описани", "расшифров", "занятий", "посещени", "под", "в рамках", "для", "во время", "курс"])
    ...
    main_func(["лазер"], ["милиум", "миллиум"], "Лазерное удаление милиумов", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "в рамках", "курс"])
    ...
    main_func(["увелич", "увелеч"], ["губ"], "Увеличение губ", ["дет", "гелео", "гиалурон", "полов", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "в рамках", "курс"])
    main_func(["увел"], ["губ"], "Увеличение губ гиалуроновой кислотой", ["дет", "полов", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["гиалуро"])
    ...
    main_func(["ринопластика"], ["ринопластика"], "Ринопластика", ["дет", "реб", "втор", "безопер", "без опер", "наполни", "филлер", "филер", "гиалурон", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["сечен", "разделени", "разведени", "устранение", "синехиотомия", "удаление"], ["синех", "синехий крайней плоти", "синехи полов", "сенехий крайней", "сенехий полов", "сенехий", "спаек при", "спаек край"], "Рассечение синехий", ["дет", "губ", "нос", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["синех", "сенехи"], ["половых губ"], "Рассечение синехий половых губ", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени",  "для", "во время", "курс"])
    main_func(["синех", "сенехи"], ["нос"], "Удаление синехий полости носа", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["пункц", "пунктирование"], ["заднего свода влаг"], "Пункция заднего свода влагалища", ["дет", "реб", "втор", "контрол", "при", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["пункц", "пунктирование"], ["кист"], "Пункция кисты яичника", ["дет", "реб", "втор", "описани", "расшифров", "контрол", "при", "занятий", "посещени", "для", "во время", "курс"], ["яичник"])
    ...
    main_func(["визометрия", "остроты"], ["визометрия", "зрения"], "Визометрия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["подбор"], ["линз"], "Подбор контактных линз", ["дет", "реб", "втор", "описани", "очков", "расшифров", "занятий", "посещени", "во время", "курс"])
    main_func(["подбор"], ["очков"], "Подбор очков для зрения", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    new_doubler_main(["очков"], ["сложн", "цилиндри", "бифокал", "призм"], ["втор", "дет", "реб", "посеще", "не ц", "не б", "не с", "во время", "курс"], "Подбор очков для зрения", 29039, 1132371, "Проверка зрения", "services")
    ...
    main_func(["эрозии", "диатермокоа", "электр"], ["шейки матки"], "Прижигание эрозии шейки матки", ["дет", "реб", "папил", "кондил", "образован", "опухол", "солковаг", "лазер", "влаг", "вульв", "крио", "кони", "азот", "радио", "сурги", "медикамент", "набот", "желез", "кист", "желуд", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий"], ["азот", "крио"], "Прижигание эрозии шейки матки жидким азотом", ["дет", "папил", "опухол", "кони", "кондил", "влаг", "вульв", "образован", "деструкцией шейки", "деструкцией матки", "деструкция шейки", "деструкция матки", "деструкции шейки", "деструкции матки", "ампутац", "биопси", "кист", "набот", "желез", "удал", "резекц", "реб", "желуд", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий"], ["лазер"], "Прижигание эрозии шейки матки лазером", ["дет", "этап", "реб", "терап", "папил", "шлиф", "кониз", "кондил", "влаг", "вульв", "опухол", "образован", "втор", "кист", "биопси", "набот", "желез", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий"], ["солковаг", "медикамент", "лекарств", "консервативное лечение", "химическ"], "Прижигание эрозии шейки матки Солковагином", ["дет", "кони", "влаг", "вульв", "папил", "опухол", "кондил", "образован", "реб", "кист", "набот", "желез", "втор", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["шейки матки", "шейки мати", "эрозии", "эктопии", "эктопиях", "эктопий"], ["радио", "сурги"], "Радиоволновое прижигание эрозии шейки матки", ["дет", "сине", "сеч", "биопси", "реб", "опухол", "кони", "папил", "кондил", "влаг", "вульв", "кист", "набот", "желез", "образован", "втор", "желуд", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["кантопекси", "подтяжк"], ["кантопекси", "уголков глаз"], "Кантопексия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["кантопластик"], ["кантопластик"], "Кантопластика", ["дет", "эпикан", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["пластик", "пунктопластика", "расширение"], ["слез", "пунктопластика"], "Пластика слезной точки", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["точк", "точек", "пунктопластика"])
    ...
    main_func(["радио", "сурги"], ["геморр", "гемор"], "Радиоволновое удаление геморроидального узла", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["коагул", "удал", "сечен", "эвакуац"])
    main_func(["склеротерап", "склерозировани"], ["гемор"], "Склеротерапия геморроидальных узлов", ["дет", "реб",])
    main_func(["тромбэктоми", "тромб"], ["гемор"], "Тромбэктомия геморроидального узла", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["антираб"], ["прививк", "вакцин"], "Антирабическая прививка", ["втор", "книж", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"])
    main_func(["осмотр", "консультаци", "прием"], ["перед", "для"], "Осмотр перед вакцинацией", ["втор", "книж", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"], ["вакцин"])
    ...
    main_func(["пневмо 23", "пневмо-23"], ["пневмо 23", "пневмо-23"], "Пневмококковая прививка Пневмо 23", ["втор", "книж", "осмотр ", "прием", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"])
    ...
    main_func(["инфанрикс"], ["инфанрикс"], "Прививка Инфанрикс", ["дет", "гекса", "реб","втор", "описани", "расшифров", "книж", "занятий", "посещени", "во время", "курс", "дмс"])
    main_func(["инфанрикс"], ["гекса"], "Прививка Инфанрикс-гекса", ["втор", "описани", "расшифров", "занятий", "посещени", "книж", "во время", "курс", "дмс"])
    main_func(["клещ"], ["э-вак", "э вак"], "Прививка Клещ-Э-Вак", ["втор", "описани", "расшифров", "занятий", "посещени", "книж", "во время", "курс", "дмс"])
    ...
    main_func(["прививк", "вакцин"], ["бешенств"], "Прививка от бешенства", ["втор", "описани", "расшифров", "занятий", "книж", "посещени", "во время", "курс", "дмс"])
    main_func(["прививк", "вакцин"], ["тиф"], "Прививка от брюшного тифа", ["втор", "тифим", "сертифика", "описани", "книж", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"])
    ...
    main_func(["прививк", "вакцин"], ["гепатита б", "гепатита b", "гепатита в"], "Прививка от гепатита В", ["втор", "книж", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"])
    main_func(["прививк", "вакцин"], ["герпес"], "Прививка от герпеса", ["втор", "описани", "расшифров", "занятий", "посещени", "книж", "во время", "курс", "дмс"])
    main_func(["прививк", "вакцин"], ["дифтери"], "Прививка от дифтерии", ["втор", "описани", "расшифров", "занятий", "посещени", "книж", "во время", "курс", "дмс"])
    ...
    main_func(["прививк", "вакцин"], ["энцефалит"], "Прививка от клещевого энцефалита", ["втор", "описани", "расшифров", "занятий", "книж", "посещени", "во время", "курс", "дмс"])
    main_func(["прививк", "вакцин"], ["коклюш"], "Прививка от коклюша", ["втор", "описани", "расшифров", "занятий", "посещени", "книж", "во время", "курс", "дмс"])
    main_func(["прививк", "вакцин"], ["кори", "корев"], "Прививка от кори", ["дет", "паротит", "реб","втор", "описани", "расшифров", "книж", "занятий", "посещени", "во время", "курс", "дмс"])
    main_func(["прививк", "вакцин"], ["кори", "корев"], "Прививка от кори и паротита", ["втор", "описани", "краснух", "расшифров", "книж", "занятий", "посещени", "во время", "курс", "дмс"], ["паротит"])
    ...
    main_func(["прививк", "вакцин"], ["краснух"], "Прививка от краснухи", ["дет", "кор", "паротит", "реб","втор", "книж", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"])
    ...
    main_func(["прививк", "вакцин"], ["полиомелит", "полиомиелит"], "Прививка от полиомиелита", ["втор", "орикс", "книж", "имовакс", "описани", "расшифров", "занятий", "посещени", "во время", "курс", "дмс"])
    ...
    main_func(["ротатек", "рота-тек"], ["ротатек", "рота-тек"], "Прививка от ротавируса РотаТек", ["втор", "описани", "расшифров", "занятий", "посещени", "книж", "во время", "курс", "дмс"])
    main_func(["прививк", "сыворот", "анатоксин"], ["столбняк", "столбнячн"], "Прививка от столбняка", ["втор", "описани", "расшифров", "занятий", "книж", "посещени", "во время", "курс", "дмс"])
    ...
    main_func(["грудн"], ["массаж"], "Сегментарный массаж грудного отдела позвоночника", ["дет", "реб", "втор", "допол", "все отделы", "всех отделов", "описани", "клетк", "полост", "меда", "медовый", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс", "шейн"])
    ...
    main_func(["прививк", "вакцин"], ["грипп"], "Прививка от гриппа", ["втор", "описани", "гриппол", "агрипал", "агриппал", "книж", "ваксигрип", "инфлювак", "ультрикс", "флюарикс", "расшифров", "занятий", "посещени", "под", "во время", "курс", "дмс"])
    ...
    main_func(["прессотерапи"], ["прессотерапи"], "Прессотерапия", ["дет", "верх", "штан", "сеансов", "рук", "ниж", "низ", "ног", "тела", "тело", "голо", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "во время", "курс"])
    main_func(["прессотерап"], ["верхних", "рук"], "Прессотерапия верхних конечностей", ["дет", "реб", "втор", "сеансов", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["прессотерап"], ["всего тела", "тела полностью", "тело полностью"], "Прессотерапия всего тела", ["дет", "реб", "костю", "шта", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["прессотерапи"], ["голов"], "Прессотерапия головы", ["дет", "реб", "втор", "описани", "сеансов", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["прессотерапи"], ["ниж", "ног"], "Прессотерапия нижних конечностей", ["дет", "реб", "штан", "втор", "сеансов", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["комков", "комочков"], ["биш"], "Удаление комков биша", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["плазм"], ["век"], "Плазмолифтинг век", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "дополни", "готов", "акци", "под", "скид", "для", "во время", "курс"], ["лифт"])
    main_func(["плазм"], ["волос", "голов"], "Плазмолифтинг волосистой части головы", ["дет", "реб", "втор", "описани", "расшифров", "готов", "дополни", "занятий", "акци", "скид", "посещени", "под", "для", "во время", "курс"], ["лифт"])
    main_func(["плазм"], ["декольт"], "Плазмолифтинг декольте", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "готов", "посещени", "под", "дополни", "акци", "скид", "для", "во время", "курс"], ["лифт"])
    main_func(["плазм"], ["рук", "кистей", "кисти", "кисть"], "Плазмолифтинг кистей рук", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "готов", "посещени", "под", "дополни", "акци", "скид", "для", "во время", "курс"], ["лифт"])
    main_func(["плазм"], ["лиц"], "Плазмолифтинг лица", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "готов", "под", "для", "дополни", "акци", "скид", "во время", "курс"], ["лифт"])
    main_func(["плазм"], ["шеи", "шея", "шейн"], "Плазмолифтинг шеи", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "готов", "дополни", "под", "для", "акци", "скид", "во время", "курс"], ["лифт"])
    main_func(["плазм"], ["десен"], "Плазмолифтинг десен", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "готов", "под", "акци", "дополни", "скид", "для", "во время", "курс"], ["лифт"])
    main_func(["плазмотерапия", "плазматерапия", "prp", "аутоплазменная терапия", "введение"], ["аутоплазмы", "плазмотерапия", "плазматерапия", "терапи", "аутоплазменная терапия"], "Плазмотерапия", ["дет", "после", "предоплат", "реб", "после", "втор", "описани", "дополни", "расшифров", "офр", "озон", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["пластик"], ["голене", "голени"], "Пластика голеней", ["дет", "реб", "лож", "сустав", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["пирсинг", "прокол"], ["нос"], "Пирсинг носа", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["коррекц", "пластик"], ["соск"], "Коррекция сосков", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["реконструкци"], ["груди"], "Реконструкция (восстановление) груди", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["увеличение", "увелеч"], ["груди"], "Увеличение груди", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["удале"], ["грудн", "молоч"], "Удаление грудных имплантов", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["имплант"])
    ...
    main_func(["отопластика", "пластика ушной раковины"], ["отопластика", "пластика ушной раковины"], "Отопластика", ["дет", "лазер", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["лазер"], ["отопластик"], "Лазерная отопластика", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["транусретра", "тур"], ["аденомы простаты", "аденомы предста"], "Трансуретральная резекция (ТУР) аденомы простаты", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["меатотомия"], ["меатотомия"], "Меатотомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["сеч", "устра"], ["фимоз", "щемл"], "Рассечение ущемляющего кольца при парафимозе", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["кольц"])
    ...
    main_func(["массаж"], ["реб", "дет"], "Детский массаж", ["втор", "описани", "расшифров", "абонемент", "занятий", "посещени", "под", "для", "во время", "допол", "курс"], ["общ", "класс"])
    main_func(["сеч"], ["дермоид"], "Иссечение дермоидных кист", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["кист"])
    ...
    main_func(["этмоидотоми"], ["этмоидотом"], "Этмоидотомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал"], ["плевр"], "Удаление плевры", ["дет", "реб", "втор", "инород", "тел", "образ", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["удал", "резекц"], ["вросш"], "Удаление вросшего ногтя", ["дет", "лазер", "бартлет", "радио", "сурги", "хирурги", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["ногт"])
    ...
    main_func(["хирурги"], ["леч"], "Хирургическое лечение вросшего ногтя", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["вросшего ногтя", "вросших ногт"])
    main_func(["хирурги"], ["удал"], "Хирургическое удаление вросшего ногтя", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "радио", "во время", "курс"], ["вросшего ногтя", "вросших ногт", "вросший ноготь"])
    ...
    main_func(["мрт", "мр-", "мр -", "мр ", "магнито-резонанс", "магниторезонанс", "магнитно-резонанс", "магнитнорезонанс", "магнито резонанс", "магнитно резонанс"], ["ангиограф"], "МР-ангиография сосудов головного мозга", ["дет", "реб", "наличии", "нашем", "проведенного", "втор", "описани", "спирал", "мскт", "расшифров", "занятий", "посещени", "спин", "под", "для", "кост", "во время", "курс"], ["сосудов мозга", "сосудов головного мозга", "вен и артерий мозга", "вен и артерий головного мозга", "артерий и вен головного мозга", "артерий и вен мозга", "головного мозга", "мозга"])
    main_func(["мрт", "мр-", "мр -", "мр ", "магнито-резонанс", "магниторезонанс", "магнитно-резонанс", "магнитнорезонанс", "магнито резонанс", "магнитно резонанс"], ["венограф"], "МР-венография головного мозга", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "спирал", "мскт", "посещени", "под", "для", "спин", "во время", "курс"], ["мозг"])
    ...
    main_func(["мрт", "мр-", "мр -", "мр ", "магнито-резонанс", "магниторезонанс", "магнитно-резонанс", "магнитнорезонанс", "магнито резонанс", "магнитно резонанс"], ["ангиограф", "сосудов ше"], "МР-ангиография сосудов шеи", ["дет", "спирал", "мскт", "наличии", "нашем", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["шеи", "шейн"])
    ...
    main_func(["экг", "электрокардиография", "электрокардиограм"], ["экг", "электрокардиография", "электрокардиограмм"], "ЭКГ", ["дет", "акц", "перед", "дом", "выезд", "неб", "сут", "монитор", "бех экг", "ад", "давлен", "холтер", "нагруз", "стресс", "пищевод", "реб", "втор", "занятий", "расшифровка", "описание", "посещени", "под", "для", "во время", "курс"])
    main_func(["ритмокардиография"], ["ритмокардиография"], "Ритмокардиография", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["сут", "смад", "cmaд", "мониторирование"], ["смад", "cmaд", "артериального давления", "мониторирование ад", "мониторирования ад"], "СМАД / Суточное мониторирование АД", ["дет", "дом", "заде", "интерпретация данн", "интерпретация резуль", "выезд", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["сут", "мониторировани"], ["экг", "холтер", "электрокардиографи"], "Суточное мониторирование ЭКГ + АД", ["дет", "реб", "втор", "описани", "расшифровка", "заде", "занятий", "посещени", "под", "для", "во время", "курс"], ["ад", "давлени"])
    ...
    main_func(["сут", "холтеру", "холтеров", "экг- мониторирование", "экг-мониторирование"], ["экг", "электрокардиография", "холтер", "экг- мониторирование", "экг-мониторирование"], "Холтер / Суточное мониторирование ЭКГ", ["дет", "постан", "оценка результатов", "устан", "ад", "заде", "давле", "интерпретация данн", "интерпретация резуль", "реб", "втор", "описани", "расшифровка", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["экг", "электрокардиографи", "электрокардиограмм"], ["реб", "дет"], "ЭКГ ребенку", ["втор", "описани", "расшифровка", "занятий", "посещени", "под", "для", "во время", "курс"])
    main_func(["экг", "электрокардиографи", "электрокардиограмм"], ["нагруз", "физическими упражнениями"], "ЭКГ с нагрузкой", ["дет", "медикаментозной нагрузкой", "реб", "втор", "описани", "расшифровка", "занятий", "посещени", "под", "для", "во время", "курс"])
    ...
    main_func(["имплант", "установк"], ["иол", "интраокулярных линз", "интраокулярной линзы"], "Имплантация ИОЛ при афакии", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["сеанс", "мин", "комплексая мануальная терапия", "комплексная мануальная терапия", "мануальная терапия при "], ["мануальн"], "Сеанс мануальной терапии", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["терап"])
    ...
    main_func(["пластик", "коррек"], ["вросш", "ногтевого ложа"], "Пластика вросшего ногтя", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["b-s", "b/s", "b s"], ["b-s", "b/s", "b s"], "Исправление вросшего ногтя B/S-пластиной", ["дет", "кобалт", "микро", "лемен", "реб", "микро", "мыш", "токси", "исс", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["ногт"])
    main_func(["скоб", "пласти"], ["зто"], "Исправление вросшего ногтя скобой ЗТО", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["ногт"])
    main_func(["ногт", "пласт", "скоб"], ["фрезер"], "Исправление вросшего ногтя скобой Фрезера", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["удал", "деструк"], ["кондилом", "кандилом"], "Удаление кондилом вульвы", ["дет", "реб", "втор", "описани", "след", "свыше", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["вульв"])
    main_func(["удал", "деструк"], ["папиллом", "папилом"], "Удаление папиллом вульвы", ["дет", "реб", "втор", "описани", "след", "свыше", "расшифров", "занятий", "посещени", "для", "во время", "курс"], ["вульв"])
    ...
    main_func(["моллюск", "молюск"], ["моллюск", "молюск"], "Удаление контагиозного моллюска", ["дет", "крио", "более", "свыше", "след", "до 5 элементов", "11-20", "6-10", "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "механич", "в рамках", "азот", "лазер", "радио", "сурги", "хирурги", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["крио", "азот"], ["моллюск", "молюск"], "Криодеструкция контагиозного моллюска жидким азотом", ["дет", "более", "свыше", "след", "до 5 элементов", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "реб", "в рамках", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["лазер"], ["моллюск", "молюск"], "Лазерное удаление контагиозного моллюска", ["дет", "реб", "втор", "более", "до 5 элементов", "след", "свыше", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "описани", "расшифров", "в рамках", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["радио", "сурги"], ["моллюск", "молюск"], "Радиоволновое удаление контагиозного моллюска", ["дет", "более", "до 5 элементов", "реб", "след", "свыше", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "втор", "описани", "расшифров", "в рамках", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["хирургич", "механич"], ["моллюск", "молюск"], "Хирургическое удаление контагиозного моллюска", ["дет", "более", "более", "до 5 элементов", "след", "свыше", "11-20", "6-10",  "от 5", "от 3", "от 6", "от 7", "от 8", "от 9", "от 15", "от 10", "до 5 элементов", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "в рамках", "под", "для", "во время", "курс"])
    ...
    main_func(["инородн"], ["зуб", "корнево"], "Удаление инородного тела из зубного канала", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["контур"], ["пластик"], "Контурная пластика", ["дет", "интим", "нит", "полов", "гиалу", "кислот", "лба", "лоб", "лиц", "нос", "губ", "слез", "скул", "ше", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["удал", "механич"], ["родин", "невус"], "Удаление родинки / невуса", ["дет", "6", "7", "8", "9", "лазер", "механич", "электр", "радио", "сурги", "крио", "азот", "хирургич", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["лазер"], ["родин", "невус"], "Лазерное удаление родинки / невуса", ["дет", "реб", "7-15", "втор", "6", "7", "8", "9", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["радио", "сурги"], ["родин", "невус"], "Радиоволновое удаление родинки / невуса", ["дет", "7-15", "реб", "6", "7", "8", "9", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["крио", "азот"], ["родин", "невус"], "Удаление родинки / невуса жидким азотом", ["дет", "реб", "7-15", "6", "7", "8", "9", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["хирургич", "механич"], ["невус", "родин"], "Хирургичекое удаление родинки / невуса", ["дет", "реб", "7-15", "6", "7", "8", "9", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["электр"], ["родин", "невус"], "Электрокоагуляция невуса", ["дет", "реб", "втор", "описани", "расшифров", "7-15", "6", "7", "8", "9", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["диаскинтест"], ["диаскинтест"], "Диаскинтест", ["дет", "реб", "втор", "описани", "расшифров", "после", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["удал", "сечен", "коагул"], ["кондилом"], "Удаление кондилом в заднем проходе", ["дет", "реб", "втор", "описани", "расшифров", "после", "занятий", "посещени", "для", "курс"], ["анал", "зад", "анус", "аногенитал", "прямой киш"])
    ...
    main_func(["риноскопия"], ["реб", "дет"], "Риноскопия ребенку", ["втор", "описани", "расшифров", "занятий", "посещени"])
    ...
    main_func(["энцефалография"], ["энцефалография"], "Энцефалография", ["дет", "рео", "рэо", "электр", "ээг", "реб", "эхо", "втор", "описани", "расшифров", "занятий", "для", "посещени"])
    ...
    main_func(["скрининг"], ["беремен", "пренатальный"], "Скрининговое УЗИ 1 триместр", ["дет", "реб", "втор", "описани", "хим", "вне", "не скрин", "расшифров", "занятий", "посещени", "для", "курс", "шейк", "трисоми", "хромос", "аномал", "биохим"], ["1 триместр", "до 13", "до 14", "i триместр", "11-14", "1-го три", "11-13 нед"])
    main_func(["скрининг"], ["беремен", "пренатальный"], "Скрининговое УЗИ 2 триместр", ["дет", "узи 2-го триместра беременности", "реб", "втор", "описани", "хим", "вне", "расшифров", "не скрин", "занятий", "посещени", "для", "курс", "шейк", "трисоми", "хромос", "аномал", "биохим"], ["2 триместр", "до 27", "до 28", "ii триместр", "20-22", "2-го три", "18-21 нед"])
    main_func(["скрининг"], ["беремен", "пренатальный"], "Скрининговое УЗИ 3 триместр", ["дет", "реб", "втор", "описани", "хим", "узи 3-го триместра беременности", "вне", "расшифров", "не скрин", "занятий", "посещени", "для", "курс", "шейк", "трисоми", "хромос", "аномал", "биохим"], ["3 триместр", "с 28", "iii триместр", "32-34", "3-го три", "30-34 нед"])
    ...
    new_doubler_main(["узи", "ультразвук"], ["печени и желчного", "печени с желчным", "желчного и печени", "желчного с печень", "печень и желчный", "желчный и печень", "печень + желчный"], ["дет", "реб", "други", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс", "навед", "пункц", "контрол"], "УЗИ печени", 47426, 541726, "УЗИ брюшной полости", "methods")
    main_func(uzi, uzi_po4ek, id_uzi_po4ek, stop_for_uzi_po4ek)
    new_doubler_main(["узи", "ультразвук"], ["почек и надпочечни", "почек с надпочечникам", "надпочечники и почки", "надпочечников и почек", "почки и надпочечников", "почки + надпочечники", "почек, надпочечников"], ["дет", "реб", "други", "втор", "описани", "расшифров", "пузыр", "занятий", "посещени", "для", "во время", "курс", "навед", "пункц", "контрол"], "УЗИ почек", 47426, 540984, "УЗИ брюшной полости", "methods")
    main_func(["проведение теста", "диагностика беременности", "диагностирование беременности"], ["беременность", "диагностика беременности", "диагностирование беременности"], "Тест на беременность", ["дет", "реб", "втор", "описани", "хим", "расшифров", "занятий", "посещени", "для", "курс"])
    main_func(["амниотест", "тест"], ["амниотест", "подтекани"], "Амниотест", ["дет", "реб", "втор", "описани", "хим", "расшифров", "занятий", "посещени", "для", "курс"], ["вод", "амниотест"])
    ...
    main_func(["уреазн", "дыхательный тест", "дыхательного теста", "хелик- тест", "хелик-тест"], ["уреазн", "дыхательный тест", "дыхательного теста", "helicobacter", "хеликобактер", "хелик- тест", "хелик- тест"], "Дыхательный тест на хеликобактер", ["дет", "реб", "втор", "описани", "без", "расшифров","прием", "консультац", "после", "занятий", "прив", "справ", "посещени", "для", "курс", "плода", "крови матери", "гена", "кровь"])
    main_func(["ведение беременности", "ведению беременности"], ["ведени"], "Ведение беременности", ["дет", "реб", "втор", "описани", "без", "расшифров", "после", "занятий", "консульт", "прием", "прив", "справ", "посещени", "для", "курс"])
    ...
    new_doubler_main(["дуплекс", "уздс", "дс "], ["артерий и вен верхних конечностей", "сосудов (артерий и вен) верхних конечностей", "артерий и вен рук", "артерий и вен верхней конечности", "артерий и вен на верхн", "вен и артерий рук", "вен и артерий верхн", "сосудов верхн", "сосудов рук"], ["ребен", "перед", "дет", "одного", "бры", "чрев"], "Дуплексное сканирование вен верхних конечностей", 1415, 546691, "Дуплексное сканирование", "methods")
    new_doubler_main(["дуплекс", "уздс", "дс "], ["артерий и вен нижн", "артерий и вен ног", "вен и артерий ног", "вен и артерий ниж", "сосудов нижн", "сосудов ног"], ["ребен", "перед", "дет", "одного", "ного", "бры", "чрев"], "Дуплексное сканирование вен нижних конечностей", 1415, 2109275, "Дуплексное сканирование", "methods")
    new_doubler_main(["дуплекс", "уздс", "дс "], ["артерий и вен верхних конечностей", "артерий и вен рук", "артерий и вен верхней конечности", "артерий и вен на верхн", "сосудов (артерий и вен) верхних конечностей", "вен и артерий рук", "вен и артерий верхн", "сосудов верхн", "сосудов рук"], ["ребен", "перед", "дет", "одного", "бры", "чрев"], "Дуплексное сканирование артерий верхних конечностей", 1415, 866862, "Дуплексное сканирование", "methods")
    new_doubler_main(["дуплекс", "уздс", "дс "], ["артерий и вен нижн", "артерий и вен ног", "вен и артерий ног", "вен и артерий ниж", "сосудов нижн", "сосудов ног"], ["ребен", "перед", "дет", "ного", "одного", "бры", "чрев"], "Дуплексное сканирование артерий нижних конечностей", 1415, 2109271, "Дуплексное сканирование", "methods")
    ...
    new_doubler_main(["вправлени", "устранение"], ["вывиха крупн", "вывихов крупн", "крупных сустав", "крупный сустав", "крупного суста", "крупном суста", "сустав (круп", "большой сустав", "большом суставе", "большого сустава"], ["дет", "кроме", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время"], "Вправление вывиха", 49585, 1132290, "Вправление вывиха", "services")
    ...
    new_doubler_main(["экг", "электрокардиография", "электрокардиограм"], ["с расшифровкой", "включая расшифровку", "и расшифровка"], ["дет", "акц", "дом", "выезд", "неб", "сут", "монитор", "ад", "давлен", "холтер", "нагруз", "стресс", "пищевод", "реб", "втор", "занятий", "расшифровка", "описание", "посещени", "под", "для", "во время", "курс"], "ЭКГ", 1060, 405, "ЭКГ и АД", "methods")
    ...
    perfect_match(["взятие крови из вены", "взятие крови", "забор крови", "забор  крови", "взятие крови для анализа из вены", "забор крови из вены", "забор крови из периферической вены", "взятие крови из периферической вены", "забор венозной крови", "взятие венозной крови", "забор крови(вена)", "взятие крови (вена)", "взятие крови (из вены)", "забор крови для анализов", "забор крови из вены (пальца)", "взятие крови из периферической вены", "забор крови из периферической вены ( пациенты от 5 лет)"], "Забор крови")
    perfect_match(["взятие мазка", "забор мазка", "взятие материала ( соскоб)", "взятие (забор) гинекологического мазка", "взятие гинекологического мазка", "получение влагалищного мазка", "забор материала на анализ (мазок) на приеме", "забор мазков для исследования из носа, уха или горла (без стоимости исследования) (1 забор)", "получение урогенитального мазка", "получение влагалищного мазка на флору, онкоцитологию, ПЦР исследование, бакпосев", "взятие мазка из уретры"], "Взятие мазка")
    ...
    main_func(["удал", "лечение одной"], ["папил"], "Удаление папиллом", ["дет", "лазер", "крио", "азот", "радио", "сурги", "электро", "дэк", "диатермо", "вульв", "вагин", "влагал", "ротов", "глот", "лор", "анус", "анал", "зад", "более", "свыше", "след", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["лазер"], ["папил"], "Лазерное удаление папиллом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["радио", "сурги"], ["папил"], "Радиоволновое удаление папиллом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["крио", "азот"], ["папил"], "Удаление папиллом жидким азотом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["хирурги", "механич"], ["папил"], "Хирургическое удаление папиллом", ["дет", "ради", "сурги", "коагул", "электр", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["электро", "диатермо", "дэк"], ["папил"], "Электрокоагуляция папиллом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["удал"], ["кондил", "кандил"], "Удаление кондилом", ["дет", "лазер", "крио", "азот", "радио", "медикамент", "сурги", "электро", "дэк", "диатермо", "солкоде", "лекарств", "вульв", "вагин", "влагал", "ротов", "глот", "лор", "анус", "анал", "зад", "более", "свыше", "след", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["крио", "азот"], ["кондил", "кандил"], "Криодеструкция кондилом жидким азотом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["лазер"], ["кондил", "кандил"], "Лазерное удаление кондилом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["радио", "сурги"], ["кондил", "кандил"], "Радиоволновое удаление кондилом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["солкодер", "лекарств", "медикамент"], ["кондил", "кандил"], "Удаление кондилом солкодермом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    main_func(["электро", "дэк", "диатермо"], ["кондилом", "кандил"], "Электрокоагуляция кондилом", ["дет", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
    ...
    main_func(["интерпретация результатов", "второе мнение", "консилиум"], ["друго", "второе мнение", "консилиум"], "Второе мнение врача", ["дет", "привлече", "для участия в консилиуме", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    main_func(["тест", "проб", "спирометри", "фвд", "внешнего дыхания"], ["бронхолитиком"], "Тест с бронхолитиком", ["дет", "реб", "втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    ...
    main_func(["эндосонография", "эндоузи", "эхоэндоскоп", "эндоскопическое ультразвуковое исследование", "Эндоскопическое узи"], ["пищевод", "желудок", "кишеч", "кишк", "эндосонография", "эндоузи"], "Эндосонография / Эндоузи", ["дет", "реб", "втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    ...
    main_func(["герме"], ["фиссур"], "Герметизация фиссур", ["втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
    ...
    main_func(["каппа", "каппы", "капа", "капы"], ["спорт", "бруксиз", "разгрузоч", "ретенци"], "Капы для зубов", ["дет", "реб", "втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
    ...
    main_func(["кюретаж"], ["пародонт"], "Закрытый кюретаж пародонтального кармана", ["дет", "реб", "втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["закр"])
    main_func(["кюретаж"], ["пародонт"], "Открытый кюретаж пародонтального кармана", ["дет", "реб", "втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["откр"])
    main_func(["дневной стационар"], ["дневной стационар"], "Дневной стационар", ["дет", "реб", "втор", "без", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
    ...
    function_with_assistant_in_cell_or_and_min_price_main(["026", "медицинское обследование для поступающих в дошкол"], ["детского сада", "детсад", "садик", "детский сад", "медицинское обследование для поступающих в дошкол"], 6000, "Медкарта 026 для детского сада")
    ...
    main_func(["чистка", "комплекс", "гигиен", "отложен", "сняти"], ["air", "эйрфлоу", "эйр флоу"], "Чистка зубов AirFlow", ["дет", "реб", "втор", "курс", "1 зуб", "скидк", "без", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["flow"])
    main_func(["удал"], ["движ"], "Удаление подвижного зуба", ["дет", "реб", "втор", "акци", "фрагмент", "отбели", "стенки", "стенок", "импла", "описани", "неподвиж", "расшифров", "занятий", "посещени", "во время", "неподвиж", "для", "курс"], ["зуб"])
    main_func(["кор", "щепл", "расшир", "аугмент", "увели", "пластик"], ["альвеол"], "Коррекция альвеолярного гребня", ["дет", "реб", "втор", "без", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["греб", "отрост"])
    main_func(["удаление имплант"], ["удаление имплант"], "Удаление зубного имплантата", ["дет", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
    main_func(["отбел"], ["opales", "опалесенс", "опейлсенс"], "Отбеливание зубов Opalescence", ["дет", "реб", "курс", "скидк", "втор", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "дом", "курс"])
    ...
    main_func(["ортопантомограмма", "оптг", "ортопантомография", "панорамн"], ["ортопантомограмма", "оптг", "ортопантомография", "рентген"], "Ортопантомограмма", ["дет", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["ортопантомограмма", "оптг", "ортопантомография", "зуб"])
    main_func(["шинир"], ["зуб"], "Шинирование зуба", ["дет", "реб", "втор", "акци", "реплантация", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс", "след"])
    main_func(["времен"], ["коронк"], "Временные коронки", ["дет", "реб", "втор", "акци", "отбели", "цементировка", "временный цемент", "имплант", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
    main_func(["внутри"], ["канал"], "Внутриканальное отбеливание зубов", ["дет", "реб", "втор", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"], ["отбел"])
    ...
    main_func(["чист", "проф", "снятие", "удал"], ["зуб", "гигиен", "отложени"], "Чистка зубов ультразвуком", ["дет", "реб", "имплант", "жир", "втор", "имплант", "акци", "лиц", "кож", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["ультразвук"])
    main_func(["удал"], ["ретенирова", "ретинирова"], "Удаление ретенированного зуба", ["дет", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"], ["зуб"])
    ...
    main_func(["имплант"], ["alpha bio", "альфа био", "alfa", "альфа-био"], "Импланты Alpha Bio", ["дет", "формировате", "аналог", "времен", "фдм", "коронк", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["анкилос", "ankilos", "ankylos"], "Импланты ANKYLOS", ["дет", "формировате", "фдм", "реб", "коронк", "аналог", "времен", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    ...
    main_func(["имплант"], ["astra", "астр-тек", "астратек", "астра тек"], "Импланты Astra Tech", ["дет", "реб", "полный", "съемн", "формировате", "фдм", "втор", "коронк", "аналог", "времен", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["bicon"], "Импланты Bicon", ["дет", "реб", "втор", "акци", "отбели", "формировате", "фдм", "описани", "коронк", "аналог", "времен", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["biomet"], "Импланты Biomet 3I", ["дет", "реб", "втор", "акци", "отбели", "формировате", "фдм", "коронк", "описани", "аналог", "времен", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["icx"], "Импланты Icx", ["дет", "реб", "втор", "акци", "отбели", "описани", "формировате", "фдм", "коронк", "расшифров", "аналог", "времен", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["impro"], "Импланты IMPRO", ["дет", "реб", "втор", "акци", "отбели", "описани", "формировате", "фдм", "коронк", "расшифров", "аналог", "времен", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["mis"], "Импланты MIS", ["дет", "реб", "втор", "акци", "отбели", "описани", "формировате", "фдм", "расшифров", "коронк", "занятий", "аналог", "времен", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["nobel", "нобел"], "Импланты Nobel Biocare", ["дет", "реб", "втор", "акци", "формировате", "фдм", "отбели", "коронк", "описани", "расшифров", "аналог", "времен", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["осстем", "остем", "osstem", "ostem"], "Импланты Osstem", ["дет", "реб", "формировате", "фдм", "втор", "на 4", "акци", "коронк", "отбели", "описани", "аналог", "времен", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["имплант"], ["xive"], "Импланты XIVE", ["дет", "реб", "втор", "акци", "отбели", "описани", "формировате", "фдм", "расшифров", "коронк", "занятий", "посещени", "аналог", "времен", "во время", "для", "курс"] )
    main_func(["имплант"], ["zimmer", "циммер", "зиммер"], "Импланты Zimmer", ["дет", "реб", "втор", "формировате", "фдм", "акци", "отбели", "коронк", "описани", "расшифров", "аналог", "времен", "занятий", "посещени", "во время", "для", "курс"] )
    ...
    main_func(["ороантра"], ["сообще"], "Закрытие ороантрального сообщения", ["дет", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
    ...
    main_func(["vector", "вектор"], ["лечени", "терапи", "снятие"], "Лечение аппаратом Вектор", ["дет", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "курс"] )
    main_func(["установка", "прямой", "индивидуаль", "alpha", "шаровид", "углово", "adin", "alfa"], ["абатмент", "абантмент", "аббатмент"], "Установка абатмента", ["дет", "реб", "времен", "втор", "акци", "отбели", "описани", "расшифров", "без установки абат", "без стоимости абат", "не включая аба", "отдельно", "занятий", "посещени", "во время", "для", "курс"] )
    main_func(["десны", "установ"], ["формировател", "фдм"], "Установка формирователя десны", ["дет", "реб", "втор", "при ", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс", "не включа", "без установки форми"], ["фдм", "формировател"])
    main_func(["коронка"], ["на имплант"], "Коронка на имплант", ["дет", "реб", "втор", "акци", "отбели", "времен", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
    main_func(["пластмас"], ["коронка"], "Пластмассовые коронки", ["дет", "реб", "времен", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
    main_func(["культев"], ["вкладк"], "Культевая вкладка", ["дет", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс", "не включа", "привар", "удал", "почин", "допол", "снятие"])
    main_func(["брекеты", "брекет-систем"], ["кларити", "clarit"], "Брекеты Clarity", ["дет", "брекета", "этап", "реб", "одного", "использование", "актив", "втор", "акци", "осмотр", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
    main_func(["брекеты", "брекет-систем"], ["damon"], "Брекеты Damon Clear", ["дет", "реб", "брекета", "втор", "этап", "акци", "актив", "отбели", "одного", "использование", "описани", "осмотр", "расшифров", "занятий", "посещени", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"], ["clear"])
    main_func(["брекеты", "брекет-систем"], ["damon"], "Брекеты Damon-Q", ["дет", "реб", "втор", "акци", "брекета", "этап", "одного", "использование", "отбели", "актив", "описани", "расшифров", "осмотр", "занятий", "посещени", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"], ["q"])
    main_func(["брекет", "брекет-систем"], ["empower"], "Брекеты Empower", ["дет", "реб", "втор", "акци", "этап", "брекета", "отбели", "актив", "описани", "одного", "использование", "расшифров", "занятий", "осмотр", "посещени", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["gemini", "gemeni"], "Брекеты Gemini", ["дет", "реб", "втор", "акци", "брекета", "отбели", "этап", "описани", "актив", "расшифров", "одного", "использование", "занятий", "посещени", "осмотр", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["in"], "Брекеты In-Ovation", ["дет", "реб", "металлический", "втор", "одного", "брекета", "использование", "акци", "отбели", "этап", "одного", "использование", "описани", "расшифров", "актив", "занятий", "посещени", "во время", "осмотр", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"], ["ovation"])
    main_func(["брекет", "брекет-систем"], ["ini"], "Брекеты Mini Master", ["дет", "реб", "втор", "акци", "отбели", "этап", "брекета", "описани", "расшифров", "актив", "занятий", "посещени", "одного", "использование", "во время", "для", "осмотр", "курс", "не включа", "привар", "почин", "допол", "снятие"], ["master"])
    main_func(["брекет", "брекет-систем"], ["sprint", "спринт"], "Брекеты Sprint", ["дет", "реб", "втор", "акци", "отбели", "этап", "брекета", "описани", "расшифров", "актив", "занятий", "посещени", "одного", "использование", "во время", "осмотр", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["стб", "stb"], "Брекеты Stb", ["дет", "реб", "втор", "акци", "отбели", "описани", "этап", "брекета", "расшифров", "занятий", "актив", "посещени", "во время", "одного", "использование", "для", "осмотр", "курс", "не включа", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["victory", "виктори"], "Брекеты Victory", ["дет", "реб", "втор", "акци", "отбели", "этап", "брекета", "описани", "расшифров", "занятий", "актив", "посещени", "одного", "использование", "во время", "для", "осмотр", "курс", "не включа", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["блеск"], "Брекеты Блеск", ["дет", "реб", "втор", "акци", "отбели", "описани", "одного", "использование", "брекета", "расшифров", "этап", "занятий", "посещени", "во время", "актив", "для", "курс", "не включа", "осмотр", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["дет", "реб"], "Брекеты для детей", ["втор", "акци", "отбели", "описани", "расшифров", "занятий", "этап", "одного", "брекета", "использование", "посещени", "во время", "для", "актив", "курс", "не включа", "привар", "осмотр", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["инкогнито", "incognito"], "Брекеты Инкогнито", ["дет", "реб", "втор", "акци", "отбели", "описани", "этап", "расшифров", "одного", "брекета", "использование", "занятий", "посещени", "актив", "во время", "для", "курс", "осмотр", "не включа", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["ortos", "ортос"], "Брекеты Ортос", ["дет", "реб", "втор", "акци", "отбели", "описани", "одного", "использование", "расшифров", "этап", "брекета", "занятий", "посещени", "во время", "актив", "для", "курс", "не включа", "осмотр", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["сапфир"], "Сапфировые брекеты", ["дет", "реб", "втор", "акци", "отбели", "описани", "одного", "использование", "расшифров", "занятий", "брекета", "этап", "посещени", "во время", "для", "актив", "курс", "не включа", "привар", "осмотр", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["самолигир", "безлигатур"], "Самолигирующие / безлигатурные брекеты", ["дет", "реб", "одного", "использование", "при ", "втор", "акци", "брекета", "отбели", "этап", "описани", "расшифров", "занятий", "актив", "посещени", "во время", "осмотр", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["лингвал"], "Лингвальные брекеты", ["дет", "реб", "осмотр", "актив", "втор", "акци", "отбели", "одного", "использование", "описани", "расшифров", "брекета", "этап", "занятий", "посещени", "во время", "для", "курс", "не включа", "осмотр", "привар", "почин", "допол", "снятие"])
    main_func(["брекет", "брекет-систем"], ["снятие"], "Снятие брекет-системы", ["дет", "реб", "элеме", "при ", "кнопк", "замк", "брасл", "втор", "акци", "актив", "отбели", "описани", "расшифров", "брекета", "занятий", "этап", "посещени", "во время", "курс", "не включа", "привар", "почин", "допол"])
    ...
    main_func(["удал"], ["молоч", "времен"], "Удаление молочных зубов", ["дет", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс", "не включа", "привар", "почин", "допол"], ["зуб"])
    function_with_assistant_in_cell_or_and_min_price_main(["invisalign"], ["invisalign"], 100000, "Элайнеры Invisalign")
    ...
    main_func(["lm", "l-m"], ["активат"], "LM-активатор", ["дет", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "контрол"])
    ...
    main_func(["внутри"], ["коронк"], "Внутрикоронковое отбеливание зуба", ["дет", "реб", "втор", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"], ["отбел"])
    ...
    main_func(uzi, uzi_kishe4nika_2, id_uzi_kishe4nika, stop_for_uzi_kishe4nika)
    ...
    main_func(uzi, uzi_jeludka, id_uzi_jeludka, stop_for_uzi_jeludka)
    ...
    main_func(uzi, uzi_jeludka_rebenku_1, id_uzi_jeludka_rebenku, stop_for_uzi_jeludka_rebenku, uzi_jeludka_rebenku_2)
    ...
    main_func(uzi, uzi_m9gkih_legkih, id_uzi_legkih, stop_for_uzi_legkih)
    ...
    main_func(instil_mo4e, instil_mo4e_2, id_instil_mo4e, stop_for_instil_mo4e)
    ...
    main_func(mrt, mr_kishe4, id_mr_kishe4_reb, stop_mr_kishe4_reb)
    ...
    main_func(mrt, mr_kishe4nikk, id_kishe4nikk, stop_mr_kishe4nikk, kt_for_kontrast)
    ...
    main_func(biomikro, biomikro_2, id_biomikro, stop_biomikro)
    ...
    main_func(sfinmetr, sfinmetr_2, id_sfinmetr, stop_sfinmetr)
    main_func(uroflowmetr, uroflowmetr_2, id_uroflowmetr, stop_uroflowmetr)
    main_func(cistometr, cistrometr_2, id_cistometr, stop_cistometr)
    main_func(cherpishekardi, cherpishekardi_2, id_cherpishekardi, stop_cherpishekardi)
    main_func(elektrogastro, elektrogastro_2, id_elektrogastro, stop_elektrogastro)
    main_func(elektronis, elektronis_2, id_elektronis, stop_elektronis)
    main_func(ehosinus, ehosinus_2, id_ehosinus, stop_ehosinus)
    main_func(fvd, fvd_2, id_fvd, stop_fvd)
    main_func(bodiplet, bodiplet_2, id_bodiplet, stop_bodiplet)
    main_func(pnevmotah, pnevmotah_2, id_pnevmotah, stop_pnevmotah)
    main_func(diffleg, diffleg_2, id_diffleg, stop_diffleg)
    main_func(spiromet, _spiromet2, id_spiromet, stop_spiromet)
    main_func(ergospiro, ergospiro_2, id_ergospiro, stop_ergospiro)
    main_func(veroelrgo, veloergo_2, id_veloergo, stop_veloergo)
    main_func(steptest, steprtest_2, id_steprtest, stop_steptetst)
    main_func(tredtest, tredtest_2, id_tredtest, stop_tredtest)
    main_func(elektroneyro, elektroneyro_2, id_eelktorneyro, stop_elektorneyro)
    main_func(enmg, enmg_2, id_enmg, stop_enmg)
    main_func(enmgverh, enmgverh_2, id_enmgverh, stop_enmgverh)
    main_func(enmgniz, enmgniz_2, id_enmgniz, stop_enmgniz)
    main_func(enmglic, enmglic_2, id_enmglic, stop_enmglic)
    main_func(enmgnreb, enmgreb_2, id_enmgreb, stop_enmgnireb)
    main_func(bronhobio, bronhobio_2, id_bronhobio, stop_bronhobio)
    main_func(bronhomok, bronhomok_2, id_bronhomok, stop_bronhomok)
    main_func(duozon, duozon_2, id_duozon, stop_duozon)
    main_func(kapsulendo, kapsulendo_2, id_kapsulendo, stop_kapsulendo)
    main_func(mikrolaringo, mikrolaringo_2, id_mikrolaringo, stop_mikrolaringo)
    main_func(mikrooto, mikro_2, id_mikro, stop_mikrooto)
    main_func(nefroskop, nefroskop_2, id_nefroskop, stop_nefroskop)
    main_func(rektosigmo, rektosigmo_2, id_rektosigmo, stop_rektosigmo)
    main_func(rektoskop, rektoskop_2, id_rektoskop, stop_rektoskop)
    main_func(sigmoskop, sigmoskop_2, id_sigmoskop, stop_sigmoskop)
    main_func(torakoskop, torakoskop_2, id_torakoskop, stop_torakoskop)
    main_func(ureteroskop, ureteroskop_2, id_ureteroskop, stop_ureteroskop)
    main_func(faringoskop, faringoskop_2, id_faringoskop, stop_faringoskop)
    main_func(holehodoskop, holehodoskop_2, id_holehodoskop, stop_holehodoskop)
...
def lab_finder():
    ...
    svobodniy = ["свободн"]
    pcr_na_skritie_infekcii = ["на скрытые инфекции", "иппп", "chlamydia trachomatis, mycoplasma genitalium, neisseria gonorrhoeae, trichomonas vaginalis"]
    pcr_na_skritie_infekcii_2 = ["gonorrhoeae", "chlamydia", "mуcoplasma", "trichomonas"] 
    pcr_na_skritie_infekcii_3 = ["gonorrhoeae", "chlamydia", "mуcoplasma", "trichomonas"]
    pcr_na_skritie_infekcii_4 = ["gonorrhoeae", "Chlamydia", "Mycoplasma", "Trichomonas"]
    pcr_na_skritie_infekcii_5 = ["gonorrhoeae", "chlamydia", "Mуcoplasma", "Trichomonas"]
    pcr_na_skritie_infekcii_6 = ["трихомо", "гонор", "микопла", "хламид"] 
    pcr_na_skritie_infekcii_7 = ["трихомо", "гонор", "микопла", "хламид"]
    pcr_na_skritie_infekcii_8 = ["трихомо", "гонор", "микопла", "хламид"]
    pcr_na_skritie_infekcii_9 = ["трихомо", "гонор", "микопла", "хламид"]
    pcr_na_skritie_infekcii_10 = ["трихомо", "гонор", "микопла", "хламид"] 
    pcr_na_skritie_infekcii_11 = ["трихомо", "гонор", "микопла", "хламид"]
    pcr_na_skritie_infekcii_12 = ["трихомо", "гонор", "микопла", "хламид"]
    pcr_na_skritie_infekcii_13, id_pcr_na_skritie_infekcii = ["трихомо", "гонор", "микопла", "хламид"], ["ПЦР анализ на скрытые инфекции"]
    ...
    ########################################################################################################
    def new_doubler_lab(name_1, name_2, stopword, what_double, what_double_section, what_double_service, what_double_title, service_or_method):
        wb.active = 1                                            
        sheet_1 = wb.active                                                         
        rows, columns = sheet_1.max_row, sheet_1.max_column
        for i in range(1, rows+1):
    ...
    new_doubler_lab(["впч", "папиллом", "папилом", "hpv"], ["высок", "онкоген", "канцеро", "16, 18, 31, 33", "16/18/31/33", "16, 18, 30, 31, 33"], ["прижиг", "удал", "книж", "низ"], "Анализ ВПЧ", 28804, 1131878, "Анализ ВПЧ", "services")
    new_lab_finder(["ca", "ca ", "ca-", "са", "са ", "са-", "cа", "cа-", "cа ", "сa", "сa ", "сa-"], ["125"], "Анализ крови на Са-125", ["описани", "книж", "результ", "тест", "125гп"])
    new_lab_finder(["вирус иммунодефицита", "вич", "human immunodeficiency virus", "hiv", " вич"], ["вирус иммунодефицита", "вич", "human immunodeficiency virus", "hiv", " вич"], "Анализ крови на ВИЧ", ["лмк", "книж", "профосмо", "профпат", "вакцин", "сулкович", "первич", "вторич", "рабинович"])
    ...
    new_lab_finder(["уреазн", "дыхательный тест", "дыхательного теста"], ["уреазн", "дыхательный тест", "дыхательного теста", "helicobacter", "хеликобактер"], "Дыхательный тест на хеликобактер", ["плода", "крови матери", "гена", "кровь"])
    ...
    new_lab_finder(["аллерг"], ["живот", "кошк", "собак", "шерст", "лошад", "коров"], "Анализ на аллергию к животным", ["шерстис", "бухар"])
    new_lab_finder(["аллерг"], ["пищев"], "Анализ на пищевые аллергены", ["дет", "реб", "токси", "стафил"])
    new_lab_finder(["аллерг"], ["бытов", "пыль"], "Анализ на бытовые аллергены", ["пыльц"])
    new_lab_finder(["аллерг"], ["бактери", "плесен", "плесне", "гриб"], "Анализ на бактериальные и грибковые аллергены", ["педиат"])
    new_lab_finder(["аллерг"], ["пыльц", "цветущих", "травам"], "Анализ на пыльцу растений", ["дерев"])
    new_lab_finder(["аллерг"], ["насеком", "таракан"], "Анализ на аллергию к насекомым", ["туширова"])
    ...
    new_lab_finder(["mar-тест", "мар-тест", "mar test", " мар тест", "mar-", "мар-"], ["mar-тест", "мар-тест", "mar test", " мар тест", "mar-", "мар-"], "MAR-тест", ["туширова"])
    ...
    new_lab_finder(["липидограмм", "липидный проф", "липидный статус", "липидного проф", "липидного стату"], ["липидограмм", "липидный проф", "липидный статус", "липидного проф", "липидного стату"], "Липидограмма", ["туширова"])
    new_lab_finder(["тестостерон", "testosterone"], ["тестостерон", "testosterone"], "Анализ на тестостерон", ["туширова", "Туширова"])
    new_lab_finder(["рака яич", "эпидидимальн", "epididymis", "he4", "he-4", "he 4", "не4", "не-4", " не 4"], ["рака яич", "эпидидимальн", "epididymis", "he4", "he-4", "he 4", "не4", "не-4", " не 4"], "Анализ на онкомаркер HE4", ["туширова"])
    ...
    new_lab_finder(["72 4", "72-4", "72.4"], ["72 4", "72-4", "72.4"], "Анализ Cа 72-4", ["туширова"])
    new_lab_finder(["енолаз", "nse", "enolase", "нсэ", "нейронспецифическ", "нейро-специфическ"], ["енолаз", "nse", "enolase", "нсэ", "нейронспецифическ", "нейро-специфическ"], "Анализ на нейронспецифическую енолазу", ["туширова", "pratense"])
    ...
    new_lab_finder(["отцовс"], ["отцовс"], "ДНК тест на отцовство", ["прижиг", "удал", "книж"])
    ...
    new_lab_finder(["катион", "eosinophil", "эозинофил", "катионный протеин эозинофилов"], ["катион", "eosinophil", "эозинофил", "катионный протеин эозинофилов"], "Анализ крови на эозинофильный катионный белок", ["эозинофилов", "нейтрофилов", "лейкоцитов", "эозинофилы"])
    ...
    new_lab_finder(["на скрытые инфекции", "иппп", "chlamydia trachomatis, mycoplasma genitalium, neisseria gonorrhoeae, trichomonas vaginalis"], ["на скрытые инфекции", "иппп", "chlamydia trachomatis, mycoplasma genitalium, neisseria gonorrhoeae, trichomonas vaginalis"], "ПЦР анализ на скрытые инфекции", ["прижиг", "удал", "книж"])
    new_lab_finder(["волос"], ["микроэлемен", "металл", "макроэлемен", "минерал", "элемент"], "Анализ волос на микроэлементы", ["прижиг", "удал", "книж", "ногт", "кож"])
    new_lab_finder(["моча", "моче", "мочи", "мочой"], ["наркоти"], "Анализ мочи на наркотики", ["прижиг", "удал", "книж"])
    new_lab_finder(["са", "сa", "ca", "cа"], ["19 9", "19-9"], "Анализ Са-19-9", ["прижиг", "удал", "книж", "мин"])
    ...
    new_lab_finder(["15 3", "15-3", "карциномы молочн"], ["15 3", "15-3", "карциномы молочн"], "Анализ крови на Са 15-3", ["мин"])
    ...
    new_doubler_lab(["hla"], ["drb1, dqa1, dqb1", "dqa1, drb1, dqb1", "dqb1, dqa1, drb1", "dqa1, dqb1, drb1", "drb1, dqb1, dqa1", "drb1, dqa1, dqb1", "hla-dqa1, hla-dqb1, hla-drb", "гистосовместимост", "комплекс", "по трем генам"], ["уроген", "андрофлор", "патоген", "chla", "локус dqa1", "локус dqb1", "локус drb1", "b27", "1 локус", "один локус", "одному локусу", "абакавир", "5701", "чувств"], "HLA-типирование", 49243, 1875930, "HLA-типирование", "services")
    ...
    perfect_match_lab(["взятие крови из вены", "взятие крови", "забор крови", "забор крови из вены", "забор крови из периферической вены", "забор  крови", "взятие крови из периферической вены", "забор венозной крови", "взятие венозной крови", "забор крови(вена)", "взятие крови для анализа из вены", "взятие крови (вена)", "взятие крови (из вены)", "забор крови для анализов", "забор крови из вены (пальца)", "взятие крови из периферической вены", "забор крови из периферической вены ( пациенты от 5 лет)"], "Забор крови")
    perfect_match_lab(["взятие мазка", "забор мазка", "взятие (забор) гинекологического мазка", "взятие материала ( соскоб)", "забор материала на анализ (мазок) на приеме", "взятие гинекологического мазка", "забор мазков для исследования из носа, уха или горла (без стоимости исследования) (1 забор)", "получение влагалищного мазка", "получение урогенитального мазка", "получение влагалищного мазка на флору, онкоцитологию, ПЦР исследование, бакпосев", "взятие мазка из уретры"], "Взятие мазка")
    new_lab_finder(["антител"], ["коронавирус", "covid"], "Тест на антитела к коронавирусу", ["лмк", "книж", "профосмо", "профпат", "рино", "адено", "профосмо", "парво", "бока", "инфекций", "вакцин"])
    new_lab_finder(["тест", "возбудител", "рнк", "забор на коронавирус"], ["коронавирус", "covid", "забор на коронавирус"], "Тест на коронавирус", ["лмк", "книж", "рино", "адено", "профосмо", "парво", "бока", "инфекций", "антител", "профпат", "вакцин"])
    ...
    new_lab_finder(["антител", "ат", "anti", "анти тел", "анти-тел"], ["ds днк", "днк ds"], "Анализ на антитела к ds ДНК", ["лмк", "книж", "рино", "адено", "профосмо", "парво", "бока", "инфекций", "профпат", "вакцин", "комплекс"])
    ...
    new_lab_finder(["антител", "ат", "anti", "анти тел", "анти-тел"], ["ro/ss-a", "ro / ss-a", "ro/ ss-a", "ro/ssa", "ssa"], "Анализ на антитела к Ro/SS-A", ["лмк", "лист", "гель", "assay", "кал", "книж", "рино", "адено", "профосмо", "парво", "бока", "инфекций", "профпат", "вакцин", "комплекс"])
    ...
    new_lab_finder(["кров", "днк", "антиген"], ["хелико", "helico", "pylori", "pilori", "pylory"], "Анализ крови на хеликобактер Пилори", ["лмк", "книж", "рино", "адено", "биопт", "желуд", "фгдс", "гастро", "эндо", "слиз", "киш", "профосмо", "парво", "бока", "инфекций", "профпат", "вакцин", "комплекс", "профил", "холес", "витамин", "соэ", "вестер"])
...
#########################################################################################################################
        ...
        if q != None:           
            ...
            for m in range(1, 3800):
                ...
                if cell_id[0] == str(cell_sheet_1):
                    ...
                    #print(sheet_1.cell(row = m, column = 5).value)
                    if len(set(a)) > 1:
                            sheet_1.cell(row = m, column = 6).value = 1
                    else:
                            sheet_1.cell(row = m, column = 6).value = 0
    ...
    #Для нахождения ПЦР на скрытые инфекции-2
    a = []
    value_for_list = 100000
    q = None
    for i in range(where_is_lab_1, rows + 1):
        cell = sheet_0.cell(row = i, column = 2).value
        if pcr_na_skritie_infekcii_2[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != ""  and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_2[1] in str(cell) and pcr_na_skritie_infekcii_2[2] in str(cell) and pcr_na_skritie_infekcii_2[3] in str(cell):
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
        ...
        elif pcr_na_skritie_infekcii_3[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_3[1] in str(cell) and pcr_na_skritie_infekcii_3[2] in str(cell) and pcr_na_skritie_infekcii_3[3] in str(cell):
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
        ...
        elif pcr_na_skritie_infekcii_4[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_4[1] in str(cell) and pcr_na_skritie_infekcii_4[2] in str(cell) and pcr_na_skritie_infekcii_4[3] in str(cell): 
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
        elif pcr_na_skritie_infekcii_5[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_5[1] in str(cell) and pcr_na_skritie_infekcii_5[2] in str(cell) and pcr_na_skritie_infekcii_5[3] in str(cell):     
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
        elif pcr_na_skritie_infekcii_6[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_6[1] in str(cell) and pcr_na_skritie_infekcii_6[2] in str(cell) and pcr_na_skritie_infekcii_6[3] in str(cell):
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
        elif pcr_na_skritie_infekcii_7[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_7[1] in str(cell) and pcr_na_skritie_infekcii_7[2] in str(cell) and pcr_na_skritie_infekcii_7[3] in str(cell): 
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
        elif pcr_na_skritie_infekcii_8[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_8[1] in str(cell) and pcr_na_skritie_infekcii_8[2] in str(cell) and pcr_na_skritie_infekcii_8[3] in str(cell):     
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
        elif pcr_na_skritie_infekcii_9[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_9[1] in str(cell) and pcr_na_skritie_infekcii_9[2] in str(cell) and pcr_na_skritie_infekcii_9[3] in str(cell): 
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
        elif pcr_na_skritie_infekcii_10[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_10[1] in str(cell) and pcr_na_skritie_infekcii_10[2] in str(cell) and pcr_na_skritie_infekcii_10[3] in str(cell):     
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
        elif pcr_na_skritie_infekcii_11[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_11[1] in str(cell) and pcr_na_skritie_infekcii_11[2] in str(cell) and pcr_na_skritie_infekcii_11[3] in str(cell):
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 3).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")     
        elif pcr_na_skritie_infekcii_12[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_12[1] in str(cell) and pcr_na_skritie_infekcii_12[2] in str(cell) and pcr_na_skritie_infekcii_12[3] in str(cell): 
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 2).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
                p = cell
                sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
        elif pcr_na_skritie_infekcii_13[0] in str(cell) and sheet_0.cell(row = i, column = 3).value != "" and sheet_0.cell(row = i, column = 3).value != None and pcr_na_skritie_infekcii_13[1] in str(cell) and pcr_na_skritie_infekcii_13[2] in str(cell) and pcr_na_skritie_infekcii_13[3] in str(cell):     
            a.append(value_for_list)
            if int(float(sheet_0.cell(row = i, column = 2).value)) < value_for_list:
                value_for_list = int(float(sheet_0.cell(row = i, column = 3).value))
                q = int(float(sheet_0.cell(row = i, column = 3).value))
    ...
    if q != None:           
        ...
        for m in range(1, 3800):
            cell_sheet_1 = sheet_1.cell(row = m, column = 4).value
            if id_pcr_na_skritie_infekcii[0] == str(cell_sheet_1):
                sheet_1.cell(row = m, column = 5).value = q
                sheet_1.cell(row = m, column = 7).value = p
                sheet_1.cell(row = m, column = 5).fill = PatternFill("solid", fgColor="008000") 
                #print(sheet_1.cell(row = m, column = 5).value)
...
try:
    ...
    print("Ошибка! Не удалось скачать шаблон. Скачай шаблон вручную, перезапусти скрипт и выбери цифру 0")
    time.sleep(5)
wbcsv = wbcsv.drop('Синоним', 1)
wbcsv = wbcsv.drop('Ссылка', 1)
wbcsv = wbcsv.drop('Просмотры выборки за посл. 30 дней', 1)
header_list = ['Родительские категории', 'service_id', 'можно удалить', 'Название выборки', 'price', 'is_min_price', 'comment', 'clinic_id', 'filial_id', 'excluded_service_ids']
