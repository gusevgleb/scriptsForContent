...
def without_lab_func():
	...
	for i in range(1, 300):
		if sheet_0.cell(row = i, column = 2).value == None or sheet_0.cell(row = i, column = 3).value == " " or sheet_0.cell(row = i, column = 3).value == "  ":
			counter += 1
	if counter > 100:
		print("Ошибка в расположении столбцов, проверь")
		time.sleep(5)
		exit()
	...
	id_uzi_malogo_taza, uzi_malogo_taza_2, stop_for_uzi_malogo_taza = "УЗИ малого таза", ["таза", "гинекологическое"], ["ребен", "брюш", "щитовид", "плод", "триместр", "терапия", "воздей", "треместр", "беремен", "втор", "муж", "трузи", "недел", "после", "аборт", "контрол", "дет", "абдомин", "живот", "ваги", "влага", "ta", "воздей", "кавита", "беремен", "tv", "вен", "кг", "кардиограф", "фолликулометр", "под", "расшир"]
	...
	tamponada_nosa, tamponada_nosa_2, id_tamponada_nosa, stop_for_tamponada_nosa = ["тампон"], ["нос"], "Тампонада носа", ["реб", "удал", "ринит", "хронич", "репози", "уретр", "перетамп", "извлеч", "лун", "зуб", "стома", "дес", "влага", "гине", "вуль", "мат", "дет", "удал", "извлеч"]
	...
	main_func(["экг", "электрокардиографи", "электрокардиограмм"], ["нагруз", "упражнениями"], "ЭКГ с нагрузкой", ["дет", "медикаментозной нагрузкой", "реб", "втор", "без нагрузки", "без нагрузок", "описани", "расшифровка", "занятий", "посещени", "для", "во время", "курс"])
