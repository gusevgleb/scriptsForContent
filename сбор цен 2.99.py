...
def without_lab_func():
	...
	uz_terapi, uz_terapi_2, id_uz_terapi, stop_uz_terapi = ["узи", "ультразвуко", "уз-", "уз - "], ["терапия", "ультразвуковой терапии", "сеанс"], "Ультразвуковая терапия", ["дет", "реб", "ингалляц", "инфу", "втор", "вторич", "протруз", "абонемент", "занятий", "посещени"]
	...
	main_func(["удал"], ["фурункул"], "Удаление фурункула", ["дет", "лазер", "хирург", "реб", "втор", "описани", "расшифров", "занятий", "после", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["вскры", "дренаж", "дренир"], ["фурунку"], "Вскрытие фурункула носа", ["дет", "реб", "перевязка после вскрытия фу", "втор", "описани", "расшифров", "занятий", "после", "посещени", "под", "для", "во время", "курс"], ["нос", "лор-органа", "лор-органов", "лор органа", "лор органов"])
	...
	main_func(["лазер"], ["папил"], "Лазерное удаление папиллом", ["дет", "более", "от 20", "свыше", "след", "5-20", "11-20", "6-", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["хирурги", "механич"], ["папил"], "Хирургическое удаление папиллом", ["дет", "ради", "лазер", "магнит", "5-20", "от 20", "сурги", "коагул", "электр", "более", "свыше", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	main_func(["электро", "диатермо", "дэк"], ["папил"], "Электрокоагуляция папиллом", ["дет", "более", "от 20", "свыше", "5-20", "след", "11-20", "6-10", "от 5", "от 3", "от 4", "от 6", "от 7", "от 8", "от 9", "от 10", "от 11", "6-10", "2-5", "от 15", "в рамках", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
