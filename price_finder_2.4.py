...
аборты добавить
дублировать заднюю тампонаду носаqwdwqdqwdqwqwwwwwwwwwwwwwww
Биометрия глаза внести
...
def without_lab_func():
    ...
    main_func(["имплант"], ["осстем", "остем", "osstem", "ostem"], "Импланты Osstem", ["дет", "реб", "формировате", "фдм", "втор", "акци", "коронк", "отбели", "описани", "аналог", "времен", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
...
wbcsv = wbcsv.drop('Комментарий для контента', 1)
