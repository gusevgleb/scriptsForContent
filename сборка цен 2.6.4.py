...
def without_lab_func():
	...
	uv4_terapi, uv4_terapi_2, id_uv4_terapi, stop_uv4_terapi = ["увч", "ультравысокочасто", "ультразвуковое лечение кожи"], ["терапи", "ультразвуковое лечение кожи", "воздействие"], "УВЧ-терапия", ["дет", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
	...
	ufo_terapi, ufo_terapi_2, id_ufo_terapi, stop_ufo_terapi = ["уфо", "ультрафиолет"], ["терапи", "лечен", "воздейств", "уфо", "облучени"], "УФО-терапия", ["дет", "куфо", " куф", "куф", "окуф", "кров", "вен", "коротк", "сосуд", "реб", "втор", "вторич", "абонемент", "занятий", "посещени"]
	...
	main_func(["сигмоскопия"], ["сигмоскопия"], "Сигмоскопия", ["дет", "ректо", "реб", "втор", "описани", "расшифров", "занятий", "посещени"])
	...
	main_func(["влагалищ"], ["гистерэктоми", "удаление матки"], "Влагалищная гистерэктомия", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время"])
	...
	main_func(["вагинопластик", "кольпорафи"], ["вагинопластик", "кольпорафия"], "Вагинопластика / Кольпорафия", ["дет", "реб", "втор", "при", "описани", "расшифров", "занятий", "посещени", "для", "во время"])
	...
	main_func(["контурная пластика", "контурной пластики", "коррекция контура"], ["губ", "smile", "lips", "smail", "kiss"], "Контурная пластика губ", ["дет", "нос", "реб", "вестибуло", "полов", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["асит", "аллерген-специфическ"], ["терапи"], "АСИТ-терапия", ["дет", "реб", "втор", "описани", "расшифров", "прием", "консул", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["склеротерапия", "склерозирован", "склеротизац", "сеанс склеротерапии"], ["сеанс склеротерапии", "склеротерапия", "склерозирован", "склеротизац"], "Склеротерапия", ["дет", "молоч", "кист", "образова", "гемор", "семен", "канат", "микро", "звезд", "эхо", "ретикул", "поч", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"], ["вен", "сосуд", "варикоз", "конечност"])
	...
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин", "телемедицин"], ["консультац", "прием"], "Онлайн консультация пульмонолога", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["пульмонолог"])
	...
	main_func(["онлайн", "он лайн", "он-лайн", "online", "on-line", "on line", "skype", "скайп", "дистанционная", "дистанционный", "телемедицин"], ["консультац", "прием"], "Онлайн консультация флеболога-хирурга", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"], ["флеболога-хирурга"])
	...
	main_func(["мрт", "мр-", "мр -", "мр ", "магнито-резонанс", "магниторезонанс", "магнитно-резонанс", "магнитнорезонанс", "магнито резонанс", "магнитно резонанс"], ["ограф"], "МР-ангиография сосудов головного мозга", ["дет", "реб", "наличии", "нашем", "проведенного", "втор", "описани", "спирал", "мскт", "расшифров", "занятий", "посещени", "спин", "под", "для", "кост", "во время", "курс"], ["сосудов мозга", "сосудов головного мозга", "вен и артерий мозга", "вен и артерий головного мозга", "артерий и вен головного мозга", "артерий и вен мозга", "головного мозга", "мозга", "артерий головного"])
	...
	main_func(["экг", "электрокардиографи", "электрокардиограм"], ["экг", "электрокардиографи", "электрокардиограмм"], "ЭКГ", ["дет", "акц", "перед", "дом", "запо", "выезд", "дополнит", "неб", "сут", "монитор", "бех экг", "ад", "давлен", "холтер", "нагруз", "стресс", "пищевод", "реб", "втор", "занятий", "расшифровка", "описание", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["брекеты", "брекет-систем"], ["empower"], "Брекеты Empower", ["дет", "реб", "втор", "акци", "этап", "брекета", "отбели", "актив", "описани", "одного", "использование", "расшифров", "занятий", "осмотр", "посещени", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["gemini", "gemeni"], "Брекеты Gemini", ["дет", "реб", "втор", "акци", "брекета", "отбели", "этап", "описани", "актив", "расшифров", "одного", "использование", "занятий", "посещени", "осмотр", "во время", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["in"], "Брекеты In-Ovation", ["дет", "реб", "металлический", "втор", "одного", "брекета", "использование", "акци", "отбели", "этап", "одного", "использование", "описани", "расшифров", "актив", "занятий", "посещени", "во время", "осмотр", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"], ["ovation"])
	main_func(["брекеты", "брекет-систем"], ["ini"], "Брекеты Mini Master", ["дет", "реб", "втор", "акци", "отбели", "этап", "брекета", "описани", "расшифров", "актив", "занятий", "посещени", "одного", "использование", "во время", "для", "осмотр", "курс", "не включа", "привар", "почин", "допол", "снятие"], ["master"])
	main_func(["брекеты", "брекет-систем"], ["sprint", "спринт"], "Брекеты Sprint", ["дет", "реб", "втор", "акци", "отбели", "этап", "брекета", "описани", "расшифров", "актив", "занятий", "посещени", "одного", "использование", "во время", "осмотр", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["стб", "stb"], "Брекеты Stb", ["дет", "реб", "втор", "акци", "отбели", "описани", "этап", "брекета", "расшифров", "занятий", "актив", "посещени", "во время", "одного", "использование", "для", "осмотр", "курс", "не включа", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["victory", "виктори"], "Брекеты Victory", ["дет", "реб", "втор", "акци", "отбели", "этап", "брекета", "описани", "расшифров", "занятий", "актив", "посещени", "одного", "использование", "во время", "для", "осмотр", "курс", "не включа", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["блеск"], "Брекеты Блеск", ["дет", "реб", "втор", "акци", "отбели", "описани", "одного", "использование", "брекета", "расшифров", "этап", "занятий", "посещени", "во время", "актив", "для", "курс", "не включа", "осмотр", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["дет", "реб"], "Брекеты для детей", ["втор", "акци", "отбели", "описани", "расшифров", "занятий", "этап", "одного", "брекета", "использование", "посещени", "во время", "для", "актив", "курс", "не включа", "привар", "осмотр", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["инкогнито", "incognito"], "Брекеты Инкогнито", ["дет", "реб", "втор", "акци", "отбели", "описани", "этап", "расшифров", "одного", "брекета", "использование", "занятий", "посещени", "актив", "во время", "для", "курс", "осмотр", "не включа", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["ortos", "ортос"], "Брекеты Ортос", ["дет", "реб", "втор", "акци", "отбели", "описани", "одного", "использование", "расшифров", "этап", "брекета", "занятий", "посещени", "во время", "актив", "для", "курс", "не включа", "осмотр", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["сапфир"], "Сапфировые брекеты", ["дет", "реб", "втор", "акци", "отбели", "описани", "одного", "использование", "расшифров", "занятий", "брекета", "этап", "посещени", "во время", "для", "актив", "курс", "не включа", "привар", "осмотр", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["самолигир", "безлигатур"], "Самолигирующие / безлигатурные брекеты", ["дет", "реб", "одного", "использование", "при ", "втор", "акци", "брекета", "отбели", "этап", "описани", "расшифров", "занятий", "актив", "посещени", "во время", "осмотр", "для", "курс", "не включа", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["лингвал"], "Лингвальные брекеты", ["дет", "реб", "осмотр", "актив", "втор", "акци", "отбели", "одного", "использование", "описани", "расшифров", "брекета", "этап", "занятий", "посещени", "во время", "для", "курс", "не включа", "осмотр", "привар", "почин", "допол", "снятие"])
	main_func(["брекеты", "брекет-систем"], ["снятие"], "Снятие брекет-системы", ["дет", "реб", "элеме", "при ", "кнопк", "замк", "брасл", "втор", "акци", "актив", "отбели", "описани", "расшифров", "брекета", "занятий", "этап", "посещени", "во время", "курс", "не включа", "привар", "почин", "допол"])
...
def lab_finder():
	...
	new_doubler_lab(["hla"], ["drb1, dqa1, dqb1", "dqa1, drb1, dqb1", "dqb1, dqa1, drb1", "dqa1, dqb1, drb1", "drb1, dqb1, dqa1", "drb1, dqa1, dqb1", "hla-dqa1, hla-dqb1, hla-drb", "гистосовместимост", "комплекс", "по трем генам"], ["уроген", "андрофлор", "патоген", "chla", "локус dqa1", ": dqa1", "локус dqb1", "локус drb1", "b27", "1 локус", "один локус", "одному локусу", "абакавир", "5701", "чувств"], "HLA-типирование", 49243, 1875930, "HLA-типирование")
