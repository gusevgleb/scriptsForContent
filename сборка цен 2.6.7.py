...
def without_lab_func():
	...
	neirosonografia, neirosonografia_2, id_neirosonografia, stop_for_neirosonograf = ["нейро", "узи", "ультразвук"], ["соно", "мозга"], "Нейросонография / УЗИ головного мозга ребенку", ["перфуз", "яич", "овари", "спасти", "инсул", "склеро", "щитовид", "эластограф", "допол", "черн", "субстанц", "паркинс", "транскрани", "магнит", "терапия", "воздей", "мрт", "терапи", "сонопульс", "аппарат", "зона", "мр", "эндосонограф", "эндоузи"]
	...
	main_func(["криотерап", "криомассаж", "криоорошение"], ["криотерапи", "криомассаж", "криоорошение"], "Криотерапия", ["дет", "лиц", "точеч", "1 ед", "тел", "волос", "акне", "ороше", "груд", "спин", "алопец", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["озон"], ["тела", "тело", "грудь", "груди", "декольте", "артикуляр"], "Озонотерапия тела", ["дет", "реб", "втор", "описани", "блок", "расшифров", "занятий", "посещени", "для", "шеи", "шей", "шея", "во время", "курс"])
	...
	main_func(["удален", "хирургическое лечение"], ["панариц"], "Удаление панариция", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "в рамках", "курс"])
	...
	main_func(["плазмотерапия", "плазматерапия", "prp", "аутоплазменная терапия", "введение"], ["плазмы", "плазмотерапия", "плазматерапия", "терапи", "аутоплазменная терапия", "prp"], "Плазмотерапия", ["дет", "век", "мезо", "после", "костной", "предоплат", "реб", "после", "втор", "описани", "дополни", "расшифров", "офр", "озон", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["времен"], ["коронк"], "Временные коронки", ["дет", "фиксаци", "реб", "втор", "зуба", "ампута", "акци", "восстановление куль", "отбели", "цементировка", "временный цемент", "имплант", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
	...
	main_func(["коронка", "единица", "коронки"], ["на имплант"], "Коронка на имплант", ["дет", "реб", "втор", "акци", "отбели", "времен", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
	...
	main_func(["реставра", "восстано"], ["зуб"], "Восстановление (реставрация) зубов", ["дет", "пломб", "витре", "vitre", "реб", "диастем", "корон", "во время", "после", "реж", "клиновид", "культ", "эмал", "втор", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"])
