...
гипергидроз = "ботокс + цена от 20 000 руб"
'''
...
def without_lab_func():
												...
												if str(sheet_0.cell(row = i, column = 3).value).isdigit():
													...
													for k in range(1, rows):
														...
														if cell_id == cell_value_name_from_template:
															if cell_value_from_price != sheet_1.cell(row = k, column = 5).value and cell_value_from_price != "": #этой строчки нет в скрипте джанго
																if sheet_1.cell(row = k, column = 5).value == None:             
																	sheet_1.cell(row = k, column = 5).value = cell_value_from_price
																	sheet_1.cell(row = k, column = 5).fill = PatternFill("solid", fgColor="008000")
																	sheet_0.cell(row = i, column = 2).fill = PatternFill("solid", fgColor="008000")
	...
	neirosonografia, neirosonografia_2, id_neirosonografia, stop_for_neirosonograf = ["нейро", "узи", "ультразвук"], ["соно", "мозга"], "Нейросонография / УЗИ головного мозга ребенку", ["перфуз", "спасти", "инсул", "склеро", "щитовид", "эластограф", "допол", "черн", "субстанц", "паркинс", "транскрани", "магнит", "терапия", "воздей", "мрт", "терапи", "сонопульс", "аппарат", "зона", "мр", "эндосонограф", "эндоузи"]
	...
	kolposkopia_video, kolposkopia_video_2, id_kolposkopia_video, stop_for_kolposkopia_video, kolposkopia_video_3 = ["кольпо"], ["скоп"], "Видеокольпоскопия", ["реб", "дет", "прием", "без вид", "без кольп"], ["видео"]
	...
	ren_pozvono4_po9s, id_ren_pozvono4_po9s, stop_ren_pozvono4_po9s = ["поясни"], "Рентген поясничного отдела позвоночника", ["дет", "реб", "втор", "блокада", "курс", "описани", "расшифров", "занятий", "посещени", "доп", "крест"]
	ren_pozvono4_shei, id_ren_pozvono4_shei, stop_ren_pozvono4_shei = ["шейн", "шеи"], "Рентген шейного отдела позвоночника", ["дет", "реб", "втор", "блокада", "курс", "описани", "позвонка", "расшифров", "занятий", "доп", "посещени"]
	...
	bronhobio, bronhobio_2, id_bronhobio, stop_bronhobio =  ["бронхоскопи"], ["биопси"], "Бронхоскопия с биопсией", ["дет", "реб", "удалени", "при бронхоскопии", "биопсия трахеи", "биопсия бронхов", "инород", "втор", "описани", "расшифров", "занятий", "посещени"]
	...
	main_func(["контурная пластика", "контурной пластики", "коррекция контура", "juvederm", "juviderm"], ["губ", "smile", "lips", "smail", "kiss"], "Контурная пластика губ", ["дет", "нос", "реб", "вестибуло", "полов", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	new_doubler_main(["лазерная эпиляция живот", "лазерная эпиляция зоны живот", "лазерная эпиляция (живот)", "удаление волос в области живота лазе", "удаление волос в зоне живота лазер", "эпиляция живота лазер", "лазерная эпиляция живота"], ["полност"], ["втор", "дет", "реб", "процедур ", "посеще", "во время", "курс"], "Лазерная эпиляция живота", 47604, 1978638, "Лазерная эпиляция")
	...
	main_func(["лазер", "smooth"], ["омолож", "смус", "smooth"], "Лазерное омоложение", ["дет", "реб", "aft", "шея", " акци", "процедур ", "растя", "влаг", "вульв", "пол", "инти", "шеи", "шей", "декольт", "кист", "рук", "локт", "орбит", "глаз", "лиц", "втор", "описани", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func([" дом", "по москве"], ["консульт", "прием", "вызов", "выезд"], "Вызов врача на дом", ["дет", "реб", "втор", "2-го", "к основному", "описани", "ортопедом", "мануал", "пси", "рефлекс", "расшифров", "дмс", "занятий", "посещени", "под", "для", "во время", "курс"], ["терапевт"])
	...
	main_func([" дом"], ["консульт", "прием", "вызов", "выезд"], "Вызов хирурга на дом", ["дет", "реб", "абдоминал", "втор", "ортопедом", "описани", "расшифров", "к основному", "занятий", "посещени", "для", "во время", "курс"], ["хирург"])
	...
	main_func([" дом", "в пределах мкад", "выезд"], ["медсестр", "сестра", "м/с", "сестры", "медицинская сестра", "медицинской сестрой", "медицинской сестры", "среднего мед"], "Медсестра на дом", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "во время", "курс"])
	...
	main_func(["резекци", "отслое", "отслойк"], ["носовой перегородки", "перегородки носа", "перегородки в носу"], "Подслизистая резекция носовой перегородки", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["удал"], ["ногт"], "Удаление ногтевой пластины", ["дет", "реб", "гриб", "вросш", "втор", "описани", "мозол", "расшифров", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["плазмотерапия", "плазматерапия", "prp", "аутоплазменная терапия", "введение"], ["аутоплазмы", "плазмотерапия", "плазматерапия", "терапи", "аутоплазменная терапия", "prp"], "Плазмотерапия", ["дет", "век", "мезо", "после", "костной", "предоплат", "реб", "после", "втор", "описани", "дополни", "расшифров", "офр", "озон", "занятий", "посещени", "под", "для", "во время", "курс"])
	...
	main_func(["пластик"], ["вросш", "ногтевого ложа"], "Пластика вросшего ногтя", ["дет", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["скоб", "пласти"], ["зто"], "Исправление вросшего ногтя скобой ЗТО", ["дет", "реб", "втор", "описани", "кор", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["удал", "механич", "сечен"], ["родин", "невус"], "Удаление родинки / невуса", ["дет", "6", "7", "8", "9", "лазер", "механич", "электр", "радио", "сурги", "крио", "азот", "хирургич", "реб", "втор", "описани", "расшифров", "занятий", "посещени", "для", "во время", "курс"])
	...
	main_func(["удал"], ["движ"], "Удаление подвижного зуба", ["дет", "реб", "втор", "акци", "фрагмент", "молоч", "отбели", "стенки", "стенок", "импла", "описани", "неподвиж", "расшифров", "занятий", "посещени", "во время", "неподвиж", "для", "курс"], ["зуб"])
	...
	main_func(["имплант"], ["alpha bio", "альфа био", "alfa", "альфа-био", "alpha - bio"], "Импланты Alpha Bio", ["дет", "формировате", "аналог", "времен", "фдм", "предложе", "коронк", "реб", "втор", "акци", "отбели", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"] )
	...
	main_func(["коронка", "единица"], ["на имплант"], "Коронка на имплант", ["дет", "реб", "втор", "акци", "отбели", "времен", "описани", "расшифров", "занятий", "посещени", "во время", "для", "курс"])
	...
	main_func(["брекеты", "брекет-систем"], ["инкогнито", "incognito"], "Брекеты Инкогнито", ["дет", "реб", "втор", "акци", "отбели", "описани", "исследование", "диагности", "этап", "расшифров", "одного", "брекета", "использование", "занятий", "посещени", "актив", "во время", "для", "курс", "осмотр", "не включа", "привар", "почин", "допол", "снятие"])
	...
	main_func(["брекеты", "брекет-систем"], ["сапфир", "inspire"], "Сапфировые брекеты", ["дет", "реб", "втор", "акци", "отбели", "описани", "одного", "использование", "расшифров", "занятий", "брекета", "этап", "посещени", "во время", "для", "актив", "курс", "не включа", "привар", "осмотр", "почин", "допол", "снятие"])
	...
	main_func(["циркони"], ["коронк", "единица"], "Циркониевые коронки", ["дет", "реб", "втор", "имплант", "alfa", "osstem", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
	...
	main_func(["ортопед", "ортезирова"], ["стелек", "стельки", "формто", "formt"], "Изготовление ортопедических стелек", ["дет", "реб", "втор", "артроза", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
	...
	main_func(["ретейнер"], ["ретейнер"], "Ретейнеры", ["дет", "реб", "втор", "сня", "удал", "1 зуб", "один зуб", "чис", "чин", "фиксация", "ремон", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
	...
	main_func(["метал", "литые", "литая"], ["коронк", "единица"], "Цельнометаллические коронки", ["дет", "реб", "времен", "молоч", "коронковой", "керам", "емакс", "e-max", "сня", "втор", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс", "импла", "удал", "извле"])
	main_func(["метал"], ["керам"], "Металлокерамические коронки", ["дет", "реб", "сня", "втор", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс", "импла", "удал", "извле"], ["корон", "единица"])
	main_func(["керам", "емакс", "e-max", "emax", "e max"], ["коронк", "единица"], "Керамические коронки", ["дет", "реб", "втор", "сня", "метал", "литы", "литой", "литу", "лита", "описани", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс", "импла", "удал", "извле"])
	...
	main_func(["штифт"], ["штифт"], "Установка зубного штифта", ["дет", "реб", "втор", "описани", "пломбир", "канала", "артроскоп", "расшифров", "занятий", "посещени", "при", "для", "во время", "курс", "акц", "сотру", "дмс"])
	...
	main_func(["тест", "возбудител", "рнк", "забор на коронавирус", "мазок на ", "мазка на"], ["коронавирус", "covid", "забор на коронавирус"], "Тест на коронавирус", ["лмк", "книж", "рино", "адено", "профосмо", "парво", "бока", "инфекций", "антител", "профпат", "вакцин"])
	...
	main_func(["реставра", "восстано"], ["зуб"], "Восстановление (реставрация) зубов", ["дет", "реб", "диастем", "корон", "во время", "после", "реж", "клиновид", "культ", "эмал", "втор", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"])
	main_func(["реставра", "восстано"], ["зуб"], "Восстановление коронковой части зуба", ["дет", "реб", "диастем", "реж", "культ", "эмал", "во время", "после", "втор", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"], ["коронков"])
	...
	main_func(["слож"], ["удал"], "Сложное удаление зуба", ["дет", "реб", "втор", "курс", "постоян", "несложн", "молоч", "не слож", "степен", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"], ["зуб"])
	main_func(["металл"], ["брекет"], "Металлические брекеты", ["дет", "реб", "втор", "снятие", "удале", "извле", "ремонт", "почин", "фиксац", "керам", "1 брекет", "1 зуб", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"])
	main_func(["композит"], ["вкладк"], "Композитная вкладка", ["дет", "реб", "втор", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"])
	...
	main_func(["частич"], ["протез"], "Частичные съемные зубные протезы", ["дет", "реб", "втор", "замен", "снятие", "удале", "извле", "ремонт", "почин", "времен", "матриц", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "для", "допол", "курс"])
	...
	main_func(["трейнер"], ["зуб", "выравни", "корре", "исправл", "функционал"], "Трейнеры для зубов", ["миобрейс", "miobrace", "втор", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "допол", "курс"])
	main_func(["трейнер"], ["миобрейс", "miobrace"], "Трейнер Миобрейс", ["втор", "курс", "скидк", "акци", "описани", "расшифров", "занятий", "посещени", "во время", "допол", "курс"])
